...
//#pragma link C++ class art::TCatTrackMinuit;
//#pragma link C++ class art::TCatTrackDiffusedMinuit;
#pragma link C++ class art::TCatTrackingProcessor;
...
#pragma link C++ class art::TCatSimpleTrackingByChargeDivision;
