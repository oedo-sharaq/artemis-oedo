...
TDaliData::TDaliData()
: fEnergy1(kInvalidD),fEnergy2(kInvalidD),fTiming1(kInvalidD),fTiming2(kInvalidD),fTotalE(kInvalidD), fTheta(kInvalidD),fPos1(kInvalidI),fPos2(kInvalidI)
{
...
TDaliData::TDaliData(const TDaliData& rhs)
   : TDataObject(rhs),
     ...
     fPos1(rhs.fPos1),
     fPos2(rhs.fPos2),
     fTiming1(rhs.fTiming1),
     fTiming2(rhs.fTiming2),
     fTotalE(rhs.fTotalE),
     fTheta(rhs.fTheta)
{}
...
void TDaliData::Copy(TObject& dest) const
{
   ...
   cobj.fTiming1 = this->GetTiming1();
   cobj.fTiming2 = this->GetTiming2();
