...
// TH1F *hist_ni = new TH1F("hist_ni","mass_AMT_ni",110000,1.90,2.011); 
 ...
 z_ca[4] = {20,20,20,20};
 aq_ca[4] = {1.94798796,1.99758196,2.04756631,2.09736331};

 z_sc[4] = {21,21,21,21};
 aq_sc[4] = {1.94798796,1.99758196,2.04756631,2.09736331};

 z_ti[4] = {22,22,22,22};
 aq_ti[4] = {1.94798796,1.99758196,2.04756631,2.09736331};

 z_v[4] = {23,23,23,23};
 aq_v[4] = {1.94798796,1.99758196,2.04756631,2.09736331};

 z_cr[4] = {24,24,24,24};
 aq_cr[4] = {1.94798796,1.99758196,2.04756631,2.09736331};

 z_mn[4] = {25,25,25,25};
 aq_mn[4] = {1.94798796,1.99758196,2.04756631,2.09736331};

 z_fe[4] = {26,26,26,26};
 aq_fe[4] = {1.94798796,1.99758196,2.04756631,2.09736331};

 z_co[4] = {27,27,27,27};
 aq_co[4] = {1.94798796,1.99758196,2.04756631,2.09736331};

 z_ni[4] = {28,28,28,28};
 aq_ni[4] = {1.94798796,1.99758196,2.04756631,2.09736331};
