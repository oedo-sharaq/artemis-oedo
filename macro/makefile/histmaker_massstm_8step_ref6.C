...
void histmaker_massstm_8step_ref6(){
...
TH1D*  h_47v  = new TH1D("h47v_aq","h47v_aq",5000,2.03,2.05);
...
TH1D*  h_47cr = new TH1D("h47cr_aq","h47cr_aq",5000,1.95,1.97);
TH1D*  h_51cr = new TH1D("h51cr_aq","h51cr_aq",5000,2.11,2.13);
...
TH1D*  h_49mn = new TH1D("h49mn_aq","h49mn_aq",5000,1.95,1.97);
...
if(j==0){
 ...
 TFile* file = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_8step_ref6_posmod.eventstore.170272.ca.root"); // Load file. Basically BLD file.
  if(!file){
 ...
 TClonesArray *array_mass_corstm_8th = NULL;

 tree->SetBranchAddress("mass_corstm_BLD_8th",&array_mass_corstm_8th);
 tree->SetBranchStatus("*",0);
 tree->SetBranchStatus("mass_corstm_BLD_8th",1);
...
for (int i=0; i < nData; i++){
 ...
 Int_t hit_mass_corstm_8th = array_mass_corstm_8th->GetEntriesFast();

if( hit_mass_corstm_8th > 0){

 art::TMassData *mass_corstm_8th = (art::TMassData*) array_mass_corstm_8th->UncheckedAt(0);

 Double_t aq_select = mass_corstm_8th->GetAq();
...
// h_50fe->Fill(aq_select);
 ...
 TFile* file_sc = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_8step_ref6_posmod.eventstore.170272.sc.root"); // Load file. Basically BLD file.
  if(!file_sc){
	 printf("Cannot open the file!\n");
	 return;
 }
 ...
 TClonesArray *array_mass_corstm_8th_sc = NULL;

 tree_sc->SetBranchAddress("mass_corstm_BLD_8th",&array_mass_corstm_8th_sc);
 tree_sc->SetBranchStatus("*",0);
 tree_sc->SetBranchStatus("mass_corstm_BLD_8th",1);
...
for (int i=0; i < nData_sc; i++){
 ...
 Int_t hit_mass_corstm_8th_sc = array_mass_corstm_8th_sc->GetEntriesFast();

if( hit_mass_corstm_8th_sc > 0){

 art::TMassData *mass_corstm_8th_sc = (art::TMassData*) array_mass_corstm_8th_sc->UncheckedAt(0);

 Double_t aq_select_sc = mass_corstm_8th_sc->GetAq();
...
// h_50fe->Fill(aq_select_sc);
 ...
 TFile* file_ti = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_8step_ref6_posmod.eventstore.170272.ti.root"); // Load file. Basically BLD file.
  if(!file_ti){
	 printf("Cannot open the file!\n");
	 return;
 }
 ...
 TClonesArray *array_mass_corstm_8th_ti = NULL;

 tree_ti->SetBranchAddress("mass_corstm_BLD_8th",&array_mass_corstm_8th_ti);
 tree_ti->SetBranchStatus("*",0);
 tree_ti->SetBranchStatus("mass_corstm_BLD_8th",1);
...
for (int i=0; i < nData_ti; i++){
 ...
 Int_t hit_mass_corstm_8th_ti = array_mass_corstm_8th_ti->GetEntriesFast();

if( hit_mass_corstm_8th_ti > 0){

 art::TMassData *mass_corstm_8th_ti = (art::TMassData*) array_mass_corstm_8th_ti->UncheckedAt(0);

 Double_t aq_select_ti = mass_corstm_8th_ti->GetAq();
...
// h_50fe->Fill(aq_select_ti);
 ...
 TFile* file_v = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_8step_ref6_posmod.eventstore.170272.v.root"); // Load file. Basically BLD file.
  if(!file_v){
	 printf("Cannot open the file!\n");
	 return;
 }
 ...
 TClonesArray *array_mass_corstm_8th_v = NULL;

 tree_v->SetBranchAddress("mass_corstm_BLD_8th",&array_mass_corstm_8th_v);
 tree_v->SetBranchStatus("*",0);
 tree_v->SetBranchStatus("mass_corstm_BLD_8th",1);
...
for (int i=0; i < nData_v; i++){
 ...
 Int_t hit_mass_corstm_8th_v = array_mass_corstm_8th_v->GetEntriesFast();

if( hit_mass_corstm_8th_v > 0){

 art::TMassData *mass_corstm_8th_v = (art::TMassData*) array_mass_corstm_8th_v->UncheckedAt(0);

 Double_t aq_select_v = mass_corstm_8th_v->GetAq();
...
// h_50fe->Fill(aq_select_v);
 ...
 TFile* file_cr = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_8step_ref6_posmod.eventstore.170272.cr.root"); // Load file. Basically BLD file.
  if(!file_cr){
	 printf("Cannot open the file!\n");
	 return;
 }
 ...
 TClonesArray *array_mass_corstm_8th_cr = NULL;

 tree_cr->SetBranchAddress("mass_corstm_BLD_8th",&array_mass_corstm_8th_cr);
 tree_cr->SetBranchStatus("*",0);
 tree_cr->SetBranchStatus("mass_corstm_BLD_8th",1);
...
for (int i=0; i < nData_cr; i++){
 ...
 Int_t hit_mass_corstm_8th_cr = array_mass_corstm_8th_cr->GetEntriesFast();

if( hit_mass_corstm_8th_cr > 0){

 art::TMassData *mass_corstm_8th_cr = (art::TMassData*) array_mass_corstm_8th_cr->UncheckedAt(0);

 Double_t aq_select_cr = mass_corstm_8th_cr->GetAq();
...
//  h_46v->Fill(aq_select_cr);
 ...
 h_47cr->Fill(aq_select_cr);
 h_51cr->Fill(aq_select_cr);
...
// h_50fe->Fill(aq_select_cr);
 ...
 TFile* file_mn = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_8step_ref6_posmod.eventstore.170272.mn.root"); // Load file. Basically BLD file.
  if(!file_mn){
	 printf("Cannot open the file!\n");
	 return;
 }
 ...
 TClonesArray *array_mass_corstm_8th_mn = NULL;

 tree_mn->SetBranchAddress("mass_corstm_BLD_8th",&array_mass_corstm_8th_mn);
 tree_mn->SetBranchStatus("*",0);
 tree_mn->SetBranchStatus("mass_corstm_BLD_8th",1);
...
for (int i=0; i < nData_mn; i++){
 ...
 Int_t hit_mass_corstm_8th_mn = array_mass_corstm_8th_mn->GetEntriesFast();

if(  hit_mass_corstm_8th_mn > 0){

 art::TMassData *mass_corstm_8th_mn = (art::TMassData*) array_mass_corstm_8th_mn->UncheckedAt(0);

 Double_t aq_select_mn = mass_corstm_8th_mn->GetAq();
...
// h_50fe->Fill(aq_select_mn);
 ...
 TFile* file_fe = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_8step_ref6_posmod.eventstore.170272.fe.root"); // Load file. Basically BLD file.
  if(!file_fe){
	 printf("Cannot open the file!\n");
	 return;
 }
 ...
 TClonesArray *array_mass_corstm_8th_fe = NULL;

 tree_fe->SetBranchAddress("mass_corstm_BLD_8th",&array_mass_corstm_8th_fe);
 tree_fe->SetBranchStatus("*",0);
 tree_fe->SetBranchStatus("mass_corstm_BLD_8th",1);
...
for (int i=0; i < nData_fe; i++){
 ...
 Int_t hit_mass_corstm_8th_fe = array_mass_corstm_8th_fe->GetEntriesFast();

if( hit_mass_corstm_8th_fe > 0){

 art::TMassData *mass_corstm_8th_fe = (art::TMassData*) array_mass_corstm_8th_fe->UncheckedAt(0);

 Double_t aq_select_fe = mass_corstm_8th_fe->GetAq();
...
// h_48mn->Fill(aq_select_fe);
 ...
 TFile* ofile = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_8step_ref6_posmod.eventstore.170272.hist.root","recreate");
