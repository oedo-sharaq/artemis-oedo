...
void histmaker_massstm_4step_ref4(){
...
if(j==0){
 ...
 TFile* file = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_4step_ref4.eventstore.170272.ca.root"); // Load file. Basically BLD file.
  if(!file){
...
// h_50fe->Fill(aq_select);
 ...
 TFile* file_sc = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_4step_ref4.eventstore.170272.sc.root"); // Load file. Basically BLD file.
  if(!file_sc){
	 printf("Cannot open the file!\n");
	 return;
 }
...
// h_50fe->Fill(aq_select_sc);
 ...
 TFile* file_ti = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_4step_ref4.eventstore.170272.ti.root"); // Load file. Basically BLD file.
  if(!file_ti){
	 printf("Cannot open the file!\n");
	 return;
 }
...
// h_50fe->Fill(aq_select_ti);
 ...
 TFile* file_v = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_4step_ref4.eventstore.170272.v.root"); // Load file. Basically BLD file.
  if(!file_v){
	 printf("Cannot open the file!\n");
	 return;
 }
...
// h_50fe->Fill(aq_select_v);
 ...
 TFile* file_cr = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_4step_ref4.eventstore.170272.cr.root"); // Load file. Basically BLD file.
  if(!file_cr){
	 printf("Cannot open the file!\n");
	 return;
 }
...
// h_50fe->Fill(aq_select_cr);
 ...
 TFile* file_mn = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_4step_ref4.eventstore.170272.mn.root"); // Load file. Basically BLD file.
  if(!file_mn){
	 printf("Cannot open the file!\n");
	 return;
 }
...
// h_50fe->Fill(aq_select_mn);
 ...
 TFile* file_fe = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_4step_ref4.eventstore.170272.fe.root"); // Load file. Basically BLD file.
  if(!file_fe){
	 printf("Cannot open the file!\n");
	 return;
 }
...
// h_48mn->Fill(aq_select_fe);
 ...
 TFile* ofile = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_4step_ref4.eventstore.170272.hist.root","recreate");
