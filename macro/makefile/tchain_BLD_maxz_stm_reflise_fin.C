...
void tchain_BLD_maxz_stm_reflise_fin(){

// This root file is for mass calibration !!!
 
 TFile *ofile = new TFile("sh13_analysis/hanai/phys/mass_cor_maxz/fe/physics.chkmass_stm2_8step_reflise_maxz_mahala.eventstore.170272.fe.root","recreate");
...
for(int i = 170; i < 273; i++){
 ...
 ch->Add(Form("sh13_analysis/hanai/phys/mass_cor_maxz/fe/physics.chkmass_stm2_8step_reflise_maxz_mahala.eventstore.%04d.fe.root",i));
 cout<< "Chain Fe Run" << i << endl;
}
