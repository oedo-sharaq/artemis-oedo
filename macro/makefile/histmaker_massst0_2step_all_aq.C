...
void histmaker_massst0_2step_all_aq(){
...
if(j==0){
 ...
 TFile* file = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st0_2step.170272.ca.root");

 TClonesArray *array_mass = NULL;
 TClonesArray *array_mass_corst0_2nd = NULL;
 art::TEventHeader *array_eventheader = NULL;
 TTree *tree = (TTree*) gDirectory->Get("tree");

 tree->SetBranchAddress("mass",&array_mass);
 tree->SetBranchAddress("mass_corst0_2nd",&array_mass_corst0_2nd);
 tree->SetBranchAddress("eventheader",&array_eventheader);
 tree->SetBranchStatus("*",0);
 tree->SetBranchStatus("mass",1);
 tree->SetBranchStatus("mass_corst0_2nd",1);
...
for (int i=0; i < nData; i++){
 ...
 Int_t hit_mass_corst0_2nd = array_mass_corst0_2nd->GetEntriesFast();

if( hit_mass > 0 && hit_mass_corst0_2nd > 0){

 art::TMassData *mass = (art::TMassData*) array_mass->UncheckedAt(0);
 art::TMassData *mass_corst0_2nd = (art::TMassData*) array_mass_corst0_2nd->UncheckedAt(0);
// art::TEventHeader *eventheader = (art::TEventHeader*) array_eventheader->UncheckedAt(0);

Double_t z_select = mass->GetZ();
Double_t aq_select = mass_corst0_2nd->GetAq();
...
//: cout << "End Ca" << endl; 
 ...
 TFile* file_sc = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st0_2step.170272.sc.root");

 TClonesArray *array_mass_sc = NULL;
 TClonesArray *array_mass_corst0_2nd_sc = NULL;
...
for (int i=0; i < nData_sc; i++){
 ...
 Int_t hit_mass_corst0_2nd_sc = array_mass_corst0_2nd_sc->GetEntriesFast();

if( hit_mass_sc > 0 && hit_mass_corst0_2nd_sc > 0){

 art::TMassData *mass_sc = (art::TMassData*) array_mass_sc->UncheckedAt(0);
 art::TMassData *mass_corst0_2nd_sc = (art::TMassData*) array_mass_corst0_2nd_sc->UncheckedAt(0);
// art::TEventHeader *eventheader_sc = (art::TEventHeader*) array_eventheader_sc->UncheckedAt(0);

 Double_t z_select_sc = mass_sc->GetZ();
 Double_t aq_select_sc = mass_corst0_2nd_sc->GetAq();
 ...
 TFile* file_ti = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st0_2step.170272.ti.root");

 TClonesArray *array_mass_ti = NULL;
 TClonesArray *array_mass_corst0_2nd_ti = NULL;
...
for (int i=0; i < nData_ti; i++){
 ...
 Int_t hit_mass_corst0_2nd_ti = array_mass_corst0_2nd_ti->GetEntriesFast();

if( hit_mass_ti > 0 && hit_mass_corst0_2nd_ti > 0){

 art::TMassData *mass_ti = (art::TMassData*) array_mass_ti->UncheckedAt(0);
 art::TMassData *mass_corst0_2nd_ti = (art::TMassData*) array_mass_corst0_2nd_ti->UncheckedAt(0);
// art::TEventHeader *eventheader_ti = (art::TEventHeader*) array_eventheader_ti->UncheckedAt(0);

 Double_t z_select_ti = mass_ti->GetZ();
 Double_t aq_select_ti = mass_corst0_2nd_ti->GetAq();
...
for (int i=0; i < nData_v; i++){
 ...
 Int_t hit_mass_corst0_2nd_v = array_mass_corst0_2nd_v->GetEntriesFast();

if( hit_mass_v > 0 && hit_mass_corst0_2nd_v > 0){

 art::TMassData *mass_v = (art::TMassData*) array_mass_v->UncheckedAt(0);
 art::TMassData *mass_corst0_2nd_v = (art::TMassData*) array_mass_corst0_2nd_v->UncheckedAt(0);
// art::TEventHeader *eventheader_v = (art::TEventHeader*) array_eventheader_v->UncheckedAt(0);

 Double_t z_select_v = mass_v->GetZ();
 Double_t aq_select_v = mass_corst0_2nd_v->GetAq();
 ...
 TFile* file_cr = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st0_2step.170272.cr.root");

 TClonesArray *array_mass_cr = NULL;
 TClonesArray *array_mass_corst0_2nd_cr = NULL;
...
for (int i=0; i < nData_cr; i++){
 ...
 Int_t hit_mass_corst0_2nd_cr = array_mass_corst0_2nd_cr->GetEntriesFast();

if( hit_mass_cr > 0 && hit_mass_corst0_2nd_cr > 0){

 art::TMassData *mass_cr = (art::TMassData*) array_mass_cr->UncheckedAt(0);
 art::TMassData *mass_corst0_2nd_cr = (art::TMassData*) array_mass_corst0_2nd_cr->UncheckedAt(0);
// art::TEventHeader *eventheader_cr = (art::TEventHeader*) array_eventheader_cr->UncheckedAt(0);

 Double_t z_select_cr = mass_cr->GetZ();
 Double_t aq_select_cr = mass_corst0_2nd_cr->GetAq();
 ...
 TFile* file_mn = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st0_2step.170272.mn.root");

 TClonesArray *array_mass_mn = NULL;
 TClonesArray *array_mass_corst0_2nd_mn = NULL;
...
for (int i=0; i < nData_mn; i++){
 ...
 Int_t hit_mass_corst0_2nd_mn = array_mass_corst0_2nd_mn->GetEntriesFast();

if( hit_mass_mn > 0 && hit_mass_corst0_2nd_mn > 0){

 art::TMassData *mass_mn = (art::TMassData*) array_mass_mn->UncheckedAt(0);
 art::TMassData *mass_corst0_2nd_mn = (art::TMassData*) array_mass_corst0_2nd_mn->UncheckedAt(0);
// art::TEventHeader *eventheader_mn = (art::TEventHeader*) array_eventheader_mn->UncheckedAt(0);

 Double_t z_select_mn = mass_mn->GetZ();
 Double_t aq_select_mn = mass_corst0_2nd_mn->GetAq();
 ...
 TFile* file_fe = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st0_2step.170272.fe.root");

 TClonesArray *array_mass_fe = NULL;
 TClonesArray *array_mass_corst0_2nd_fe = NULL;
...
for (int i=0; i < nData_fe; i++){
 ...
 Int_t hit_mass_corst0_2nd_fe = array_mass_corst0_2nd_fe->GetEntriesFast();

if( hit_mass_fe > 0 && hit_mass_corst0_2nd_fe > 0){

 art::TMassData *mass_fe = (art::TMassData*) array_mass_fe->UncheckedAt(0);
 art::TMassData *mass_corst0_2nd_fe = (art::TMassData*) array_mass_corst0_2nd_fe->UncheckedAt(0);
// art::TEventHeader *eventheader_fe = (art::TEventHeader*) array_eventheader_fe->UncheckedAt(0);

 Double_t z_select_fe = mass_fe->GetZ();
 Double_t aq_select_fe = mass_corst0_2nd_fe->GetAq();
 ...
 TFile* file_co = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st0_2step.170272.co.root");

 TClonesArray *array_mass_co = NULL;
 TClonesArray *array_mass_corst0_2nd_co = NULL;
...
for (int i=0; i < nData_co; i++){
 ...
 Int_t hit_mass_corst0_2nd_co = array_mass_corst0_2nd_co->GetEntriesFast();

if( hit_mass_co > 0 && hit_mass_corst0_2nd_co > 0){

 art::TMassData *mass_co = (art::TMassData*) array_mass_co->UncheckedAt(0);
 art::TMassData *mass_corst0_2nd_co = (art::TMassData*) array_mass_corst0_2nd_co->UncheckedAt(0);
// art::TEventHeader *eventheader_fe = (art::TEventHeader*) array_eventheader_fe->UncheckedAt(0);

 Double_t z_select_co = mass_co->GetZ();
 Double_t aq_select_co = mass_corst0_2nd_co->GetAq();
 ...
 TFile* file_ni = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st0_2step.170272.ni.root");

 TClonesArray *array_mass_ni = NULL;
 TClonesArray *array_mass_corst0_2nd_ni = NULL;
...
for (int i=0; i < nData_ni; i++){
 ...
 Int_t hit_mass_corst0_2nd_ni = array_mass_corst0_2nd_ni->GetEntriesFast();

if( hit_mass_ni > 0 && hit_mass_corst0_2nd_ni > 0){

 art::TMassData *mass_ni = (art::TMassData*) array_mass_ni->UncheckedAt(0);
 art::TMassData *mass_corst0_2nd_ni = (art::TMassData*) array_mass_corst0_2nd_ni->UncheckedAt(0);
// art::TEventHeader *eventheader_fe = (art::TEventHeader*) array_eventheader_fe->UncheckedAt(0);

 Double_t z_select_ni = mass_ni->GetZ();
 Double_t aq_select_ni = mass_corst0_2nd_ni->GetAq();
 ...
 TFile *ofile = new TFile("sh13_analysis/hanai/phys/merge/mass_corst0_2nd_all.170272.hist.root","recreate");
