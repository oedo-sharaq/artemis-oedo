...
void histmaker_massst2_2step_ref(){
...
// TFile* file = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st2_2step.170272.ca.root");
 TFile* file = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st2_2step_st1theta.170272.ca.root");
...
//: cout << "End Ca" << endl; 
 ...
 TFile* file_sc = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st2_2step_st1theta.170272.sc.root");
...
// h_41ca->Fill(aq_select_sc);
 ...
 TFile* file_ti = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st2_2step_st1theta.170272.ti.root");
...
// h_41ca->Fill(aq_select_ti);
 ...
 TFile* file_v = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st2_2step_st1theta.170272.v.root");
...
// h_41ca->Fill(aq_select_v);
 ...
 TFile* file_cr = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st2_2step_st1theta.170272.cr.root");
...
// h_41ca->Fill(aq_select_cr);
 ...
 TFile* file_mn = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st2_2step_st1theta.170272.mn.root");
...
// h_41ca->Fill(aq_select_mn);
 ...
 TFile* file_fe = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st2_2step_st1theta.170272.fe.root");
...
// TFile *ofile = new TFile("sh13_analysis/hanai/phys/merge/mass_corst2_2nd_ref.170272.hist.root","recreate");
 TFile *ofile = new TFile("sh13_analysis/hanai/phys/merge/mass_corst2_2nd_ref_st1theta.170272.hist.root","recreate");
