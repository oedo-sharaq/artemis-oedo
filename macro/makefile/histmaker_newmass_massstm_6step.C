...
void histmaker_newmass_massstm_6step(){

TH1D*  hnewaq_a = new TH1D("hnewaq_a","hnewaq_a",5000,1.70,1.72);
TH1D*  hnewaq_b = new TH1D("hnewaq_b","hnewaq_b",5000,1.72,1.74);
TH1D*  hnewaq_c = new TH1D("hnewaq_c","hnewaq_c",5000,1.74,1.76);
TH1D*  hnewaq_d = new TH1D("hnewaq_d","hnewaq_d",5000,1.76,1.78);
TH1D*  hnewaq_e = new TH1D("hnewaq_e","hnewaq_e",5000,1.78,1.80);
TH1D*  hnewaq_f = new TH1D("hnewaq_f","hnewaq_f",5000,1.80,1.82);
TH1D*  hnewaq_g = new TH1D("hnewaq_g","hnewaq_g",5000,1.82,1.84);
TH1D*  hnewaq_h = new TH1D("hnewaq_h","hnewaq_h",5000,1.81,1.83);
...
if(j==0){
 ...
 TFile* file = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_6step_ref6.eventstore.170272.ca.root"); // Load file. Basically BLD file.
  if(!file){
...
if( hit_mass_corstm_6th > 0){
 ...
 hnewaq_a->Fill(aq_select); 
 hnewaq_b->Fill(aq_select); 
 hnewaq_c->Fill(aq_select); 
 hnewaq_d->Fill(aq_select); 
 hnewaq_e->Fill(aq_select); 
 hnewaq_f->Fill(aq_select); 
 hnewaq_g->Fill(aq_select); 
 hnewaq_h->Fill(aq_select); 
     }
   }
...
if( hit_mass_corstm_6th_ni > 0){
 ...
 TFile* ofile = TFile::Open("sh13_analysis/hanai/phys/mass_calib/newmass_stm2_6step.eventstore.170272.hist.root","recreate");
// TFile* ofile = TFile::Open("sh13_analysis/hanai/phys/mass_calib/newmasswoconi_stm2_6step.eventstore.170272.hist.root","recreate");
