...
void histmaker_massst1_2step_ref(){
...
// TFile* file = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st1_2step.170272.ca.root");

// TFile* file = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_st1_2step.eventstore.170272.ca.root"); // Load file. Basically BLD file.
 TFile* file = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_st1_2step_weight.eventstore.170272.ca.root"); // Load file. Basically BLD file.
  if(!file){
...
// TClonesArray *array_mass = NULL;
 TClonesArray *array_mass_corst1_2nd = NULL;
// TTree *tree = (TTree*) gDirectory->Get("tree");

// tree->SetBranchAddress("mass",&array_mass);
// tree->SetBranchAddress("mass_corst1_2nd",&array_mass_corst1_2nd);
// tree->SetBranchAddress("mass_corst1_BLD_2nd",&array_mass_corst1_2nd);
 tree->SetBranchAddress("mass_corst1_BLD_w",&array_mass_corst1_2nd);
 tree->SetBranchStatus("*",0);
// tree->SetBranchStatus("mass",1);
// tree->SetBranchStatus("mass_corst1_2nd",1);
// tree->SetBranchStatus("mass_corst1_BLD_2nd",1);
 tree->SetBranchStatus("mass_corst1_BLD_w",1);
...
// Int_t hit_mass = array_mass->GetEntriesFast();
 Int_t hit_mass_corst1_2nd = array_mass_corst1_2nd->GetEntriesFast();

if( hit_mass_corst1_2nd > 0){

// art::TMassData *mass = (art::TMassData*) array_mass->UncheckedAt(0);
 art::TMassData *mass_corst1_2nd = (art::TMassData*) array_mass_corst1_2nd->UncheckedAt(0);
// art::TEventHeader *eventheader = (art::TEventHeader*) array_eventheader->UncheckedAt(0);

//Double_t z_select = mass->GetZ();
Double_t aq_select = mass_corst1_2nd->GetAq();
...
// TFile* file_sc = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st1_2step.170272.sc.root");

// TFile* file_sc = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_st1_2step.eventstore.170272.sc.root"); // Load file. Basically BLD file.
 TFile* file_sc = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_st1_2step_weight.eventstore.170272.sc.root"); // Load file. Basically BLD file.
  if(!file_sc){
	 printf("Cannot open the file!\n");
	 return;
 }
...
// TClonesArray *array_mass_sc = NULL;
 TClonesArray *array_mass_corst1_2nd_sc = NULL;
// TTree *tree_sc = (TTree*) gDirectory->Get("tree");

// tree_sc->SetBranchAddress("mass",&array_mass_sc);
// tree_sc->SetBranchAddress("mass_corst1_2nd",&array_mass_corst1_2nd_sc);
// tree_sc->SetBranchAddress("mass_corst1_BLD_2nd",&array_mass_corst1_2nd_sc);
 tree_sc->SetBranchAddress("mass_corst1_BLD_w",&array_mass_corst1_2nd_sc);
 tree_sc->SetBranchStatus("*",0);
// tree_sc->SetBranchStatus("mass",1);
// tree_sc->SetBranchStatus("mass_corst1_2nd",1);
// tree_sc->SetBranchStatus("mass_corst1_BLD_2nd",1);
 tree_sc->SetBranchStatus("mass_corst1_BLD_w",1);
...
// Int_t hit_mass_sc = array_mass_sc->GetEntriesFast();
 Int_t hit_mass_corst1_2nd_sc = array_mass_corst1_2nd_sc->GetEntriesFast();

if( hit_mass_corst1_2nd_sc > 0){

// art::TMassData *mass_sc = (art::TMassData*) array_mass_sc->UncheckedAt(0);
 art::TMassData *mass_corst1_2nd_sc = (art::TMassData*) array_mass_corst1_2nd_sc->UncheckedAt(0);
// art::TEventHeader *eventheader_sc = (art::TEventHeader*) array_eventheader_sc->UncheckedAt(0);

// Double_t z_select_sc = mass_sc->GetZ();
 Double_t aq_select_sc = mass_corst1_2nd_sc->GetAq();
...
// TFile* file_ti = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st1_2step.170272.ti.root");

// TFile* file_ti = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_st1_2step.eventstore.170272.ti.root"); // Load file. Basically BLD file.
 TFile* file_ti = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_st1_2step_weight.eventstore.170272.ti.root"); // Load file. Basically BLD file.
  if(!file_ti){
	 printf("Cannot open the file!\n");
	 return;
 }
...
// TClonesArray *array_mass_ti = NULL;
 TClonesArray *array_mass_corst1_2nd_ti = NULL;
// TTree *tree_ti = (TTree*) gDirectory->Get("tree");

// tree_ti->SetBranchAddress("mass",&array_mass_ti);
// tree_ti->SetBranchAddress("mass_corst1_2nd",&array_mass_corst1_2nd_ti);
// tree_ti->SetBranchAddress("mass_corst1_BLD_2nd",&array_mass_corst1_2nd_ti);
 tree_ti->SetBranchAddress("mass_corst1_BLD_w",&array_mass_corst1_2nd_ti);
 tree_ti->SetBranchStatus("*",0);
// tree_ti->SetBranchStatus("mass",1);
// tree_ti->SetBranchStatus("mass_corst1_2nd",1);
// tree_ti->SetBranchStatus("mass_corst1_BLD_2nd",1);
 tree_ti->SetBranchStatus("mass_corst1_BLD_w",1);
...
// Int_t hit_mass_ti = array_mass_ti->GetEntriesFast();
 Int_t hit_mass_corst1_2nd_ti = array_mass_corst1_2nd_ti->GetEntriesFast();

if( hit_mass_corst1_2nd_ti > 0){

// art::TMassData *mass_ti = (art::TMassData*) array_mass_ti->UncheckedAt(0);
 art::TMassData *mass_corst1_2nd_ti = (art::TMassData*) array_mass_corst1_2nd_ti->UncheckedAt(0);
// art::TEventHeader *eventheader_ti = (art::TEventHeader*) array_eventheader_ti->UncheckedAt(0);

// Double_t z_select_ti = mass_ti->GetZ();
 Double_t aq_select_ti = mass_corst1_2nd_ti->GetAq();
...
// TFile* file_v = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st1_2step.170272.v.root");

// TFile* file_v = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_st1_2step.eventstore.170272.v.root"); // Load file. Basically BLD file.
 TFile* file_v = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_st1_2step_weight.eventstore.170272.v.root"); // Load file. Basically BLD file.
  if(!file_v){
	 printf("Cannot open the file!\n");
	 return;
 }
...
// TClonesArray *array_mass_v = NULL;
 TClonesArray *array_mass_corst1_2nd_v = NULL;
// TTree *tree_v = (TTree*) gDirectory->Get("tree");

// tree_v->SetBranchAddress("mass",&array_mass_v);
// tree_v->SetBranchAddress("mass_corst1_2nd",&array_mass_corst1_2nd_v);
// tree_v->SetBranchAddress("mass_corst1_BLD_2nd",&array_mass_corst1_2nd_v);
 tree_v->SetBranchAddress("mass_corst1_BLD_w",&array_mass_corst1_2nd_v);
 tree_v->SetBranchStatus("*",0);
// tree_v->SetBranchStatus("mass",1);
// tree_v->SetBranchStatus("mass_corst1_2nd",1);
// tree_v->SetBranchStatus("mass_corst1_BLD_2nd",1);
 tree_v->SetBranchStatus("mass_corst1_BLD_w",1);
...
// Int_t hit_mass_v = array_mass_v->GetEntriesFast();
 Int_t hit_mass_corst1_2nd_v = array_mass_corst1_2nd_v->GetEntriesFast();

if( hit_mass_corst1_2nd_v > 0){

// art::TMassData *mass_v = (art::TMassData*) array_mass_v->UncheckedAt(0);
 art::TMassData *mass_corst1_2nd_v = (art::TMassData*) array_mass_corst1_2nd_v->UncheckedAt(0);
// art::TEventHeader *eventheader_v = (art::TEventHeader*) array_eventheader_v->UncheckedAt(0);

// Double_t z_select_v = mass_v->GetZ();
 Double_t aq_select_v = mass_corst1_2nd_v->GetAq();
...
// TFile* file_cr = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st1_2step.170272.cr.root");

// TFile* file_cr = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_st1_2step.eventstore.170272.cr.root"); // Load file. Basically BLD file.
 TFile* file_cr = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_st1_2step_weight.eventstore.170272.cr.root"); // Load file. Basically BLD file.
  if(!file_cr){
	 printf("Cannot open the file!\n");
	 return;
 }
...
// TClonesArray *array_mass_cr = NULL;
 TClonesArray *array_mass_corst1_2nd_cr = NULL;
// TTree *tree_cr = (TTree*) gDirectory->Get("tree");

// tree_cr->SetBranchAddress("mass",&array_mass_cr);
// tree_cr->SetBranchAddress("mass_corst1_2nd",&array_mass_corst1_2nd_cr);
// tree_cr->SetBranchAddress("mass_corst1_BLD_2nd",&array_mass_corst1_2nd_cr);
 tree_cr->SetBranchAddress("mass_corst1_BLD_w",&array_mass_corst1_2nd_cr);
 tree_cr->SetBranchStatus("*",0);
// tree_cr->SetBranchStatus("mass",1);
// tree_cr->SetBranchStatus("mass_corst1_2nd",1);
// tree_cr->SetBranchStatus("mass_corst1_BLD_2nd",1);
 tree_cr->SetBranchStatus("mass_corst1_BLD_w",1);
...
// Int_t hit_mass_cr = array_mass_cr->GetEntriesFast();
 Int_t hit_mass_corst1_2nd_cr = array_mass_corst1_2nd_cr->GetEntriesFast();

if( hit_mass_corst1_2nd_cr > 0){

// art::TMassData *mass_cr = (art::TMassData*) array_mass_cr->UncheckedAt(0);
 art::TMassData *mass_corst1_2nd_cr = (art::TMassData*) array_mass_corst1_2nd_cr->UncheckedAt(0);
// art::TEventHeader *eventheader_cr = (art::TEventHeader*) array_eventheader_cr->UncheckedAt(0);

// Double_t z_select_cr = mass_cr->GetZ();
 Double_t aq_select_cr = mass_corst1_2nd_cr->GetAq();
...
// TFile* file_mn = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st1_2step.170272.mn.root");

// TFile* file_mn = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_st1_2step.eventstore.170272.mn.root"); // Load file. Basically BLD file.
 TFile* file_mn = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_st1_2step_weight.eventstore.170272.mn.root"); // Load file. Basically BLD file.
  if(!file_mn){
	 printf("Cannot open the file!\n");
	 return;
 }
...
// TClonesArray *array_mass_mn = NULL;
 TClonesArray *array_mass_corst1_2nd_mn = NULL;
 //TTree *tree_mn = (TTree*) gDirectory->Get("tree");

// tree_mn->SetBranchAddress("mass",&array_mass_mn);
// tree_mn->SetBranchAddress("mass_corst1_2nd",&array_mass_corst1_2nd_mn);
// tree_mn->SetBranchAddress("mass_corst1_BLD_2nd",&array_mass_corst1_2nd_mn);
 tree_mn->SetBranchAddress("mass_corst1_BLD_w",&array_mass_corst1_2nd_mn);
 tree_mn->SetBranchStatus("*",0);
// tree_mn->SetBranchStatus("mass",1);
// tree_mn->SetBranchStatus("mass_corst1_2nd",1);
// tree_mn->SetBranchStatus("mass_corst1_BLD_2nd",1);
 tree_mn->SetBranchStatus("mass_corst1_BLD_w",1);
...
// Int_t hit_mass_mn = array_mass_mn->GetEntriesFast();
 Int_t hit_mass_corst1_2nd_mn = array_mass_corst1_2nd_mn->GetEntriesFast();

if(  hit_mass_corst1_2nd_mn > 0){

// art::TMassData *mass_mn = (art::TMassData*) array_mass_mn->UncheckedAt(0);
 art::TMassData *mass_corst1_2nd_mn = (art::TMassData*) array_mass_corst1_2nd_mn->UncheckedAt(0);
// art::TEventHeader *eventheader_mn = (art::TEventHeader*) array_eventheader_mn->UncheckedAt(0);

// Double_t z_select_mn = mass_mn->GetZ();
 Double_t aq_select_mn = mass_corst1_2nd_mn->GetAq();
...
// TFile* file_fe = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st1_2step.170272.fe.root");

// TFile* file_fe = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_st1_2step.eventstore.170272.fe.root"); // Load file. Basically BLD file.
 TFile* file_fe = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_st1_2step_weight.eventstore.170272.fe.root"); // Load file. Basically BLD file.
  if(!file_fe){
	 printf("Cannot open the file!\n");
	 return;
 }
...
// TClonesArray *array_mass_fe = NULL;
 TClonesArray *array_mass_corst1_2nd_fe = NULL;
// TTree *tree_fe = (TTree*) gDirectory->Get("tree");

// tree_fe->SetBranchAddress("mass",&array_mass_fe);
// tree_fe->SetBranchAddress("mass_corst1_2nd",&array_mass_corst1_2nd_fe);
// tree_fe->SetBranchAddress("mass_corst1_BLD_2nd",&array_mass_corst1_2nd_fe);
 tree_fe->SetBranchAddress("mass_corst1_BLD_w",&array_mass_corst1_2nd_fe);
 tree_fe->SetBranchStatus("*",0);
// tree_fe->SetBranchStatus("mass",1);
// tree_fe->SetBranchStatus("mass_corst1_2nd",1);
// tree_fe->SetBranchStatus("mass_corst1_BLD_2nd",1);
 tree_fe->SetBranchStatus("mass_corst1_BLD_w",1);
...
// Int_t hit_mass_fe = array_mass_fe->GetEntriesFast();
 Int_t hit_mass_corst1_2nd_fe = array_mass_corst1_2nd_fe->GetEntriesFast();

if( hit_mass_corst1_2nd_fe > 0){

// art::TMassData *mass_fe = (art::TMassData*) array_mass_fe->UncheckedAt(0);
 art::TMassData *mass_corst1_2nd_fe = (art::TMassData*) array_mass_corst1_2nd_fe->UncheckedAt(0);
// art::TEventHeader *eventheader_fe = (art::TEventHeader*) array_eventheader_fe->UncheckedAt(0);

// Double_t z_select_fe = mass_fe->GetZ();
 Double_t aq_select_fe = mass_corst1_2nd_fe->GetAq();
...
// TFile *ofile = new TFile("sh13_analysis/hanai/phys/merge/mass_corst1_2nd_ref.170272.hist.root","recreate");
// TFile* ofile = new TFile("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_st1_2step.eventstore.170272.hist.root","recreate");
 TFile* ofile = new TFile("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_st1_2step_weight.eventstore.170272.hist.root","recreate");
