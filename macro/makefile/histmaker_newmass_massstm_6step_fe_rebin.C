...
void histmaker_newmass_massstm_6step_fe_rebin(){

TH1D*  hnewaq_a = new TH1D("hnewaq_a","hnewaq_a",2000,1.72,1.74);
TH1D*  hnewaq_b = new TH1D("hnewaq_b","hnewaq_b",2000,1.76,1.78);
TH1D*  hnewaq_c = new TH1D("hnewaq_c","hnewaq_c",2000,1.79,1.81);
TH1D*  hnewaq_d = new TH1D("hnewaq_d","hnewaq_d",2000,1.83,1.85);
TH1D*  hnewaq_e = new TH1D("hnewaq_e","hnewaq_e",2000,1.87,1.89);
TH1D*  hnewaq_f = new TH1D("hnewaq_f","hnewaq_f",2000,1.92,1.94);
TH1D*  hnewaq_g = new TH1D("hnewaq_g","hnewaq_g",2000,1.95,1.97);
TH1D*  hnewaq_h = new TH1D("hnewaq_h","hnewaq_h",2000,1.98,2.0);
...
if( hit_mass_corstm_6th_fe > 0){
 ...
 TFile* ofile = TFile::Open("sh13_analysis/hanai/phys/mass_calib/newmass_stm2_6step_fe.eventstore.170272_rebin.hist.root","recreate");
