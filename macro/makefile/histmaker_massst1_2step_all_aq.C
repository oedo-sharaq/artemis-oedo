...
void histmaker_massst1_2step_all_aq(){
...
if( hit_mass > 0 && hit_mass_corst1_2nd > 0){
...
if( hit_mass_sc > 0 && hit_mass_corst1_2nd_sc > 0){
...
if( hit_mass_ti > 0 && hit_mass_corst1_2nd_ti > 0){
...
if( hit_mass_v > 0 && hit_mass_corst1_2nd_v > 0){
...
if( hit_mass_cr > 0 && hit_mass_corst1_2nd_cr > 0){
...
if( hit_mass_mn > 0 && hit_mass_corst1_2nd_mn > 0){
...
if( hit_mass_fe > 0 && hit_mass_corst1_2nd_fe > 0){
...
// art::TEventHeader *eventheader_fe = (art::TEventHeader*) array_eventheader_fe->UncheckedAt(0);
 ...
 TClonesArray *array_mass_corst1_2nd_co = NULL;
...
for (int i=0; i < nData_co; i++){
 ...
 Int_t hit_mass_corst1_2nd_co = array_mass_corst1_2nd_co->GetEntriesFast();

if( hit_mass_co > 0 && hit_mass_corst1_2nd_co > 0){

 art::TMassData *mass_co = (art::TMassData*) array_mass_co->UncheckedAt(0);
 art::TMassData *mass_corst1_2nd_co = (art::TMassData*) array_mass_corst1_2nd_co->UncheckedAt(0);
// art::TEventHeader *eventheader_fe = (art::TEventHeader*) array_eventheader_fe->UncheckedAt(0);

 Double_t z_select_co = mass_co->GetZ();
 Double_t aq_select_co = mass_corst1_2nd_co->GetAq();
 ...
 TClonesArray *array_mass_corst1_2nd_ni = NULL;
...
for (int i=0; i < nData_ni; i++){
 ...
 Int_t hit_mass_corst1_2nd_ni = array_mass_corst1_2nd_ni->GetEntriesFast();

if( hit_mass_ni > 0 && hit_mass_corst1_2nd_ni > 0){

 art::TMassData *mass_ni = (art::TMassData*) array_mass_ni->UncheckedAt(0);
 art::TMassData *mass_corst1_2nd_ni = (art::TMassData*) array_mass_corst1_2nd_ni->UncheckedAt(0);
// art::TEventHeader *eventheader_fe = (art::TEventHeader*) array_eventheader_fe->UncheckedAt(0);

 Double_t z_select_ni = mass_ni->GetZ();
 Double_t aq_select_ni = mass_corst1_2nd_ni->GetAq();
 ...
 TFile *ofile = new TFile("sh13_analysis/hanai/phys/merge/mass_corst1_2nd_all.170272.hist.root","recreate");
