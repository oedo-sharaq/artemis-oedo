...
void histmaker_massst3_2step_all_aq(){
...
// art::TEventHeader *eventheader_fe = (art::TEventHeader*) array_eventheader_fe->UncheckedAt(0);
 ...
 TFile* file_co = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st3_2step.170272.co.root");

 TClonesArray *array_mass_co = NULL;
 TClonesArray *array_mass_corst3_2nd_co = NULL;
...
for (int i=0; i < nData_co; i++){
 ...
 Int_t hit_mass_corst3_2nd_co = array_mass_corst3_2nd_co->GetEntriesFast();

if( hit_mass_co > 0 && hit_mass_corst3_2nd_co > 0){

 art::TMassData *mass_co = (art::TMassData*) array_mass_co->UncheckedAt(0);
 art::TMassData *mass_corst3_2nd_co = (art::TMassData*) array_mass_corst3_2nd_co->UncheckedAt(0);
// art::TEventHeader *eventheader_fe = (art::TEventHeader*) array_eventheader_fe->UncheckedAt(0);

 Double_t z_select_co = mass_co->GetZ();
 Double_t aq_select_co = mass_corst3_2nd_co->GetAq();
 ...
 TFile* file_ni = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st3_2step.170272.ni.root");

 TClonesArray *array_mass_ni = NULL;
 TClonesArray *array_mass_corst3_2nd_ni = NULL;
...
for (int i=0; i < nData_ni; i++){
 ...
 Int_t hit_mass_corst3_2nd_ni = array_mass_corst3_2nd_ni->GetEntriesFast();

if( hit_mass_ni > 0 && hit_mass_corst3_2nd_ni > 0){

 art::TMassData *mass_ni = (art::TMassData*) array_mass_ni->UncheckedAt(0);
 art::TMassData *mass_corst3_2nd_ni = (art::TMassData*) array_mass_corst3_2nd_ni->UncheckedAt(0);
// art::TEventHeader *eventheader_fe = (art::TEventHeader*) array_eventheader_fe->UncheckedAt(0);

 Double_t z_select_ni = mass_ni->GetZ();
 Double_t aq_select_ni = mass_corst3_2nd_ni->GetAq();
 ...
 TFile *ofile = new TFile("sh13_analysis/hanai/phys/merge/mass_corst3_2nd_all.170272.hist.root","recreate");
