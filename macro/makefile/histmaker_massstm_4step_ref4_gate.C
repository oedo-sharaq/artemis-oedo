...
void histmaker_massstm_4step_ref4_gate(){
...
if(j==0){
 ...
 tree->AddFriend("tree1 = tree","sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_4step_ref4.eventstore.170272.ca.root"); // Add file. Basically mass calibration file.
...
if( hit_mass_corstm_4th > 0 && hit_trackd > 0){
...
// tree->AddFriend("tree1 = tree","sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_3step_ref4_BVar.eventstore.170272.sc.root"); // Add file. Basically mass calibration file.
 tree->AddFriend("tree1 = tree","sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_4step_ref4.eventstore.170272.sc.root"); // Add file. Basically mass calibration file.
...
Double_t y2 = trackd_tmp->GetY();
 ...
 art::TMassData *mass_corstm_4th_sc = (art::TMassData*) array_mass_corstm_4th->UncheckedAt(0);
...
// tree->AddFriend("tree1 = tree","sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_3step_ref4_BVar.eventstore.170272.ti.root"); // Add file. Basically mass calibration file.
 tree->AddFriend("tree1 = tree","sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_4step_ref4.eventstore.170272.ti.root"); // Add file. Basically mass calibration file.
...
Double_t y2 = trackd_tmp->GetY();
 ...
 art::TMassData *mass_corstm_4th_ti = (art::TMassData*) array_mass_corstm_4th->UncheckedAt(0);
...
// tree->AddFriend("tree1 = tree","sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_3step_ref4_BVar.eventstore.170272.v.root"); // Add file. Basically mass calibration file.
 tree->AddFriend("tree1 = tree","sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_4step_ref4.eventstore.170272.v.root"); // Add file. Basically mass calibration file.
...
Double_t y2 = trackd_tmp->GetY();
 ...
 art::TMassData *mass_corstm_4th_v = (art::TMassData*) array_mass_corstm_4th->UncheckedAt(0);
...
// tree->AddFriend("tree1 = tree","sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_3step_ref4_BVar.eventstore.170272.cr.root"); // Add file. Basically mass calibration file.
 tree->AddFriend("tree1 = tree","sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_4step_ref4.eventstore.170272.cr.root"); // Add file. Basically mass calibration file.
...
Double_t y2 = trackd_tmp->GetY();
 ...
 art::TMassData *mass_corstm_4th_cr = (art::TMassData*) array_mass_corstm_4th->UncheckedAt(0);
...
// tree->AddFriend("tree1 = tree","sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_3step_ref4_BVar.eventstore.170272.mn.root"); // Add file. Basically mass calibration file.
 tree->AddFriend("tree1 = tree","sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_4step_ref4.eventstore.170272.mn.root"); // Add file. Basically mass calibration file.
...
Double_t y2 = trackd_tmp->GetY();
 ...
 art::TMassData *mass_corstm_4th_mn = (art::TMassData*) array_mass_corstm_4th->UncheckedAt(0);
...
// tree->AddFriend("tree1 = tree","sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_3step_ref4_BVar.eventstore.170272.fe.root"); // Add file. Basically mass calibration file.
 tree->AddFriend("tree1 = tree","sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_4step_ref4.eventstore.170272.fe.root"); // Add file. Basically mass calibration file.
...
Double_t y2 = trackd_tmp->GetY();
 ...
 art::TMassData *mass_corstm_4th_fe = (art::TMassData*) array_mass_corstm_4th->UncheckedAt(0);
...
// TFile* ofile = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_3step_ref4_BVarY.eventstore.170272.hist.root","recreate");
 TFile* ofile = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_4step_ref4_BVarY.eventstore.170272.hist.root","recreate");
