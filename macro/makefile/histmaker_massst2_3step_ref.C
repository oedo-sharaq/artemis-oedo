...
void histmaker_massst2_3step_ref(){
...
if(j==0){
 ...
 tree->SetBranchAddress("mass_corst2_BLD_2nd_3rd",&array_mass_corst2_2nd);
...
// h_50fe->Fill(aq_select);
 ...
 tree_sc->SetBranchAddress("mass_corst2_BLD_2nd_3rd",&array_mass_corst2_2nd_sc);
...
// h_50fe->Fill(aq_select_sc);
 ...
 tree_ti->SetBranchAddress("mass_corst2_BLD_2nd_3rd",&array_mass_corst2_2nd_ti);
...
// h_50fe->Fill(aq_select_ti);
 ...
 TClonesArray *array_mass_corst2_2nd_v = NULL;

 tree_v->SetBranchAddress("mass_corst2_BLD_2nd_3rd",&array_mass_corst2_2nd_v);
...
for (int i=0; i < nData_v; i++){
 ...
 Int_t hit_mass_corst2_2nd_v = array_mass_corst2_2nd_v->GetEntriesFast();

if( hit_mass_corst2_2nd_v > 0){

 art::TMassData *mass_corst2_2nd_v = (art::TMassData*) array_mass_corst2_2nd_v->UncheckedAt(0);

 Double_t aq_select_v = mass_corst2_2nd_v->GetAq();
...
// h_50fe->Fill(aq_select_v);
 ...
 TClonesArray *array_mass_corst2_2nd_cr = NULL;

 tree_cr->SetBranchAddress("mass_corst2_BLD_2nd_3rd",&array_mass_corst2_2nd_cr);
...
for (int i=0; i < nData_cr; i++){
 ...
 Int_t hit_mass_corst2_2nd_cr = array_mass_corst2_2nd_cr->GetEntriesFast();

if( hit_mass_corst2_2nd_cr > 0){

 art::TMassData *mass_corst2_2nd_cr = (art::TMassData*) array_mass_corst2_2nd_cr->UncheckedAt(0);

 Double_t aq_select_cr = mass_corst2_2nd_cr->GetAq();
...
// h_50fe->Fill(aq_select_cr);
 ...
 TClonesArray *array_mass_corst2_2nd_mn = NULL;

 tree_mn->SetBranchAddress("mass_corst2_BLD_2nd_3rd",&array_mass_corst2_2nd_mn);
...
for (int i=0; i < nData_mn; i++){
 ...
 Int_t hit_mass_corst2_2nd_mn = array_mass_corst2_2nd_mn->GetEntriesFast();

if(  hit_mass_corst2_2nd_mn > 0){

 art::TMassData *mass_corst2_2nd_mn = (art::TMassData*) array_mass_corst2_2nd_mn->UncheckedAt(0);

 Double_t aq_select_mn = mass_corst2_2nd_mn->GetAq();
...
// h_50fe->Fill(aq_select_mn);
 ...
 TClonesArray *array_mass_corst2_2nd_fe = NULL;

 tree_fe->SetBranchAddress("mass_corst2_BLD_2nd_3rd",&array_mass_corst2_2nd_fe);
...
for (int i=0; i < nData_fe; i++){
 ...
 Int_t hit_mass_corst2_2nd_fe = array_mass_corst2_2nd_fe->GetEntriesFast();

if( hit_mass_corst2_2nd_fe > 0){

 art::TMassData *mass_corst2_2nd_fe = (art::TMassData*) array_mass_corst2_2nd_fe->UncheckedAt(0);

 Double_t aq_select_fe = mass_corst2_2nd_fe->GetAq();
