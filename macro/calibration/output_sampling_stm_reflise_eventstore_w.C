...
void output_sampling_stm_reflise_eventstore_w(){
...
//     b(ievt,0) = Ref_m[iref];
 ...
 ofstream fouta("/home/sh13/art_analysis/user/hanai/prm/mass/set_Amatrix_svd4th_stm2_reflise_8step_unit2.5_SSR.csv");
 if (fouta.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 return;
  }

 ofstream foutb("/home/sh13/art_analysis/user/hanai/prm/mass/set_bmatrix_svd4th_stm2_reflise_8step_unit2.5_SSR.csv");
 if (foutb.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 return;
  }

 ofstream foutw("/home/sh13/art_analysis/user/hanai/prm/mass/set_Wmatrix_svd4th_stm2_reflise_8step_unit2.5_SSR.csv");
 if (foutw.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 return;
  }
