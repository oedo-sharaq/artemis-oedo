...
// unit orientation
 ...
 ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_lu3rd.dat");
 if (fout.fail()){
...
for(int n = 0; n < Nevt; n++){
 ...
 ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_lu3rd.dat");
 if (foutselect.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 return;
  }
...
//   sprintf(foutname, "output/mass/lu_out.dat");
   std::ofstream foutmtr("output/mass/lu3rd_out.dat");
...
// b_re.Print();
 ...
 TH1D *h_43V_sol  = new TH1D("h43V_sol ", "h43V_sol ",500,1.885,1.890);
...
// Output
 ...
 TH1D *h_43V  = new TH1D("h43V ", "h43V ",500,1.885,1.890);
...
//                                        
// TH1D *h_43V_org = new TH1D("h43V_org ", "4h3V_org ",500,1.885,1.890);
