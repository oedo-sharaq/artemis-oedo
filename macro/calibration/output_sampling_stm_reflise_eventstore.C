...
void output_sampling_stm_reflise_eventstore(){
...
// 4th order
 ...
 ofstream fouta("/home/sh13/art_analysis/user/hanai/prm/mass/set_Amatrix_svd4th_stm2_reflise_7step_unit2.5_SSR.csv");
 if (fouta.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 return;
  }

 ofstream foutb("/home/sh13/art_analysis/user/hanai/prm/mass/set_bmatrix_svd4th_stm2_reflise_7step_unit2.5_SSR.csv");
 if (foutb.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 return;
  }

 ofstream foutb_singl("/home/sh13/art_analysis/user/hanai/prm/mass/set_b_singlmatrix_svd4th_stm2_reflise_7step_unit2.5_SSR.csv");
 if (foutb_singl.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 return;
  }
