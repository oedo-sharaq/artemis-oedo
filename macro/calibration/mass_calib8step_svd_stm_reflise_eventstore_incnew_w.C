...
void mass_calib8step_svd_stm_reflise_eventstore_incnew_w(){
...
//// Save the results of SVD
  ...
  Theta.Print();
   ...
   char foutname[50];
   std::ofstream foutmtr("output/mass/svd4th_out_stm2_reflise_8step_unitlise_SSR_mahala_incnew_w2.dat");
   ...
   std::ofstream foutmtrth("output/mass/theta_stm2_reflise_8step_unitlise_SSR_mahala_incnew_w2.dat");
 if (foutmtrth.fail()){
...
// if (ssrd < 0.1){
 ...
 if(21.5 < z_tmpt && z_tmpt < 22.5){
   ...
   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_stm2_reflise_8step_unitlise_SSR_mahala_incnew_w2.hist.root","recreate");
