...
void mass_calib4step_svd_stm_eventstore(){
 ...
 ifstream fin("/home/sh13/art_analysis/user/hanai/prm/mass/input_4step_stm_ref4.dat");
 if (fin.fail()){
...
//     Double_t y2_tmp = trackd_tmp->GetY();
    ...
    if(Z_low[iref] < z_tmp && z_tmp < Z_up[iref] 
    	 && Aq_low[iref] < aq_tmp && aq_tmp < Aq_up[iref] && tracku_ok && trackd_ok && ssrd < 0.1 && var3d < 0.002)
    {
      irandm.push_back(i);
      n_tmp++;
     }else {
...
// ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd4th_stm2_ref4_4step_unit2_SSRBVarY.dat");
 ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd4th_stm2_ref4_4step_unit2_SSRBVar.dat");
 if (fout.fail()){
...
// ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd4th_stm2_ref4_4step_unit2_SSRBVarY.dat");
 ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd4th_stm2_ref4_4step_unit2_SSRBVar.dat");
 if (foutselect.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 return;
  }
...
//   TFile *ofv = new TFile("output/mass/mass_calib_svd_4th_stm2_ref4_4step.hist_selected_unit2_SSRBVarY.root","recreate");
   TFile *ofv = new TFile("output/mass/mass_calib_svd_4th_stm2_ref4_4step.hist_selected_unit2_SSRBVar.root","recreate");
...
//// Save the results of SVD
  ...
  Theta.Print();
   ...
   char foutname[50];
//   std::ofstream foutmtr("output/mass/svd4th_out_stm2_ref4_4step_unit2_SSRBVarY.dat");
   std::ofstream foutmtr("output/mass/svd4th_out_stm2_ref4_4step_unit2_SSRBVar.dat");
...
//   std::ofstream foutmtrth("output/mass/theta_stm2_ref4_4step_unit2_SSRBVarY.dat");
   std::ofstream foutmtrth("output/mass/theta_stm2_ref4_4step_unit2_SSRBVar.dat");
 if (foutmtrth.fail()){
...
//   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_stm2_ref4_4step_unit2_SSRBVarY.hist.root","recreate");
   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_stm2_ref4_4step_unit2_SSRBVar.hist.root","recreate");
