...
//  const Int_t Nrun = 250;  //the number of runs
 ...
 TClonesArray *array_mass_st3 = NULL;
 ...
 tree->SetBranchAddress("mass_st3",&array_mass_st3);
 ...
 tree->SetBranchStatus("mass_st3",1);
 ...
 TFile* fbuff = new TFile("output/mass/mass_calib_mlp_st3_y0_anntree.root","recreate");
...
//// Fill data in matrix for each Ref	 
   for(int p = 0; p < Nrun; p++){
	 ...
	 art::TMassData *mass_st3 = (art::TMassData*) array_mass_st3->UncheckedAt(0);
     ...
     Double_t aq_select = mass_st3->GetAq();
 
     Double_t ti = mass_st3->GetTof();
...
// unit orientation
 ...
 ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_mlp_eachstripst3.dat");
 if (foutselect.fail()){
...
//// Set ANN
   ...
   TMultiLayerPerceptron* mlp = new TMultiLayerPerceptron("c0,c1,c2,c3,c4,c5,c6:12:10:f", anntree,  "Entry$%2","(Entry$%2)==0");
...
//// Draw original histogram
 ...
 TFile *ofile = new TFile("output/mass/mass_calib_mlp_eachstrip_st3.hist.root","recreate");
