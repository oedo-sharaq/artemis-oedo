...
void mass_calib2step_svd_stm_eventstore(){
...
// tree->AddFriend("tree1 = tree","sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm_1step_ref4.eventstore.170272.all.root"); // Add file. Basically mass calibration file.
 tree->AddFriend("tree1 = tree","sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_1step_ref4.eventstore.170272.all.root"); // Add file. Basically mass calibration file.
...
// TTree *tree = (TTree*) gDirectory->Get("tree");
 ...
 tree->SetBranchAddress("mass_corstm_BLD",&array_mass_corstm);
 ...
 tree->SetBranchStatus("mass_corstm_BLD",1);
...
for (int iref = 0; iref < Nref; iref++){
  ...
  for(int i = 0; i < nData; i++){
     ...
     if ( hit_mass > 0 && hit_mass_corstm > 0 && hit_tracku > 0 && hit_s0 > 0){
...
// ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd3rd_stm_ref4_2step_BLD.dat");
 ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd3rd_stm2_ref4_2step_BLD.dat");
 if (fout.fail()){
...
// ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd3rd_stm_ref4_2step_BLD.dat");
 ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd3rd_stm2_ref4_2step_BLD.dat");
 if (foutselect.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 return;
  }
...
//// Save the results of SVD
  ...
  Theta.Print();
   ...
   char foutname[50];
 //  std::ofstream foutmtr("output/mass/svd3rd_out_stm_ref4_2step_BLD.dat");
   std::ofstream foutmtr("output/mass/svd3rd_out_stm2_ref4_2step_BLD.dat");
...
//   std::ofstream foutmtrth("output/mass/theta_stm_ref4_2step_BLD.dat");
   std::ofstream foutmtrth("output/mass/theta_stm2_ref4_2step_BLD.dat");
 if (foutmtrth.fail()){
...
//// AoQ cor
  ...
  for (Int_t iData = 0; iData < nData; iData++){
    ...
    Int_t hit_s0_cor = array_s0->GetEntriesFast();
     ...
     if ( hit_dia_tof32stmcor > 0 && hit_tracku_cor > 0 && hit_s0_cor >0){
...
//  TFile *ofile = new TFile("output/mass/mass_calib_svd_3rd_eachstrip_stm_ref4_2step_BLD.hist.root","recreate");
  TFile *ofile = new TFile("output/mass/mass_calib_svd_3rd_eachstrip_stm2_ref4_2step_BLD.hist.root","recreate");
