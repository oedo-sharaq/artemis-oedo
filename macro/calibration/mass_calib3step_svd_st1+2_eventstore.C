...
void mass_calib3step_svd_st1+2_eventstore(){
 ...
 tree->AddFriend("tree1 = tree","sh13_analysis/hanai/phys/mass_calib/physics.chkmass_st1_2step.eventstore.170272.all.root"); // Add file. Basically mass calibration file.
 tree->AddFriend("tree2 = tree","sh13_analysis/hanai/phys/mass_calib/physics.chkmass_st2_2step.eventstore.170272.all.root"); // Add file. Basically mass calibration file.
...
//  const Int_t Nrun = 2000;  //the number of runs
 ...
 TClonesArray *array_mass_corst12 = NULL;
