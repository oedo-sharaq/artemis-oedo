...
void mass_calib3step_svd_stm_mwdcref(){

 TFile* file_load = TFile::Open("sh13_analysis/hanai/phys/bld_file/physics.bld_mass2nd.170272.all.root"); // Load file. Basically BLD file.
  if(!file_load){
 ...
 TClonesArray *array_tracku_38ca = NULL;
 TClonesArray *array_tracku_39ca = NULL;
 TClonesArray *array_tracku_41ca = NULL;
 TClonesArray *array_tracku_40sc = NULL;
 TClonesArray *array_tracku_41sc = NULL;
 TClonesArray *array_tracku_43sc = NULL;
 TClonesArray *array_tracku_40ti = NULL;
 TClonesArray *array_tracku_41ti = NULL;
 TClonesArray *array_tracku_42ti = NULL;
 TClonesArray *array_tracku_43v  = NULL;
 TClonesArray *array_tracku_44v  = NULL;
 TClonesArray *array_tracku_46v  = NULL;
 TClonesArray *array_tracku_44cr = NULL;
 TClonesArray *array_tracku_45cr = NULL;
 TClonesArray *array_tracku_46cr = NULL;
 TClonesArray *array_tracku_46mn = NULL;
 TClonesArray *array_tracku_47mn = NULL;
 TClonesArray *array_tracku_48mn = NULL;
 TClonesArray *array_tracku_48fe = NULL;
 TClonesArray *array_tracku_49fe = NULL;
 TClonesArray *array_tracku_50fe = NULL;
 TClonesArray *array_trackd     = NULL;
 TClonesArray *array_trackd_38ca = NULL;
 TClonesArray *array_trackd_39ca = NULL;
 TClonesArray *array_trackd_41ca = NULL;
 TClonesArray *array_trackd_40sc = NULL;
 TClonesArray *array_trackd_41sc = NULL;
 TClonesArray *array_trackd_43sc = NULL;
 TClonesArray *array_trackd_40ti = NULL;
 TClonesArray *array_trackd_41ti = NULL;
 TClonesArray *array_trackd_42ti = NULL;
 TClonesArray *array_trackd_43v  = NULL;
 TClonesArray *array_trackd_44v  = NULL;
 TClonesArray *array_trackd_46v = NULL;
 TClonesArray *array_trackd_44cr = NULL;
 TClonesArray *array_trackd_45cr = NULL;
 TClonesArray *array_trackd_46cr = NULL;
 TClonesArray *array_trackd_46mn = NULL;
 TClonesArray *array_trackd_47mn = NULL;
 TClonesArray *array_trackd_48mn = NULL;
 TClonesArray *array_trackd_48fe = NULL;
 TClonesArray *array_trackd_49fe = NULL;
 TClonesArray *array_trackd_50fe = NULL;
 ...
 tree->SetBranchAddress("f3_38ca",&array_tracku_38ca);
 tree->SetBranchAddress("f3_39ca",&array_tracku_39ca);
 tree->SetBranchAddress("f3_41ca",&array_tracku_41ca);
 tree->SetBranchAddress("f3_40sc",&array_tracku_40sc);
 tree->SetBranchAddress("f3_41sc",&array_tracku_41sc);
 tree->SetBranchAddress("f3_43sc",&array_tracku_43sc);
 tree->SetBranchAddress("f3_40ti",&array_tracku_40ti);
 tree->SetBranchAddress("f3_41ti",&array_tracku_41ti);
 tree->SetBranchAddress("f3_42ti",&array_tracku_42ti);
 tree->SetBranchAddress("f3_43v",&array_tracku_43v);
 tree->SetBranchAddress("f3_44v",&array_tracku_44v);
 tree->SetBranchAddress("f3_46v",&array_tracku_46v);
 tree->SetBranchAddress("f3_44cr",&array_tracku_44cr);
 tree->SetBranchAddress("f3_45cr",&array_tracku_45cr);
 tree->SetBranchAddress("f3_46cr",&array_tracku_46cr);
 tree->SetBranchAddress("f3_46mn",&array_tracku_46mn);
 tree->SetBranchAddress("f3_47mn",&array_tracku_47mn);
 tree->SetBranchAddress("f3_48mn",&array_tracku_48mn);
 tree->SetBranchAddress("f3_48fe",&array_tracku_48fe);
 tree->SetBranchAddress("f3_49fe",&array_tracku_49fe);
 tree->SetBranchAddress("f3_50fe",&array_tracku_50fe);
 tree->SetBranchAddress("s2",&array_trackd);
 tree->SetBranchAddress("s2_38ca",&array_trackd_38ca);
 tree->SetBranchAddress("s2_39ca",&array_trackd_39ca);
 tree->SetBranchAddress("s2_41ca",&array_trackd_41ca);
 tree->SetBranchAddress("s2_40sc",&array_trackd_40sc);
 tree->SetBranchAddress("s2_41sc",&array_trackd_41sc);
 tree->SetBranchAddress("s2_43sc",&array_trackd_43sc);
 tree->SetBranchAddress("s2_40ti",&array_trackd_40ti);
 tree->SetBranchAddress("s2_41ti",&array_trackd_41ti);
 tree->SetBranchAddress("s2_42ti",&array_trackd_42ti);
 tree->SetBranchAddress("s2_43v",&array_trackd_43v);
 tree->SetBranchAddress("s2_44v",&array_trackd_44v);
 tree->SetBranchAddress("s2_46v",&array_trackd_46v);
 tree->SetBranchAddress("s2_44cr",&array_trackd_44cr);
 tree->SetBranchAddress("s2_45cr",&array_trackd_45cr);
 tree->SetBranchAddress("s2_46cr",&array_trackd_46cr);
 tree->SetBranchAddress("s2_46mn",&array_trackd_46mn);
 tree->SetBranchAddress("s2_47mn",&array_trackd_47mn);
 tree->SetBranchAddress("s2_48mn",&array_trackd_48mn);
 tree->SetBranchAddress("s2_48fe",&array_trackd_48fe);
 tree->SetBranchAddress("s2_49fe",&array_trackd_49fe);
 tree->SetBranchAddress("s2_50fe",&array_trackd_50fe);
 ...
 tree->SetBranchStatus("f3_38ca",1);
 tree->SetBranchStatus("f3_39ca",1);
 tree->SetBranchStatus("f3_41ca",1);
 tree->SetBranchStatus("f3_40sc",1);
 tree->SetBranchStatus("f3_41sc",1);
 tree->SetBranchStatus("f3_43sc",1);
 tree->SetBranchStatus("f3_40ti",1);
 tree->SetBranchStatus("f3_41ti",1);
 tree->SetBranchStatus("f3_42ti",1);
 tree->SetBranchStatus("f3_43v",1);
 tree->SetBranchStatus("f3_44v",1);
 tree->SetBranchStatus("f3_46v",1);
 tree->SetBranchStatus("f3_44cr",1);
 tree->SetBranchStatus("f3_45cr",1);
 tree->SetBranchStatus("f3_46cr",1);
 tree->SetBranchStatus("f3_46mn",1);
 tree->SetBranchStatus("f3_47mn",1);
 tree->SetBranchStatus("f3_48mn",1);
 tree->SetBranchStatus("f3_48fe",1);
 tree->SetBranchStatus("f3_49fe",1);
 tree->SetBranchStatus("f3_50fe",1);
 tree->SetBranchStatus("s2",1);
 tree->SetBranchStatus("s2_38ca",1);
 tree->SetBranchStatus("s2_39ca",1);
 tree->SetBranchStatus("s2_41ca",1);
 tree->SetBranchStatus("s2_40sc",1);
 tree->SetBranchStatus("s2_41sc",1);
 tree->SetBranchStatus("s2_43sc",1);
 tree->SetBranchStatus("s2_40ti",1);
 tree->SetBranchStatus("s2_41ti",1);
 tree->SetBranchStatus("s2_42ti",1);
 tree->SetBranchStatus("s2_43v",1);
 tree->SetBranchStatus("s2_44v",1);
 tree->SetBranchStatus("s2_46v",1);
 tree->SetBranchStatus("s2_44cr",1);
 tree->SetBranchStatus("s2_45cr",1);
 tree->SetBranchStatus("s2_46cr",1);
 tree->SetBranchStatus("s2_46mn",1);
 tree->SetBranchStatus("s2_47mn",1);
 tree->SetBranchStatus("s2_48mn",1);
 tree->SetBranchStatus("s2_48fe",1);
 tree->SetBranchStatus("s2_49fe",1);
 tree->SetBranchStatus("s2_50fe",1);
...
for (int iref = 0; iref < Nref; iref++){
  ...
  for(int i = 0; i < nData; i++){
	  tree->GetEntry(i);
	  Int_t hit_tracku,hit_trackd;

      switch(iref){
		  case 0:
	         hit_tracku = array_tracku_38ca->GetEntriesFast();
             hit_trackd = array_trackd_38ca->GetEntriesFast();
		   break;
		  case 1:
	         hit_tracku = array_tracku_39ca->GetEntriesFast();
             hit_trackd = array_trackd_39ca->GetEntriesFast();
		   break;
		  case 2:
	         hit_tracku = array_tracku_41ca->GetEntriesFast();
             hit_trackd = array_trackd_41ca->GetEntriesFast();
		   break;
		  case 3:
             hit_tracku = array_tracku_40sc->GetEntriesFast();
             hit_trackd = array_trackd_40sc->GetEntriesFast();
		   break;
		  case 4:
             hit_tracku = array_tracku_41sc->GetEntriesFast();
             hit_trackd = array_trackd_41sc->GetEntriesFast();
		   break;
		  case 5:
             hit_tracku = array_tracku_43sc->GetEntriesFast();
             hit_trackd = array_trackd_43sc->GetEntriesFast();
		   break;
		  case 6:
             hit_tracku = array_tracku_40ti->GetEntriesFast();
             hit_trackd = array_trackd_40ti->GetEntriesFast();
		   break;
		  case 7:
             hit_tracku = array_tracku_41ti->GetEntriesFast();
             hit_trackd = array_trackd_41ti->GetEntriesFast();
		   break;
		  case 8:
             hit_tracku = array_tracku_42ti->GetEntriesFast();
             hit_trackd = array_trackd_42ti->GetEntriesFast();
		   break;
		  case 9:
             hit_tracku = array_tracku_43v->GetEntriesFast();
             hit_trackd = array_trackd_43v->GetEntriesFast();
		   break;
		  case 10:
             hit_tracku = array_tracku_44v->GetEntriesFast();
             hit_trackd = array_trackd_44v->GetEntriesFast();
		   break;
		  case 11:
             hit_tracku = array_tracku_46v->GetEntriesFast();
             hit_trackd = array_trackd_46v->GetEntriesFast();
		   break;
		  case 12:
             hit_tracku = array_tracku_44cr->GetEntriesFast();
             hit_trackd = array_trackd_44cr->GetEntriesFast();
		   break;
		  case 13:
             hit_tracku = array_tracku_45cr->GetEntriesFast();
             hit_trackd = array_trackd_45cr->GetEntriesFast();
		   break;
		  case 14:
             hit_tracku = array_tracku_46cr->GetEntriesFast();
             hit_trackd = array_trackd_46cr->GetEntriesFast();
		   break;
		  case 15:
             hit_tracku = array_tracku_46mn->GetEntriesFast();
             hit_trackd = array_trackd_46mn->GetEntriesFast();
		   break;
		  case 16:
             hit_tracku = array_tracku_47mn->GetEntriesFast();
             hit_trackd = array_trackd_47mn->GetEntriesFast();
		   break;
		  case 17:
             hit_tracku = array_tracku_48mn->GetEntriesFast();
             hit_trackd = array_trackd_48mn->GetEntriesFast();
		   break;
		  case 18:
             hit_tracku = array_tracku_48fe->GetEntriesFast();
             hit_trackd = array_trackd_48fe->GetEntriesFast();
		   break;
		  case 19:
             hit_tracku = array_tracku_49fe->GetEntriesFast();
             hit_trackd = array_trackd_49fe->GetEntriesFast();
		   break;
		  case 20:
             hit_tracku = array_tracku_50fe->GetEntriesFast();
             hit_trackd = array_trackd_50fe->GetEntriesFast();
		   break;
    }
     ...
     art::TMWDCTrackingResult *tracku_tmp;
     art::TMWDCTrackingResult *trackd_tmp;


      switch(iref){
		  case 0:
	        tracku_tmp = (art::TMWDCTrackingResult*) array_tracku_38ca->UncheckedAt(0);
            trackd_tmp = (art::TMWDCTrackingResult*) array_trackd_38ca->UncheckedAt(0);
		   break;
		  case 1:
	        tracku_tmp = (art::TMWDCTrackingResult*) array_tracku_39ca->UncheckedAt(0);
            trackd_tmp = (art::TMWDCTrackingResult*) array_trackd_39ca->UncheckedAt(0);
		   break;
		  case 2:
	        tracku_tmp = (art::TMWDCTrackingResult*) array_tracku_41ca->UncheckedAt(0);
            trackd_tmp = (art::TMWDCTrackingResult*) array_trackd_41ca->UncheckedAt(0);
		   break;
		  case 3:
            tracku_tmp = (art::TMWDCTrackingResult*) array_tracku_40sc->UncheckedAt(0);
            trackd_tmp = (art::TMWDCTrackingResult*) array_trackd_40sc->UncheckedAt(0);
		   break;
		  case 4:
            tracku_tmp = (art::TMWDCTrackingResult*) array_tracku_41sc->UncheckedAt(0);
            trackd_tmp = (art::TMWDCTrackingResult*) array_trackd_41sc->UncheckedAt(0);
		   break;
		  case 5:
            tracku_tmp = (art::TMWDCTrackingResult*) array_tracku_43sc->UncheckedAt(0);
            trackd_tmp = (art::TMWDCTrackingResult*) array_trackd_43sc->UncheckedAt(0);
		   break;
		  case 6:
            tracku_tmp = (art::TMWDCTrackingResult*) array_tracku_40ti->UncheckedAt(0);
            trackd_tmp = (art::TMWDCTrackingResult*) array_trackd_40ti->UncheckedAt(0);
		   break;
		  case 7:
            tracku_tmp = (art::TMWDCTrackingResult*) array_tracku_41ti->UncheckedAt(0);
            trackd_tmp = (art::TMWDCTrackingResult*) array_trackd_41ti->UncheckedAt(0);
		   break;
		  case 8:
            tracku_tmp = (art::TMWDCTrackingResult*) array_tracku_42ti->UncheckedAt(0);
            trackd_tmp = (art::TMWDCTrackingResult*) array_trackd_42ti->UncheckedAt(0);
		   break;
		  case 9:
            tracku_tmp = (art::TMWDCTrackingResult*) array_tracku_43v->UncheckedAt(0);
            trackd_tmp = (art::TMWDCTrackingResult*) array_trackd_43v->UncheckedAt(0);
		   break;
		  case 10:
            tracku_tmp = (art::TMWDCTrackingResult*) array_tracku_44v->UncheckedAt(0);
            trackd_tmp = (art::TMWDCTrackingResult*) array_trackd_44v->UncheckedAt(0);
		   break;
		  case 11:
            tracku_tmp = (art::TMWDCTrackingResult*) array_tracku_46v->UncheckedAt(0);
            trackd_tmp = (art::TMWDCTrackingResult*) array_trackd_46v->UncheckedAt(0);
		   break;
		  case 12:
            tracku_tmp = (art::TMWDCTrackingResult*) array_tracku_44cr->UncheckedAt(0);
            trackd_tmp = (art::TMWDCTrackingResult*) array_trackd_44cr->UncheckedAt(0);
		   break;
		  case 13:
            tracku_tmp = (art::TMWDCTrackingResult*) array_tracku_45cr->UncheckedAt(0);
            trackd_tmp = (art::TMWDCTrackingResult*) array_trackd_45cr->UncheckedAt(0);
		   break;
		  case 14:
            tracku_tmp = (art::TMWDCTrackingResult*) array_tracku_46cr->UncheckedAt(0);
            trackd_tmp = (art::TMWDCTrackingResult*) array_trackd_46cr->UncheckedAt(0);
		   break;
		  case 15:
            tracku_tmp = (art::TMWDCTrackingResult*) array_tracku_46mn->UncheckedAt(0);
            trackd_tmp = (art::TMWDCTrackingResult*) array_trackd_46mn->UncheckedAt(0);
		   break;
		  case 16:
            tracku_tmp = (art::TMWDCTrackingResult*) array_tracku_47mn->UncheckedAt(0);
            trackd_tmp = (art::TMWDCTrackingResult*) array_trackd_47mn->UncheckedAt(0);
		   break;
		  case 17:
            tracku_tmp = (art::TMWDCTrackingResult*) array_tracku_48mn->UncheckedAt(0);
            trackd_tmp = (art::TMWDCTrackingResult*) array_trackd_48mn->UncheckedAt(0);
		   break;
		  case 18:
            tracku_tmp = (art::TMWDCTrackingResult*) array_tracku_48fe->UncheckedAt(0);
            trackd_tmp = (art::TMWDCTrackingResult*) array_trackd_48fe->UncheckedAt(0);
		   break;
		  case 19:
            tracku_tmp = (art::TMWDCTrackingResult*) array_tracku_49fe->UncheckedAt(0);
            trackd_tmp = (art::TMWDCTrackingResult*) array_trackd_49fe->UncheckedAt(0);
		   break;
		  case 20:
            tracku_tmp = (art::TMWDCTrackingResult*) array_tracku_50fe->UncheckedAt(0);
            trackd_tmp = (art::TMWDCTrackingResult*) array_trackd_50fe->UncheckedAt(0);
		   break;
    }
...
//// Fill data in matrix for each Ref	 
   for(int p = 0; p < Nrun; p++){
     ...
     art::TMWDCTrackingResult *tracku;
     art::TMWDCTrackingResult *trackd;

      switch(iref){
		  case 0:
	        tracku = (art::TMWDCTrackingResult*) array_tracku_38ca->UncheckedAt(0);
            trackd = (art::TMWDCTrackingResult*) array_trackd_38ca->UncheckedAt(0);
		   break;
		  case 1:
	        tracku = (art::TMWDCTrackingResult*) array_tracku_39ca->UncheckedAt(0);
            trackd = (art::TMWDCTrackingResult*) array_trackd_39ca->UncheckedAt(0);
		   break;
		  case 2:
	        tracku = (art::TMWDCTrackingResult*) array_tracku_41ca->UncheckedAt(0);
            trackd = (art::TMWDCTrackingResult*) array_trackd_41ca->UncheckedAt(0);
		   break;
		  case 3:
            tracku = (art::TMWDCTrackingResult*) array_tracku_40sc->UncheckedAt(0);
            trackd = (art::TMWDCTrackingResult*) array_trackd_40sc->UncheckedAt(0);
		   break;
		  case 4:
            tracku = (art::TMWDCTrackingResult*) array_tracku_41sc->UncheckedAt(0);
            trackd = (art::TMWDCTrackingResult*) array_trackd_41sc->UncheckedAt(0);
		   break;
		  case 5:
            tracku = (art::TMWDCTrackingResult*) array_tracku_43sc->UncheckedAt(0);
            trackd = (art::TMWDCTrackingResult*) array_trackd_43sc->UncheckedAt(0);
		   break;
		  case 6:
            tracku = (art::TMWDCTrackingResult*) array_tracku_40ti->UncheckedAt(0);
            trackd = (art::TMWDCTrackingResult*) array_trackd_40ti->UncheckedAt(0);
		   break;
		  case 7:
            tracku = (art::TMWDCTrackingResult*) array_tracku_41ti->UncheckedAt(0);
            trackd = (art::TMWDCTrackingResult*) array_trackd_41ti->UncheckedAt(0);
		   break;
		  case 8:
            tracku = (art::TMWDCTrackingResult*) array_tracku_42ti->UncheckedAt(0);
            trackd = (art::TMWDCTrackingResult*) array_trackd_42ti->UncheckedAt(0);
		   break;
		  case 9:
            tracku = (art::TMWDCTrackingResult*) array_tracku_43v->UncheckedAt(0);
            trackd = (art::TMWDCTrackingResult*) array_trackd_43v->UncheckedAt(0);
		   break;
		  case 10:
            tracku = (art::TMWDCTrackingResult*) array_tracku_44v->UncheckedAt(0);
            trackd = (art::TMWDCTrackingResult*) array_trackd_44v->UncheckedAt(0);
		   break;
		  case 11:
            tracku = (art::TMWDCTrackingResult*) array_tracku_46v->UncheckedAt(0);
            trackd = (art::TMWDCTrackingResult*) array_trackd_46v->UncheckedAt(0);
		   break;
		  case 12:
            tracku = (art::TMWDCTrackingResult*) array_tracku_44cr->UncheckedAt(0);
            trackd = (art::TMWDCTrackingResult*) array_trackd_44cr->UncheckedAt(0);
		   break;
		  case 13:
            tracku = (art::TMWDCTrackingResult*) array_tracku_45cr->UncheckedAt(0);
            trackd = (art::TMWDCTrackingResult*) array_trackd_45cr->UncheckedAt(0);
		   break;
		  case 14:
            tracku = (art::TMWDCTrackingResult*) array_tracku_46cr->UncheckedAt(0);
            trackd = (art::TMWDCTrackingResult*) array_trackd_46cr->UncheckedAt(0);
		   break;
		  case 15:
            tracku = (art::TMWDCTrackingResult*) array_tracku_46mn->UncheckedAt(0);
            trackd = (art::TMWDCTrackingResult*) array_trackd_46mn->UncheckedAt(0);
		   break;
		  case 16:
            tracku = (art::TMWDCTrackingResult*) array_tracku_47mn->UncheckedAt(0);
            trackd = (art::TMWDCTrackingResult*) array_trackd_47mn->UncheckedAt(0);
		   break;
		  case 17:
            tracku = (art::TMWDCTrackingResult*) array_tracku_48mn->UncheckedAt(0);
            trackd = (art::TMWDCTrackingResult*) array_trackd_48mn->UncheckedAt(0);
		   break;
		  case 18:
            tracku = (art::TMWDCTrackingResult*) array_tracku_48fe->UncheckedAt(0);
            trackd = (art::TMWDCTrackingResult*) array_trackd_48fe->UncheckedAt(0);
		   break;
		  case 19:
            tracku = (art::TMWDCTrackingResult*) array_tracku_49fe->UncheckedAt(0);
            trackd = (art::TMWDCTrackingResult*) array_trackd_49fe->UncheckedAt(0);
		   break;
		  case 20:
            tracku = (art::TMWDCTrackingResult*) array_tracku_50fe->UncheckedAt(0);
            trackd = (art::TMWDCTrackingResult*) array_trackd_50fe->UncheckedAt(0);
		   break;
    }
...
// 4th order
 ...
 ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd4th_stm_ref4_3step_unit2_mwdcref.dat");
 if (fout.fail()){
...
for(int n = 0; n < Nevt; n++){
 ...
 ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd4th_stm_ref4_3step_unit2_mwdcref.dat");
 if (foutselect.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 return;
  }
...
for(int n = 0; n < Nevt; n++){
   ...
   TFile *ofv = new TFile("output/mass/mass_calib_svd_4th_stm_ref4_3step.hist_selected_unit2_mwdcref.root","recreate");
...
//// Save the results of SVD
  ...
  Theta.Print();
   ...
   char foutname[50];
   std::ofstream foutmtr("output/mass/svd4th_out_stm_ref4_3step_unit2_mwdcref.dat");
   ...
   std::ofstream foutmtrth("output/mass/theta_stm_ref4_3step_unit2_mwdcref.dat");
 if (foutmtrth.fail()){
...
//      switch(iref){
//		  case 0:
//	        hit_tracku_cor = array_tracku_38ca->GetEntriesFast();
//            hit_trackd_cor = array_trackd_38ca->GetEntriesFast();
//	        tracku_cor = (art::TMWDCTrackingResult*) array_tracku_38ca->UncheckedAt(0);
//            trackd_cor = (art::TMWDCTrackingResult*) array_trackd_38ca->UncheckedAt(0);
//		   break;
//		  case 1:
//	        hit_tracku_cor = array_tracku_39ca->GetEntriesFast();
//            hit_trackd_cor = array_trackd_39ca->GetEntriesFast();
//	        tracku_cor = (art::TMWDCTrackingResult*) array_tracku_39ca->UncheckedAt(0);
//            trackd_cor = (art::TMWDCTrackingResult*) array_trackd_39ca->UncheckedAt(0);
//		   break;
//		  case 2:
//	        hit_tracku_cor = array_tracku_41ca->GetEntriesFast();
//            hit_trackd_cor = array_trackd_41ca->GetEntriesFast();
//	        tracku_cor = (art::TMWDCTrackingResult*) array_tracku_41ca->UncheckedAt(0);
//            trackd_cor = (art::TMWDCTrackingResult*) array_trackd_41ca->UncheckedAt(0);
//		   break;
//		  case 3:
//	        hit_tracku_cor = array_tracku_40sc->GetEntriesFast();
//            hit_trackd_cor = array_trackd_40sc->GetEntriesFast();
//            tracku_cor = (art::TMWDCTrackingResult*) array_tracku_40sc->UncheckedAt(0);
//            trackd_cor = (art::TMWDCTrackingResult*) array_trackd_40sc->UncheckedAt(0);
//		   break;
//		  case 4:
//	        hit_tracku_cor = array_tracku_41sc->GetEntriesFast();
//            hit_trackd_cor = array_trackd_41sc->GetEntriesFast();
//            tracku_cor = (art::TMWDCTrackingResult*) array_tracku_41sc->UncheckedAt(0);
//            trackd_cor = (art::TMWDCTrackingResult*) array_trackd_41sc->UncheckedAt(0);
//		   break;
//		  case 5:
//	        hit_tracku_cor = array_tracku_43sc->GetEntriesFast();
//            hit_trackd_cor = array_trackd_43sc->GetEntriesFast();
//            tracku_cor = (art::TMWDCTrackingResult*) array_tracku_43sc->UncheckedAt(0);
//            trackd_cor = (art::TMWDCTrackingResult*) array_trackd_43sc->UncheckedAt(0);
//		   break;
//		  case 6:
//	        hit_tracku_cor = array_tracku_40ti->GetEntriesFast();
//            hit_trackd_cor = array_trackd_40ti->GetEntriesFast();
//            tracku_cor = (art::TMWDCTrackingResult*) array_tracku_40ti->UncheckedAt(0);
//            trackd_cor = (art::TMWDCTrackingResult*) array_trackd_40ti->UncheckedAt(0);
//		   break;
//		  case 7:
//	        hit_tracku_cor = array_tracku_41ti->GetEntriesFast();
//            hit_trackd_cor = array_trackd_41ti->GetEntriesFast();
//            tracku_cor = (art::TMWDCTrackingResult*) array_tracku_41ti->UncheckedAt(0);
//            trackd_cor = (art::TMWDCTrackingResult*) array_trackd_41ti->UncheckedAt(0);
//		   break;
//		  case 8:
//	        hit_tracku_cor = array_tracku_42ti->GetEntriesFast();
//            hit_trackd_cor = array_trackd_42ti->GetEntriesFast();
//            tracku_cor = (art::TMWDCTrackingResult*) array_tracku_42ti->UncheckedAt(0);
//            trackd_cor = (art::TMWDCTrackingResult*) array_trackd_42ti->UncheckedAt(0);
//		   break;
//		  case 9:
//	        hit_tracku_cor = array_tracku_43v->GetEntriesFast();
//            hit_trackd_cor = array_trackd_43v->GetEntriesFast();
//            tracku_cor = (art::TMWDCTrackingResult*) array_tracku_43v->UncheckedAt(0);
//            trackd_cor = (art::TMWDCTrackingResult*) array_trackd_43v->UncheckedAt(0);
//		   break;
//		  case 10:
//	        hit_tracku_cor = array_tracku_44v->GetEntriesFast();
//            hit_trackd_cor = array_trackd_44v->GetEntriesFast();
//            tracku_cor = (art::TMWDCTrackingResult*) array_tracku_44v->UncheckedAt(0);
//            trackd_cor = (art::TMWDCTrackingResult*) array_trackd_44v->UncheckedAt(0);
//		   break;
//		  case 11:
//	        hit_tracku_cor = array_tracku_46v->GetEntriesFast();
//            hit_trackd_cor = array_trackd_46v->GetEntriesFast();
//            tracku_cor = (art::TMWDCTrackingResult*) array_tracku_46v->UncheckedAt(0);
//            trackd_cor = (art::TMWDCTrackingResult*) array_trackd_46v->UncheckedAt(0);
//		   break;
//		  case 12:
//	        hit_tracku_cor = array_tracku_44cr->GetEntriesFast();
//            hit_trackd_cor = array_trackd_44cr->GetEntriesFast();
//            tracku_cor = (art::TMWDCTrackingResult*) array_tracku_44cr->UncheckedAt(0);
//            trackd_cor = (art::TMWDCTrackingResult*) array_trackd_44cr->UncheckedAt(0);
//		   break;
//		  case 13:
//	        hit_tracku_cor = array_tracku_45cr->GetEntriesFast();
//            hit_trackd_cor = array_trackd_45cr->GetEntriesFast();
//            tracku_cor = (art::TMWDCTrackingResult*) array_tracku_45cr->UncheckedAt(0);
//            trackd_cor = (art::TMWDCTrackingResult*) array_trackd_45cr->UncheckedAt(0);
//		   break;
//		  case 14:
//	        hit_tracku_cor = array_tracku_46cr->GetEntriesFast();
//            hit_trackd_cor = array_trackd_46cr->GetEntriesFast();
//            tracku_cor = (art::TMWDCTrackingResult*) array_tracku_46cr->UncheckedAt(0);
//            trackd_cor = (art::TMWDCTrackingResult*) array_trackd_46cr->UncheckedAt(0);
//		   break;
//		  case 15:
//	        hit_tracku_cor = array_tracku_46mn->GetEntriesFast();
//            hit_trackd_cor = array_trackd_46mn->GetEntriesFast();
//            tracku_cor = (art::TMWDCTrackingResult*) array_tracku_46mn->UncheckedAt(0);
//            trackd_cor = (art::TMWDCTrackingResult*) array_trackd_46mn->UncheckedAt(0);
//		   break;
//		  case 16:
//	        hit_tracku_cor = array_tracku_47mn->GetEntriesFast();
//            hit_trackd_cor = array_trackd_47mn->GetEntriesFast();
//            tracku_cor = (art::TMWDCTrackingResult*) array_tracku_47mn->UncheckedAt(0);
//            trackd_cor = (art::TMWDCTrackingResult*) array_trackd_47mn->UncheckedAt(0);
//		   break;
//		  case 17:
//	        hit_tracku_cor = array_tracku_48mn->GetEntriesFast();
//            hit_trackd_cor = array_trackd_48mn->GetEntriesFast();
//            tracku_cor = (art::TMWDCTrackingResult*) array_tracku_48mn->UncheckedAt(0);
//            trackd_cor = (art::TMWDCTrackingResult*) array_trackd_48mn->UncheckedAt(0);
//		   break;
//		  case 18:
//	        hit_tracku_cor = array_tracku_48fe->GetEntriesFast();
//            hit_trackd_cor = array_trackd_48fe->GetEntriesFast();
//            tracku_cor = (art::TMWDCTrackingResult*) array_tracku_48fe->UncheckedAt(0);
//            trackd_cor = (art::TMWDCTrackingResult*) array_trackd_48fe->UncheckedAt(0);
//		   break;
//		  case 19:
//            hit_tracku_cor = array_tracku_49fe->GetEntriesFast();
//            hit_trackd_cor = array_trackd_49fe->GetEntriesFast();
//            tracku_cor = (art::TMWDCTrackingResult*) array_tracku_49fe->UncheckedAt(0);
//            trackd_cor = (art::TMWDCTrackingResult*) array_trackd_49fe->UncheckedAt(0);
//		   break;
//		  case 20:
//            hit_tracku_cor = array_tracku_50fe->GetEntriesFast();
//            hit_trackd_cor = array_trackd_50fe->GetEntriesFast();
//            tracku_cor = (art::TMWDCTrackingResult*) array_tracku_50fe->UncheckedAt(0);
//            trackd_cor = (art::TMWDCTrackingResult*) array_trackd_50fe->UncheckedAt(0);
//		   break;
//    }
...
//      h_47V_org->Fill(aq_tmpt);
 ...
 TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_stm_ref4_3step_unit2_mwdcref.hist.root","recreate");
