...
void mass_calib7step_svd_stm_reflise_eventstore_maxz(){
...
//	foutselect.close();
   ...
   TFile *ofv = new TFile("output/mass/mass_calib_svd_4th_stm2_reflise_7step.hist_selected_unitlise_SSR_epsilon_angle_maxz.root","recreate");
...
//// Save the results of SVD
  ...
  Theta.Print();
   ...
   char foutname[50];
 //  std::ofstream foutmtr("output/mass/svd4th_out_stm2_reflise_8step_unitlise_SSR_epsilon_angle_maxz.dat");
   std::ofstream foutmtr("output/mass/svd4th_out_st1_reflise_7step_unitlise_SSR.dat");
...
//   std::ofstream foutmtrth("output/mass/theta_stm2_reflise_8step_unitlise_SSR_epsilon_angle_maxz.dat");
   std::ofstream foutmtrth("output/mass/theta_st1_reflise_8step_unitlise_SSR.dat");
 if (foutmtrth.fail()){
...
//    if( tracku_cor_ok && trackd_cor_ok  && angle_ok){
    if( tracku_cor_ok && trackd_cor_ok  && dia_id_1){
...
//   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_stm2_reflise_8step_unitlise_SSR_epsilon_angle_maxz.hist.root","recreate");
   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_st1_reflise_8step_unitlise_SSR_maxz.hist.root","recreate");
