...
void mass_calib3step_svd_st1_ref4_eventstore(){
 ...
 tree->AddFriend("tree1 = tree","sh13_analysis/hanai/phys/mass_calib/physics.chkmass_st1_2step_ref4.eventstore.170272.all.root"); // Add file. Basically mass calibration file.
...
// ifstream fin("/home/sh13/art_analysis/user/hanai/prm/mass/input_3step_st1_ref4.dat");
 ifstream fin("/home/sh13/art_analysis/user/hanai/prm/mass/input_3step_st1_ref5.dat");
 if (fin.fail()){
...
// ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd4th_eachstripst1_ref4_3step_unit2_SSR.dat");
 ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd4th_eachstripst1_ref5_3step_unit2_SSR.dat");
 if (fout.fail()){
...
// ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd4th_eachstripst1_ref4_3step_unit2_SSR.dat");
 ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd4th_eachstripst1_ref5_3step_unit2_SSR.dat");
 if (foutselect.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 return;
  }
...
//   TFile *ofv = new TFile("output/mass/mass_calib_svd_4th_eachstrip_st1_ref4_3step.hist_selected_unit2_SSR.root","recreate");
   TFile *ofv = new TFile("output/mass/mass_calib_svd_4th_eachstrip_st1_ref5_3step.hist_selected_unit2_SSR.root","recreate");
...
//// Save the results of SVD
  ...
  Theta.Print();
   ...
   char foutname[50];
//   std::ofstream foutmtr("output/mass/svd4th_out_st1_ref4_3step_unit2_SSR.dat");
   std::ofstream foutmtr("output/mass/svd4th_out_st1_ref5_3step_unit2_SSR.dat");
...
//   std::ofstream foutmtrth("output/mass/theta_st1_ref4_3step_unit2_SSR.dat");
   std::ofstream foutmtrth("output/mass/theta_st1_ref5_3step_unit2_SSR.dat");
 if (foutmtrth.fail()){
...
//   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_st1_ref4_3step_unit2_SSR.hist.root","recreate");
   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_st1_ref5_3step_unit2_SSR.hist.root","recreate");
