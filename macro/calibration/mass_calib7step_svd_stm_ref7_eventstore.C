...
void mass_calib7step_svd_stm_ref7_eventstore(){
 ...
 tree->AddFriend("tree1 = tree","sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_6step_ref6.eventstore.170272.all.root"); // Add file. Basically mass calibration file.
  ...
  const Int_t Nrun = 2200;  //the number of runs
  const Int_t Nrun_ni = 300;  //the number of runs
  const Int_t Nref =  27;  // the number of species for reference
 ...
 ifstream fin("/home/sh13/art_analysis/user/hanai/prm/mass/input_7step_stm_ref7.dat");
 if (fin.fail()){
 ...
 TMatrixD value_mahala_pop(Nevt,9); // output the fitting value 
...
////ref7test
//     Double_t t = (ti - 2042.) * 0.125 + 1;  
////     Double_t t = (ti - 2042.) * 0.025;  
//     Double_t x3 = x3i * 0.1 * 0.5;  
//     Double_t a3 = (a3i * 0.1 + 0.5) * 0.5;
//     Double_t y3 = (y3i + 2 + 0.5) * 0.5;
//     Double_t b3 = (b3i * 0.05 + 0.5) * 0.5;
//     Double_t x0 = (x0i * 0.015) * 0.5; 
//     Double_t x2 = (x2i * 0.1 + 0.5) * 0.5; 
//     Double_t a2 = a2i * 0.025 * 0.5;
//     Double_t y2 = (y2i * 0.05 - 0.5) * 0.5;
//     Double_t b2 = (b2i * 0.05 + 1.3) * 0.5;
...
//   TFile *ofv = new TFile("output/mass/mass_calib_svd_4th_stm2_ref7_7step.hist_selected_unit2.5_SSR_epsilon.root","recreate");
//   TFile *ofv = new TFile("output/mass/mass_calib_svd_4th_stm2_ref7_7step.hist_selected_unitref7_SSR_epsilon.root","recreate");
   TFile *ofv = new TFile("output/mass/mass_calib_svd_4th_stm2_ref7_7step.hist_selected_reunit_SSR_epsilon.root","recreate");
...
//  TFile *ofv_mahala = new TFile("sh13_analysis/hanai/output/Mahala_correlation_mahala_calib7step_stm_ref7.hist.root","recreate");
//  TFile *ofv_mahala = new TFile("sh13_analysis/hanai/output/Mahala_correlation_mahala_calib7step_stm_ref7_unitref7.hist.root","recreate");
  TFile *ofv_mahala = new TFile("sh13_analysis/hanai/output/Mahala_correlation_mahala_calib7step_stm_ref7_reunit.hist.root","recreate");
...
// ofstream foutmahalaR("/home/sh13/art_analysis/user/hanai/prm/mass/mahala/mahalaR_calib7step_stm_ref7.dat");
// ofstream foutmahalaR("/home/sh13/art_analysis/user/hanai/prm/mass/mahala/mahalaR_calib7step_stm_ref7_unitref7.dat");
 ofstream foutmahalaR("/home/sh13/art_analysis/user/hanai/prm/mass/mahala/mahalaR_calib7step_stm_ref7_reunit.dat");
...
// ofstream foutmahalaRi("/home/sh13/art_analysis/user/hanai/prm/mass/mahala/mahalaRi_calib7step_stm_ref7.dat");
// ofstream foutmahalaRi("/home/sh13/art_analysis/user/hanai/prm/mass/mahala/mahalaRi_calib7step_stm_ref7_unitref7.dat");
 ofstream foutmahalaRi("/home/sh13/art_analysis/user/hanai/prm/mass/mahala/mahalaRi_calib7step_stm_ref7_reunit.dat");
...
//// Save the results of SVD
  ...
  Theta.Print();
   ...
   char foutname[50];
//   std::ofstream foutmtr("output/mass/svd4th_out_stm2_ref7_8step_unit2.5_SSR_epsilon.dat");
   std::ofstream foutmtr("output/mass/svd4th_out_stm2_ref7_8step_reunit_SSR_epsilon.dat");
...
//   std::ofstream foutmtrth("output/mass/theta_stm2_ref7_8step_unit2.5_SSR_epsilon.dat");
   std::ofstream foutmtrth("output/mass/theta_stm2_ref7_8step_reunit_SSR_epsilon.dat");
 if (foutmtrth.fail()){
...
//// AoQ cor
  ...
  for (Int_t iData = 0; iData < nData; iData++){
    ...
    if( tracku_cor_ok && trackd_cor_ok){
...
////ref7
//     Double_t t_cor = (ti_cor - 2042.) * 0.125 + 1;  
////     Double_t t = (ti - 2042.) * 0.025;  
//     Double_t x3_cor = x3i_cor * 0.1 * 0.5;  
//     Double_t a3_cor = (a3i_cor * 0.1 + 0.5) * 0.5;
//     Double_t y3_cor = (y3i_cor + 2 + 0.5) * 0.5;
//     Double_t b3_cor = (b3i_cor * 0.05 + 0.5) * 0.5;
//     Double_t x0_cor = (x0i_cor * 0.015) * 0.5; 
//     Double_t x2_cor = (x2i_cor * 0.1 + 0.5) * 0.5; 
//     Double_t a2_cor = a2i_cor * 0.025 * 0.5;
//     Double_t y2_cor = (y2i_cor * 0.05 - 0.5) * 0.5;
//     Double_t b2_cor = (b2i_cor * 0.05 + 1.3) * 0.5;
...
// 	   b_re_elem += A(ic,ir) * Theta(ir);
 ...
 TH1D *h_41Ca_sol = new TH1D("h41Ca_sol", "h41Ca_sol",5000,2.040,2.060);
 ...
 TH1D *h_43Sc_sol = new TH1D("h43Sc_sol", "h43Sc_sol",5000,2.04,2.060);
 ...
 TH1D *h_47V_sol  = new TH1D("h47V_sol", "h47V_sol",5000,2.035,2.055);
 ...
 TH1D *h_51Cr_sol = new TH1D("h51Cr_sol", "h51Cr_sol",5000,2.11,2.13);
 ...
 TH1D *h_49Mn_sol = new TH1D("h49Mn_sol", "h49Mn_sol",5000,1.95,1.97);
                                    
 TH1D *h_48Fe_sol = new TH1D("h48Fe_sol", "h48Fe_sol",5000,1.835,1.855);
 TH1D *h_49Fe_sol = new TH1D("h49Fe_sol", "h49Fe_sol",5000,1.87,1.89);
 TH1D *h_50Fe_sol = new TH1D("h50Fe_sol", "h50Fe_sol",5000,1.91,1.930);

 TH1D *h_50Co_sol = new TH1D("h50Co_sol", "h50Co_sol",5000,1.84,1.86);
 TH1D *h_51Co_sol = new TH1D("h51Co_sol", "h51Co_sol",5000,1.875,1.895);
 ...
 Int_t Nrun_26 = 26 * Nrun;
 Int_t Nrun_27 = Nrun_26 * Nrun_ni;
 ...
 } else if(Nrun_25 <= isol && isol  < Nrun_26){
	 h_51Co_sol->Fill(b_re(isol));
 } else if(Nrun_26 <= isol && isol  < Nrun_27){
...
// Output
 ...
 TH1D *h_41Ca = new TH1D("h41Ca", "h41Ca",5000,2.040,2.060);
                                                            
 TH1D *h_40Sc = new TH1D("h40Sc", "h40Sc",5000,1.900,1.92);
 TH1D *h_41Sc = new TH1D("h41Sc", "h41Sc",5000,1.945,1.965);
 TH1D *h_43Sc = new TH1D("h43Sc", "h43Sc",5000,2.04,2.060);
 ...
 TH1D *h_47V  = new TH1D("h47V", "h47V",5000,2.035,2.055);
 ...
 TH1D *h_51Cr = new TH1D("h51Cr", "h51Cr",5000,2.11,2.13);
...
//	  tree->Fill();
 ...
 }else if(Z_low[21] < z_tmpt && z_tmpt < Z_up[21]){

      h_48Fe->Fill(Aq_cor[iData]);
      h_49Fe->Fill(Aq_cor[iData]);
      h_50Fe->Fill(Aq_cor[iData]);

 }else if(Z_low[24] < z_tmpt && z_tmpt < Z_up[24]){

      h_50Co->Fill(Aq_cor[iData]);
      h_51Co->Fill(Aq_cor[iData]);

 }else if(Z_low[26] < z_tmpt && z_tmpt < Z_up[26]){
...
//// Draw original histogram
 ...
 TH1D *h_47V_org = new TH1D("h47V_org", "h47V_org",5000,2.035,2.055);
 ...
 TH1D *h_47Cr_org = new TH1D("h47Cr_org", "h47Cr",5000,1.95,1.97);
 TH1D *h_51Cr_org = new TH1D("h51Cr_org", "h51Cr",5000,2.11,2.13);
 ...
 TH1D *h_49Mn_org = new TH1D("h49Mn_org", "h49Mn_org",5000,1.95,1.97);
                                                                        
 TH1D *h_48Fe_org = new TH1D("h48Fe_org", "h48Fe_org",5000,1.835,1.855);
 TH1D *h_49Fe_org = new TH1D("h49Fe_org", "h49Fe_org",5000,1.87,1.89);
 TH1D *h_50Fe_org = new TH1D("h50Fe_org", "h50Fe_org",5000,1.91,1.930);

 TH1D *h_50Co_org = new TH1D("h50Co_org", "h50Co_org",5000,1.84,1.86);
 TH1D *h_51Co_org = new TH1D("h51Co_org", "h51Co_org",5000,1.875,1.895);
 ...
 }else if(Z_low[10] < z_tmpt && z_tmpt < Z_up[10]){
...
//   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_stm2_ref7_8step_unitref7.hist.root","recreate");
   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_stm2_ref7_8step_reunit.hist.root","recreate");
