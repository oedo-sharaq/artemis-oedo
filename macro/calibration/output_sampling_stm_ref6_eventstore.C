...
void output_sampling_stm_ref6_eventstore(){
...
// 4th order
 ...
 ofstream fouta("/home/sh13/art_analysis/user/hanai/prm/mass/set_Amatrix_svd4th_stm2_ref6_6step_unit2.5_SSR.csv");
 if (fouta.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 return;
  }

 ofstream foutb("/home/sh13/art_analysis/user/hanai/prm/mass/set_bmatrix_svd4th_stm2_ref6_6step_unit2.5_SSR.csv");
 if (foutb.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 return;
  }

 ofstream foutb_singl("/home/sh13/art_analysis/user/hanai/prm/mass/set_b_singlmatrix_svd4th_stm2_ref6_6step_unit2.5_SSR.csv");
 if (foutb_singl.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 return;
  }
...
for(int n = 0; n < Nevt; n++){
    foutb_singl.precision(10);
	foutb_singl << b_singl(n,0) << ", " << endl;
}
   foutb_singl.close();
