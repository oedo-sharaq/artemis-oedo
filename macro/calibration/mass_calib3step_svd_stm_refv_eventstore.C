...
void mass_calib3step_svd_stm_refv_eventstore(){
...
// 4th order
 ...
 ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd4th_stm2_refv_3step_unit2_SSR.dat");
// ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd4th_stm2_ref4_3step_unit2_SSRBVar.dat");
// ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd4th_stm2_ref4_3step_unit2_SSRBVarY.dat");
 if (fout.fail()){
...
for(int n = 0; n < Nevt; n++){
 ...
 ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd4th_stm2_refv_3step_unit2_SSR.dat");
// ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd4th_stm2_ref4_3step_unit2_SSRBVar.dat");
// ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd4th_stm2_ref4_3step_unit2_SSRBVarY.dat");
 if (foutselect.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 return;
  }
...
for(int n = 0; n < Nevt; n++){
   ...
   TFile *ofv = new TFile("output/mass/mass_calib_svd_4th_stm2_refv_3step.hist_selected_unit2_SSR.root","recreate");
//   TFile *ofv = new TFile("output/mass/mass_calib_svd_4th_stm2_ref4_3step.hist_selected_unit2_SSRBVar.root","recreate");
//   TFile *ofv = new TFile("output/mass/mass_calib_svd_4th_stm2_ref4_3step.hist_selected_unit2_SSRBVarY.root","recreate");
...
//// Save the results of SVD
  ...
  Theta.Print();
   ...
   char foutname[50];
   std::ofstream foutmtr("output/mass/svd4th_out_stm2_refv_3step_unit2_SSR.dat");
//   std::ofstream foutmtr("output/mass/svd4th_out_stm2_ref4_3step_unit2_SSRBVar.dat");
//   std::ofstream foutmtr("output/mass/svd4th_out_stm2_ref4_3step_unit2_SSRBVarY.dat");
   ...
   std::ofstream foutmtrth("output/mass/theta_stm2_refv_3step_unit2_SSR.dat");
//   std::ofstream foutmtrth("output/mass/theta_stm2_ref4_3step_unit2_SSRBVar.dat");
//   std::ofstream foutmtrth("output/mass/theta_stm2_ref4_3step_unit2_SSRBVarY.dat");
 if (foutmtrth.fail()){
...
for(int ic = 0; ic < Nevt; ic++ ){
 ...
 TH1D *h_47V_sol  = new TH1D("h47V_sol", "h47V_sol",1000,2.04,2.042);
 ...
 TH1D *h_49Cr_sol = new TH1D("h49Cr_sol", "h49Cr_sol",1000,2.03,2.05);
...
// Output
 ...
 TH1D *h_47V  = new TH1D("h47V", "h47V",1000,2.04,2.042);
 ...
 TH1D *h_49Cr = new TH1D("h49Cr", "h49Cr",1000,2.03,2.05);
...
//// Draw original histogram
 ...
 TH1D *h_47V_org = new TH1D("h47V_org", "h47V_org",1000,2.04,2.042);
 ...
 TH1D *h_49Cr_org = new TH1D("h49Cr_org", "h49Cr",1000,2.03,2.05);
 ...
 TH2D *h_zaq_org = new TH2D("zaq_org", "zaq_org",500,1.7,2.3,500,18,30);
  ...
  for (Int_t iData = 0; iData < nData; iData++){
   ...
   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_stm2_refv_3step_unit2_SSR.hist.root","recreate");
//   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_stm2_ref4_3step_unit2_SSRBVar.hist.root","recreate");
//   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_stm2_ref4_3step_unit2_SSRBVarY.hist.root","recreate");
