...
void mass_calib8step_svd_stm_refliseT_eventstore(){
...
// ifstream fin("/home/sh13/art_analysis/user/hanai/prm/mass/input_8step_stm_reflise.dat");
 ifstream fin("/home/sh13/art_analysis/user/hanai/prm/mass/input_8step_stm_refliseT.dat");
 if (fin.fail()){
...
//   TFile *ofv = new TFile("output/mass/mass_calib_svd_4th_stm2_reflise_8step.hist_selected_unitlise_SSR_mahala.root","recreate");
   TFile *ofv = new TFile("output/mass/mass_calib_svd_4th_stm2_refliseT_8step.hist_selected_unitlise_SSR_mahala.root","recreate");
...
//   std::ofstream foutmtr("output/mass/svd4th_out_stm2_reflise_8step_unitlise_SSR_mahala.dat");
   std::ofstream foutmtr("output/mass/svd4th_out_stm2_refliseT_8step_unitlise_SSR_mahala.dat");
...
//   std::ofstream foutmtrth("output/mass/theta_stm2_reflise_8step_unitlise_SSR_mahala.dat");
   std::ofstream foutmtrth("output/mass/theta_stm2_refliseT_8step_unitlise_SSR_mahala.dat");
...
//	  tree->Fill();
 ...
 }else if(Z_low[8] < z_tmpt && z_tmpt < Z_up[8]){
...
//   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_stm2_reflise_8step_unitlise_SSR_mahala.hist.root","recreate");
   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_stm2_refliseT_8step_unitlise_SSR_mahala.hist.root","recreate");
