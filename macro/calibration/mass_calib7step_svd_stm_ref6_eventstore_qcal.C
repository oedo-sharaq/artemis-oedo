...
void mass_calib7step_svd_stm_ref6_eventstore_qcal(){

 TFile* file_load = TFile::Open("sh13_analysis/hanai/phys/bld_file/BLD_stm_prmhist_qcal/physics.bld_stm_qcal.170272.all.root"); // Load file. Basically BLD file.
  if(!file_load){
...
// 4th order
 ...
 ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd4th_stm2_ref6_7step_unit2.5_SSR_qcal.dat");
...
for(int n = 0; n < Nevt; n++){
 ...
 ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd4th_stm2_ref6_7step_unit2.5_SSR_qcal.dat");
...
for(int n = 0; n < Nevt; n++){
   ...
   TFile *ofv = new TFile("output/mass/mass_calib_svd_4th_stm2_ref6_7step.hist_selected_unit2.5_SSR_qcal.root","recreate");
...
//// Save the results of SVD
  ...
  Theta.Print();
   ...
   char foutname[50];
   std::ofstream foutmtr("output/mass/svd4th_out_stm2_ref6_7step_unit2.5_SSR_qcal.dat");
//   std::ofstream foutmtr("output/mass/svd4th_out_stm2_ref6_6step_unit2.5_SSR_posmod.dat");
   ...
   std::ofstream foutmtrth("output/mass/theta_stm2_ref6_7step_unit2.5_SSR_qcal.dat");
...
//// Draw original histogram
 ...
 TH2D *h_zaq_org = new TH2D("zaq_org", "zaq_org",500,1.7,2.3,500,18,30);
  ...
  for (Int_t iData = 0; iData < nData; iData++){
   ...
   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_stm2_ref6_7step_unit2.5_SSR_qcal.hist.root","recreate");
