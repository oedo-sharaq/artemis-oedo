...
// TFile* file = TFile::Open("sh13_analysis/hanai/phys/merge/physics_merge_ref2_eachstrip.all.170272.root");
...
// ifstream fin("/home/sh13/art_analysis/user/hanai/prm/mass/input2.dat");
 if (fin.fail()){
...
// ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd3rd_eachstripst2_ref2.dat");
 ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd3rd_eachstripst2_BLD.dat");
 if (fout.fail()){
...
// ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd3rd_eachstripst2_ref2.dat");
 ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd3rd_eachstripst2_BLD.dat");
 if (foutselect.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 return;
  }
...
//// Save the results of SVD
  ...
  Theta.Print();
   ...
   char foutname[50];
 //  std::ofstream foutmtr("output/mass/svd3rd_out_st2_ref2.dat");
   std::ofstream foutmtr("output/mass/svd3rd_out_st2_BLD.dat");
 ...
 //  std::ofstream foutmtrth("output/mass/theta_st2_ref2.dat");
   std::ofstream foutmtrth("output/mass/theta_st2_BLD.dat");
 if (foutmtrth.fail()){
...
//   TFile *ofile = new TFile("output/mass/mass_calib_svd_3rd_eachstrip_st2.hist.root","recreate");
//   TFile *ofile = new TFile("output/mass/mass_calib_svd_3rd_eachstrip_st2_ref2.hist.root","recreate");
   TFile *ofile = new TFile("output/mass/mass_calib_svd_3rd_eachtrip_st2_BLD.hist.root","recreate");
