...
void mass_calib8step_svd_stm_reflise_eventstore(){
...
//  const Int_t Nrun = 1000;  //the number of runs
  ...
  const Int_t Nrun_casc = 5000;  //the number of runs
...
//   std::ofstream foutmtr("output/mass/svd4th_out_stm2_reflise_8step_unitlise_SSR_mahala_cascmashi.dat");
   std::ofstream foutmtr("output/mass/svd4th_out_stm2_reflise_8step_unitlise_SSR_mahala_cascmashi_narrow.dat");
...
//   std::ofstream foutmtrth("output/mass/theta_stm2_reflise_8step_unitlise_SSR_mahala.dat");
   std::ofstream foutmtrth("output/mass/theta_stm2_reflise_8step_unitlise_SSR_mahala_cascmashi_narrow.dat");
...
//   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_stm2_reflise_8step_unitlise_SSR_mahala_cascmashi.hist.root","recreate");
   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_stm2_reflise_8step_unitlise_SSR_mahala_cascmashi_narrow.hist.root","recreate");
