...
void mass_calib7step_svd_stm_ref8_eventstore(){
...
//// Save the results of SVD
  ...
  Theta.Print();
   ...
   char foutname[50];
//   std::ofstream foutmtr("output/mass/svd4th_out_stm2_ref7_8step_unit2.5_SSR.dat");
...
//   std::ofstream foutmtrth("output/mass/theta_stm2_ref7_8step_unit2.5_SSR.dat");
...
//// AoQ cor
  ...
  for (Int_t iData = 0; iData < nData; iData++){
    ...
    if( tracku_cor_ok && trackd_cor_ok && ssrd < 0.1){
...
// 	   b_re_elem += A(ic,ir) * Theta(ir);
 ...
 TH1D *h_46V_sol  = new TH1D("h46V_sol", "h46V_sol",5000,1.985,2.005);
 ...
 Int_t Nrun_27 = 27 * Nrun;
 Int_t Nrun_28 = Nrun_27 + Nrun_ni;
 ...
 } else if(Nrun_27 <= isol && isol  < Nrun_28){
...
// Output
 ...
 TH1D *h_46V  = new TH1D("h46V", "h46V",5000,1.985,2.005);
...
//	  tree->Fill();
 ...
 }else if(Z_low[27] < z_tmpt && z_tmpt < Z_up[27]){
...
//// Draw original histogram
 ...
 TH1D *h_46V_org = new TH1D("h46V_org", "h46V_org",5000,1.985,2.005);
