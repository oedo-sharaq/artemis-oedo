...
// tree->SetBranchAddress("mass_corst1_BLD_3rd",&array_mass_corst1);
 tree->SetBranchAddress("mass_corst1_BLD_4th",&array_mass_corst1);
...
// ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd4th_eachstripst1_ref1_4step.dat");
// ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd4th_eachstripst1_ref2_4step.dat");
// ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd4th_eachstripst1_ref2_4step_nooff.dat");
 ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd4th_eachstripst1_ref2_4.5step_nooff.dat");
 if (fout.fail()){
...
//// Save the results of SVD
  ...
  Theta.Print();
   ...
   char foutname[50];
//   std::ofstream foutmtr("output/mass/svd4th_out_st1_ref1_4step.dat");
//   std::ofstream foutmtr("output/mass/svd4th_out_st1_ref2_4step.dat");
//   std::ofstream foutmtr("output/mass/svd4th_out_st1_ref2_4step_nooff.dat");
   std::ofstream foutmtr("output/mass/svd4th_out_st1_ref2_4.5step_nooff.dat");
...
//   std::ofstream foutmtrth("output/mass/theta_st1_ref1_4step.dat");
//   std::ofstream foutmtrth("output/mass/theta_st1_ref2_4step.dat");
 //  std::ofstream foutmtrth("output/mass/theta_st1_ref2_4step_nooff.dat");
   std::ofstream foutmtrth("output/mass/theta_st1_ref2_4.5step_nooff.dat");
 if (foutmtrth.fail()){
...
//// AoQ cor
  ...
  for (Int_t iData = 0; iData < nData; iData++){
    double sum = 0.;
     ...
     tree->GetEntry(iData);
//	 art::TDiaTimingData *dia_tof32st1cor = (art::TDiaTimingData*) array_dia_tof32st1_off->UncheckedAt(0);
...
//    Int_t hit_dia_tof32st1cor = array_dia_tof32st1_off->GetEntriesFast();
