...
void mass_calib6step_svd_stm_ref6_plsMahala(){
...
// ifstream fin("/home/sh13/art_analysis/user/hanai/prm/mass/input_6step_stm_ref6_forMahara.dat");
 ...
 TMatrixD value_mahala_tgt(Nevt_tgt,10); // output the fitting value 
...
// 4th order
  ...
  Int_t itgt = ievt - Nevt_pop;

     value_mahala_tgt(itgt,0) = t;
     value_mahala_tgt(itgt,1) = x3;
     value_mahala_tgt(itgt,2) = a3;
     value_mahala_tgt(itgt,3) = y3;
     value_mahala_tgt(itgt,4) = b3;
     value_mahala_tgt(itgt,5) = x0;
     value_mahala_tgt(itgt,6) = x2;
     value_mahala_tgt(itgt,7) = a2;
     value_mahala_tgt(itgt,8) = y2;
     value_mahala_tgt(itgt,9) = b2;
 }
     ievt++;
 ...
 ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd4th_stm2_ref6_6step_unit2.5_SSR_Mahara.dat");
...
for(int n = 0; n < Nevt_pop; n++){
 ...
 ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd4th_stm2_ref6_6step_unit2.5_SSR_Mahara.dat");
...
for(int s = 0; s < Nrun; s++){
 for (int k = 0; k < Nopt; k++){
  for(int n = 0; n < Ntgt1; n++){

   mean_1tgt[k] =+ value_mahala_tgt(n,k) / Nrun;

 }
 
 for(int nn = 0; nn < Ntgt1; nn++){

 var_1tgt[k]  =+ ( (value_mahala_tgt(nn,k) - mean_1tgt[k]) * (value_mahala_tgt(nn,k) - mean_1tgt[k]) ) / Nrun;
...
for(int s = 0; s < Nrun; s++){
 for (int k = 0; k < Nopt; k++){
  for(int n = Ntgt1; n < Ntgt2; n++){

   mean_2tgt[k] =+ value_mahala_tgt(n,k) / Nrun;

 }
 
 for(int nn = Ntgt1; nn < Ntgt2; nn++){

 var_2tgt[k]  =+ ( (value_mahala_tgt(nn,k) - mean_2tgt[k]) * (value_mahala_tgt(nn,k) - mean_2tgt[k]) ) / Nrun;
 ...
 value_2tgt(s,k) =  (value_mahala_tgt(s,k) - mean_2tgt[k]) / sdv_2tgt[k];
...
for(int s = 0; s < Nrun; s++){
 for (int k = 0; k < Nopt; k++){
  for(int n = Ntgt2; n < Ntgt3; n++){

   mean_3tgt[k] =+ value_mahala_tgt(n,k) / Nrun;

 }
 
 for(int nn = Ntgt2; nn < Ntgt3; nn++){

 var_3tgt[k]  =+ ( (value_mahala_tgt(nn,k) - mean_3tgt[k]) * (value_mahala_tgt(nn,k) - mean_3tgt[k]) ) / Nrun;
 ...
 value_3tgt(s,k) =  (value_mahala_tgt(s,k) - mean_3tgt[k]) / sdv_3tgt[k];
...
for(int s = 0; s < Nrun; s++){
 for (int k = 0; k < Nopt; k++){
  for(int n = Ntgt3; n < Ntgt4; n++){

   mean_4tgt[k] =+ value_mahala_tgt(n,k) / Nrun;

 }
 
 for(int nn = Ntgt3; nn < Ntgt4; nn++){

 var_4tgt[k]  =+ ( (value_mahala_tgt(nn,k) - mean_4tgt[k]) * (value_mahala_tgt(nn,k) - mean_4tgt[k]) ) / Nrun;
 ...
 value_4tgt(s,k) =  (value_mahala_tgt(s,k) - mean_4tgt[k]) / sdv_4tgt[k];
...
for(int s = 0; s < Nrun; s++){
 for (int k = 0; k < Nopt; k++){
  for(int n = Ntgt4; n < Ntgt5; n++){

   mean_5tgt[k] =+ value_mahala_tgt(n,k) / Nrun;

 }
 
 for(int nn = Ntgt4; nn < Ntgt5; nn++){

 var_5tgt[k]  =+ ( (value_mahala_tgt(nn,k) - mean_5tgt[k]) * (value_mahala_tgt(nn,k) - mean_5tgt[k]) ) / Nrun;
 ...
 value_5tgt(s,k) =  (value_mahala_tgt(s,k) - mean_5tgt[k]) / sdv_5tgt[k];
...
// Fill the distance to hist
 ...
 ofstream foutmahalaR("/home/sh13/art_analysis/user/hanai/prm/mass/mahala/stm2_ref6_6step_MahalaR.dat");
...
for(int i = 0; i < Nopt; i++){
 ...
 TH1D *hmahala1 = new TH1D("hmahala1","Mahala 41Ca",500,-5,5);
...
for(int qq = 0; qq < Nrun; qq++){
 ...
 TH1D *hmahala2 = new TH1D("hmaraha2","Mahara 43Sc",500,-5,5);
 ofstream foutmahala2tgt("/home/sh13/art_analysis/user/hanai/prm/mass/mahala/stm2_ref6_6step_Mahala_tgt2.dat");
...
for(int qq = 0; qq < Nrun; qq++){
 ...
 TH1D *hmahala3 = new TH1D("hmaraha2","Mahara 46V",500,-5,5);
 ofstream foutmahala3tgt("/home/sh13/art_analysis/user/hanai/prm/mass/mahala/stm2_ref6_6step_Mahala_tgt3.dat");
...
for(int qq = 0; qq < Nrun; qq++){
 ...
 TH1D *hmahala4 = new TH1D("hmaraha4","Mahara 47V",500,-5,5);
 ofstream foutmahala4tgt("/home/sh13/art_analysis/user/hanai/prm/mass/mahala/stm2_ref6_6step_Mahala_tgt4.dat");
...
for(int qq = 0; qq < Nrun; qq++){
 ...
 TH1D *hmahala5 = new TH1D("hmaraha5","Mahara 51Cr",500,-5,5);
 ofstream foutmahala5tgt("/home/sh13/art_analysis/user/hanai/prm/mass/mahala/stm2_ref6_6step_Mahala_tgt5.dat");
...
// Write matrix
 ...
 TFile *ofile = new TFile("output/mass/mahala/mahala_stm2_6step_ref6.hist.root","recreate");
 hmahala1->Write();
 hmahala2->Write();
 hmahala3->Write();
 hmahala4->Write();
...
//// Save the results of SVD
  ...
  Theta.Print();
   ...
   char foutname[50];
 //  std::ofstream foutmtr("output/mass/svd4th_out_stm2_ref6_6step_unit2.5_SSR_Mahara.dat");
   std::ofstream foutmtr("output/mass/svd4th_out_stm2_ref6_6step_unit2.5_SSR_Mahara2.dat");
...
//   std::ofstream foutmtrth("output/mass/theta_stm2_ref6_6step_unit2.5_SSR_Mahara.dat");
   std::ofstream foutmtrth("output/mass/theta_stm2_ref6_6step_unit2.5_SSR_Mahara2.dat");
 if (foutmtrth.fail()){
