...
////  while(!fin.eof()){
////	 //   fin.precision(10);
////	    fin >> Ref_m_tmp >> Z_low_tmp >> Z_up_tmp >> Aq_low_tmp >> Aq_up_tmp >> weight_buff;
...
//// fin.close();
 ...
 TMatrixD W(57090,57089); // output the fitting value 
...
//     value(ievt,13) = ssrd;
//
////  for(int ievt_c = 0; ievt_c < Nevt; ievt_c++){
////      if(ievt == ievt_c){ 
////           W(ievt,ievt_c) = scale / weight[iref];
////      }else{
////           W(ievt,ievt_c) = 0;
////      }
////  }
...
//////          Cov.Mult(At,WA);
//////
////// TMatrixD AtW(Nprm,Nevt);
//////          AtW.Mult(At,W);
//////
////// TMatrixD AtWb(Nprm,1);
//////          AtWb.Mult(AtW,b);
//////
////// TVectorD AtWb_v = TMatrixDColumn(AtWb,0);
//////  
