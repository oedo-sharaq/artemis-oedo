...
void mass_calib8step_svd_stm_refliseS_eventstore_w(){
...
// ifstream fin("/home/sh13/art_analysis/user/hanai/prm/mass/input_8step_stm_reflise.dat");
 ifstream fin("/home/sh13/art_analysis/user/hanai/prm/mass/input_8step_stm_refliseS_w.dat");
 if (fin.fail()){
...
//     b(ievt,0) = Ref_m[iref];
     b(ievt,0) = Ref_m[iref] * weightscale ;
...
// 4th order
 ...
 if(ievt != Nevt){
	 cout << "The number of samling events is " << ievt << " Not equal to the number of total events" << Nevt << endl;
 }else{
	 cout << "The number of sampling events is " << ievt << " " << endl;
	 }
 if(!HasEvents){
...
//   TFile *ofv = new TFile("output/mass/mass_calib_svd_4th_stm2_refliseS_8step.hist_selected_unitlise_SSR_mahala.root","recreate");
   TFile *ofv = new TFile("output/mass/mass_calib_svd_4th_stm2_refliseS_8step_w.hist_selected_unitlise_SSR_mahala.root","recreate");
...
//// Save the results of SVD
  ...
  Theta.Print();
   ...
   char foutname[50];
//   std::ofstream foutmtr("output/mass/svd4th_out_stm2_reflise_8step_unitlise_SSR_mahala.dat");
 //  std::ofstream foutmtr("output/mass/svd4th_out_stm2_refliseS_8step_unitlise_SSR_mahala.dat");
   std::ofstream foutmtr("output/mass/svd4th_out_stm2_refliseS_8step_w_unitlise_SSR_mahala.dat");
//   std::ofstream foutmtr("output/mass/svd4th_out_stm2_reflise_8step_unitlise2_SSR_mahala.dat");
//   std::ofstream foutmtr("output/mass/svd4th_out_stm2_reflise_8step_unitlise2_SSR_mahala_casc_mashi.dat");
...
//   std::ofstream foutmtrth("output/mass/theta_stm2_reflise_8step_unitlise_SSR_mahala.dat");
//   std::ofstream foutmtrth("output/mass/theta_stm2_refliseS_8step_unitlise_SSR_mahala.dat");
   std::ofstream foutmtrth("output/mass/theta_stm2_refliseS_8step_w_unitlise_SSR_mahala.dat");
//   std::ofstream foutmtrth("output/mass/theta_stm2_reflise_8step_unitlise2_SSR_mahala.dat");
//   std::ofstream foutmtrth("output/mass/theta_stm2_reflise_8step_unitlise2_SSR_mahala_cascmashi.dat");
 if (foutmtrth.fail()){
...
// 	   b_re_elem += A(ic,ir) * Theta(ir);
 ...
 TH1D *h_47Cr_sol = new TH1D("h47Cr_sol", "h47Cr_sol",5000,1.95,1.97);
...
// Output
 ...
 TH1D *h_47Cr = new TH1D("h47Cr", "h47Cr",5000,1.95,1.97);
...
//	  tree->Fill();
 ...
 }else if(Z_low[16] < z_tmpt && z_tmpt < Z_up[16]){
 ...
 }else if(Z_low[19] < z_tmpt && z_tmpt < Z_up[19]){
...
//// Draw original histogram
 ...
 TH1D *h_47Cr_org = new TH1D("h47Cr_org", "h47Cr_org",5000,1.95,1.97);
...
//   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_stm2_reflise_8step_unitlise_SSR_mahala.hist.root","recreate");
//   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_stm2_refliseS_8step_unitlise_SSR_mahala.hist.root","recreate");
   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_stm2_refliseS_8step_w_unitlise_SSR_mahala.hist.root","recreate");
//   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_stm2_reflise_8step_unitlise2_SSR_mahala.hist.root","recreate");
//   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_stm2_reflise_8step_unitlise2_SSR_mahala_cascmashi.hist.root","recreate");
