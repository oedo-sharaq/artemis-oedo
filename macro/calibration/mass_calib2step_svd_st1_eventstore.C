...
void mass_calib2step_svd_st1_eventstore(){

 TFile* file_load = TFile::Open("sh13_analysis/hanai/phys/bld_file/physics.bld.170272.all.root"); // Load file. Basically BLD file.
// TFile* file_load = TFile::Open("sh13_analysis/hanai/phys/bld_file/BLD_ssdpla/BLD_tpla_ssdpla.170272.all.root");
  if(!file_load){
...
// tree->AddFriend("tree1 = tree","sh13_analysis/hanai/phys/merge/physics.chkmass_st1_1step.eventstore.170272.all.root"); // Add file. Basically mass calibration file.
 tree->AddFriend("tree1 = tree","sh13_analysis/hanai/phys/mass_calib/physics.chkmass_st1_1step_ref4.eventstore.170272.all.root"); // Add file. Basically mass calibration file.
// tree->AddFriend("tree1 = tree","sh13_analysis/hanai/phys/mass_calib/physics.chkmass_st1_1step_ssdpla.eventstore.170272.all.root"); // Add file. Basically mass calibration file.
...
// tree->SetBranchAddress("mass_corst1_BLD_ssdpla",&array_mass_corst1);
...
// tree->SetBranchStatus("mass_corst1_BLD_ssdpla",1);
 ...
 ifstream fin("/home/sh13/art_analysis/user/hanai/prm/mass/input_2step_st1_ref4.dat");
 if (fin.fail()){
...
// ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd3rd_eachstripst1_ref1_2step.dat");
 ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd3rd_eachstripst1_ref1_2step_BLD_ref4.dat");
// ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd3rd_eachstripst1_ref1_2step_ssdpla.dat");
 if (fout.fail()){
...
for(int n = 0; n < Nevt; n++){
 ...
 ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd3rd_eachstripst1_ref1_2step_BLD_ref4.dat");
// ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd3rd_eachstripst1_ref1_2step_ssdpla.dat");
 if (foutselect.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 return;
  }
...
//// Save the results of SVD
  ...
  Theta.Print();
   ...
   char foutname[50];
   std::ofstream foutmtr("output/mass/svd3rd_out_st1_ref1_2step_BLD_ref4.dat");
//   std::ofstream foutmtr("output/mass/svd3rd_out_st1_ref1_2step_ssdpla.dat");
   ...
   std::ofstream foutmtrth("output/mass/theta_st1_ref1_2step_BLD_ref4.dat");
//   std::ofstream foutmtrth("output/mass/theta_st1_ref1_2step_ssdpla.dat");
 if (foutmtrth.fail()){
...
//      h_47V_org->Fill(aq_tmpt);
   ...
   TFile *ofile = new TFile("output/mass/mass_calib_svd_3rd_eachstrip_st1_ref1_2step_BLD_ref4.hist.root","recreate");
//   TFile *ofile = new TFile("output/mass/mass_calib_svd_3rd_eachstrip_st1_ref1_2step_ssdpla.hist.root","recreate");
