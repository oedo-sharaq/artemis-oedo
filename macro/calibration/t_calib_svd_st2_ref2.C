...
for(int ic = 0; ic < Nevt; ic++ ){
 ...
 TH1D *h_38Ca_sol = new TH1D("h38Ca_sol", "h38Ca_sol",500,1.87,1.91);
 ...
 TH1D *h_48Mn_sol = new TH1D("h48Mn_sol", "h48n_sol",500,1.90,1.940);
...
// Output
 ...
 TH1D *h_38Ca = new TH1D("h38Ca", "h38Ca",500,1.870,1.910);
 ...
 TH1D *h_48Mn = new TH1D("h498n", "h48Mn",500,1.90,1.940);
...
//// Draw original histogram
 ...
 TH1D *h_38Ca_org = new TH1D("h38Ca_org", "h38Ca_org",500,1.870,1.910);
 ...
 TH1D *h_48Mn_org = new TH1D("h48Mn_org", "h48Mn_org",500,1.90,1.940);
