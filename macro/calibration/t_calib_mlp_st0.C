...
// unit orientation
 ...
 ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_mlp_eachstripst0.dat");
 if (foutselect.fail()){
...
//// Draw original histogram
 ...
 TFile *ofile = new TFile("output/mass/mass_calib_mlp_eachstrip_st0.hist.root","recreate");
