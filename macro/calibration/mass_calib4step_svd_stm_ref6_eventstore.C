...
void mass_calib4step_svd_stm_ref6_eventstore(){
 ...
 tree->AddFriend("tree1 = tree","sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_3step_ref4.eventstore.170272.all.root"); // Add file. Basically mass calibration file.
 ...
 tree->SetBranchAddress("mass_corstm_BLD_3rd",&array_mass_corstm);
 ...
 ifstream fin("/home/sh13/art_analysis/user/hanai/prm/mass/input_4step_stm_ref6.dat");
 if (fin.fail()){
...
// ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd4th_stm2_ref6_4step_unit2_SSR.dat");
 ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd4th_stm2_ref6_4step_unit2.5_SSR.dat");
 if (fout.fail()){
...
// ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd4th_stm2_ref6_4step_unit2_SSR.dat");
 ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd4th_stm2_ref6_4step_unit2.5_SSR.dat");
 if (foutselect.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 return;
  }
...
//   TFile *ofv = new TFile("output/mass/mass_calib_svd_4th_stm2_ref6_4step.hist_selected_unit2_SSR.root","recreate");
   TFile *ofv = new TFile("output/mass/mass_calib_svd_4th_stm2_ref6_4step.hist_selected_unit2.5_SSR.root","recreate");
...
//// Save the results of SVD
  ...
  Theta.Print();
   ...
   char foutname[50];
//   std::ofstream foutmtr("output/mass/svd4th_out_stm2_ref6_4step_unit2_SSR.dat");
   std::ofstream foutmtr("output/mass/svd4th_out_stm2_ref6_4step_unit2.5_SSR.dat");
...
//   std::ofstream foutmtrth("output/mass/theta_stm2_ref6_4step_unit2_SSR.dat");
   std::ofstream foutmtrth("output/mass/theta_stm2_ref6_4step_unit2.5_SSR.dat");
 if (foutmtrth.fail()){
...
//// Draw original histogram
 ...
 //  TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_stm2_ref6_4step_unit2_SSR.hist.root","recreate");
   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_stm2_ref6_4step_unit2.5_SSR.hist.root","recreate");
