...
void mass_calib7step_svd_stm_ref7_eventstore_maxz(){
...
// ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd4th_stm2_ref7_7step_maxz.dat");
 ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd4th_stm2_ref7_7step_maxz_unit.dat");
 if (fout.fail()){
...
// ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd4th_stm2_ref7_7step_maxz.dat");
 ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd4th_stm2_ref7_7step_maxz_unit.dat");
 if (foutselect.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 return;
  }
...
//  TFile *ofv = new TFile("output/mass/mass_calib_svd_4th_stm2_ref7_7step.hist_selected_maxz.root","recreate");
  TFile *ofv = new TFile("output/mass/mass_calib_svd_4th_stm2_ref7_7step.hist_selected_maxz_unit.root","recreate");
...
//// Save the results of SVD
  ...
  Theta.Print();
   ...
   char foutname[50];
//   std::ofstream foutmtr("output/mass/svd4th_out_stm2_ref7_7step_maxz.dat");
   std::ofstream foutmtr("output/mass/svd4th_out_stm2_ref7_7step_maxz_unit.dat");
...
//   std::ofstream foutmtrth("output/mass/theta_stm2_ref7_7step_maxz.dat");
   std::ofstream foutmtrth("output/mass/theta_stm2_ref7_7step_maxz_unit.dat");
 if (foutmtrth.fail()){
...
//// AoQ cor
 ...
 cout <<  "Set mass after calib" << endl;
  ...
  for (Int_t iData = 0; iData < nData; iData++){
    ...
    if( tracku_cor_ok && trackd_cor_ok && angle_ok){
...
// angle gate
//
     Double_t t_cor = (ti_cor - 2042.) * 0.03125;  
     Double_t x3_cor = x3i_cor * 0.1; 
     Double_t a3_cor = a3i_cor * 0.1 + 0.2;
     Double_t y3_cor = y3i_cor * 0.6 + 1.2;
     Double_t b3_cor = b3i_cor * 0.05 + 0.5;
     Double_t x0_cor = x0i_cor * 0.015; 
     Double_t x2_cor = x2i_cor * 0.1 + 0.3; 
     Double_t a2_cor = a2i_cor * 0.025;
     Double_t y2_cor = y2i_cor * 0.15 - 3.;
     Double_t b2_cor = b2i_cor * 0.15 - 0.6;
...
// 	   b_re_elem += A(ic,ir) * Theta(ir);
 ...
 TH1D *h_51Co_sol = new TH1D("h51Co_sol", "h51Co_sol",5000,1.88,1.90);
...
// Output
 ...
 TH1D *h_51Co = new TH1D("h51Co", "h51Co",5000,1.88,1.90);
...
//	  tree->Fill();
 ...
 }else if(Z_low[23] < z_tmpt && z_tmpt < Z_up[23]){

      h_48Fe->Fill(Aq_cor[iData]);
      h_49Fe->Fill(Aq_cor[iData]);
      h_50Fe->Fill(Aq_cor[iData]);

 }else if(Z_low[25] < z_tmpt && z_tmpt < Z_up[25]){
...
//// Draw original histogram
 ...
 TH1D *h_41Ca_org = new TH1D("h41Ca_org", "h41Ca_org",5000,2.040,2.060);
 ...
 TH1D *h_43Sc_org = new TH1D("h43Sc_org", "h43Sc_org",5000,2.04,2.060);
 ...
 TH1D *h_51Co_org = new TH1D("h51Co_org", "h51Co_org",5000,1.88,1.90);
...
//   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_stm2_ref7_7step_maxz.hist.root","recreate");
   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_stm2_ref7_7step_maxz_unit.hist.root","recreate");
