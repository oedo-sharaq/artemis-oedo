...
void mass_calib6step_svd_stm_ref6_eventstore_incnew(){
...
//   TFile *ofv = new TFile("output/mass/mass_calib_svd_4th_stm2_ref6_6step.hist_selected_unit2.5_SSR.root","recreate");
...
//  TH2D *b3aq_selected = new TH2D("b3aq_selected","b3aq_selected",100,1.8,2.15,300,-2,2);
...
//// Save the results of SVD
  ...
  Theta.Print();
   ...
   char foutname[50];
//   std::ofstream foutmtr("output/mass/svd4th_out_stm2_ref6_6step_unit2.5_SSR.dat");
//   std::ofstream foutmtr("output/mass/svd4th_out_stm2_ref6_6step_unit2.5_SSR_posmod.dat");
//   std::ofstream foutmtr("output/mass/svd4th_out_stm2_ref6_6step_nogate.dat");
//   std::ofstream foutmtr("output/mass/svd4th_out_stm2_ref6_6step_nogate_sqrt.dat");
   std::ofstream foutmtr("output/mass/svd4th_out_stm2_ref6_6step_nogate_sqrt_incnew.dat");
...
//   std::ofstream foutmtrth("output/mass/theta_stm2_ref6_6step_unit2.5_SSR.dat");
//   std::ofstream foutmtrth("output/mass/theta_stm2_ref6_6step_unit2.5_SSR_posmod.dat");
//   std::ofstream foutmtrth("output/mass/theta_stm2_ref6_6step_nogate.dat");
//   std::ofstream foutmtrth("output/mass/theta_stm2_ref6_6step_nogate_sqrt.dat");
   std::ofstream foutmtrth("output/mass/theta_stm2_ref6_6step_nogate_sqrt_incnew.dat");
 if (foutmtrth.fail()){
...
// Output
 ...
 TH2D *h_41Tix2 = new TH2D("h41Tix2", "h41Tix2",500,1.86,1.865,300,-20,20);
...
// Output new mass region
 ...
 TH1D *h_aq_cal = new TH1D("aq_cal", "aq_cal",26000,1.7,1.96);
 TH2D *h_zaq_cal = new TH2D("zaq_cal", "zaq_cal",26000,1.7,1.96,1000,19,30);

 TH1D *hnew_ti_a = new TH1D("hnwe_ti_a","hnew_ti_a",2000,1.76,1.78); //39Ti

 TH1D *hnew_cr_a = new TH1D("hnwe_cr_a","hnew_cr_a",2000,1.74,1.76); //42Cr
 TH1D *hnew_cr_b = new TH1D("hnwe_cr_b","hnew_cr_d",2000,1.78,1.80); //43Cr

 TH1D *hnew_fe_a = new TH1D("hnwe_fe_a","hnew_fe_a",2000,1.72,1.74); //45Fe
 TH1D *hnew_fe_b = new TH1D("hnwe_fe_b","hnew_fe_d",2000,1.76,1.78); //46Fe
 TH1D *hnew_fe_c = new TH1D("hnwe_fe_c","hnew_fe_c",2000,1.8,1.82); //47Fe

 TH1D *hnew_ni_a = new TH1D("hnwe_ni_a","hnew_ni_a",2000,1.70,1.72); //48Ni
 TH1D *hnew_ni_b = new TH1D("hnwe_ni_b","hnew_ni_d",2000,1.74,1.76); //49Ni
 TH1D *hnew_ni_c = new TH1D("hnwe_ni_c","hnew_ni_c",2000,1.775,1.795); //50Ni
 TH1D *hnew_ni_d = new TH1D("hnwe_ni_d","hnew_ni_d",2000,1.81,1.83); //50Ni
...
// if (ssrd < 0.1){
 if (tracku_tmp_ok && trackd_tmp_ok){
    ...
    for (int s = 0; s < 35; s++){
     ...
     Bool_t oekaki_ok = Z_low_draw[s] < z_tmpt && z_tmpt < Z_up_draw[s] && Aq_low_draw[s] < Aq_cor[iData] && Aq_cor[iData] <  Aq_up_draw[s];
...
//   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_stm2_ref6_6step_unit2.5_SSR.hist.root","recreate");
//   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_stm2_ref6_6step_unit2.5_SSR_posmod.hist.root","recreate");
   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_stm2_ref6_6step_nogate.hist_incnew.root","recreate");
