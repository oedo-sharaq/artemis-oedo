...
void mass_calib3step_svd_stm_maxz(){

 TFile* file = TFile::Open("sh13_analysis/hanai/phys/mass_cor_maxz/physics.chkmass_stm2_2step_ref4_maxz.eventstore.170272.all.root");
 if(!file){
...
// 4th order
 ...
 ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd4th_stm2_ref4_3step_unit2_mazx.dat");
 if (fout.fail()){
...
for(int n = 0; n < Nevt; n++){
 ...
 ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd4th_stm2_ref4_3step_unit2_maxz.dat");
 if (foutselect.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 return;
  }
...
for(int n = 0; n < Nevt; n++){
   ...
   TFile *ofv = new TFile("output/mass/mass_calib_svd_4th_stm2_ref4_3step_hist_selected_unit2_maxz.root","recreate");
...
//// Save the results of SVD
  ...
  Theta.Print();
   ...
   char foutname[50];
   std::ofstream foutmtr("output/mass/svd4th_out_stm2_ref4_3step_unit2_maxz.dat");
   ...
   std::ofstream foutmtrth("output/mass/theta_stm2_ref4_3step_unit2_maxz.dat");
 if (foutmtrth.fail()){
...
//      h_47V_org->Fill(aq_tmpt);
   ...
   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_stm2_ref4_3step_unit2_maxz.hist.root","recreate");
