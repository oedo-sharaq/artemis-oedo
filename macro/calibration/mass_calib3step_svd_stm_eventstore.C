...
void mass_calib3step_svd_stm_eventstore(){
...
for (int iref = 0; iref < Nref; iref++){
  ...
  for(int i = 0; i < nData; i++){
    ...
    if(Z_low[iref] < z_tmp && z_tmp < Z_up[iref] 
    	 && Aq_low[iref] < aq_tmp && aq_tmp < Aq_up[iref] && tracku_ok && trackd_ok && ssrd < 0.1 && var3d < 0.002 && 15 < y2_tmp && y2_tmp < 24 )
    {
      irandm.push_back(i);
      n_tmp++;
     }else {
...
// ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd4th_stm2_ref4_3step_unit2_SSR.dat");
...
// ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd4th_stm2_ref4_3step_unit2_SSR.dat");
...
//   TFile *ofv = new TFile("output/mass/mass_calib_svd_4th_stm2_ref4_3step.hist_selected_unit2_SSR.root","recreate");
//   TFile *ofv = new TFile("output/mass/mass_calib_svd_4th_stm2_ref4_3step.hist_selected_unit2_SSRBVar.root","recreate");
  ...
  TH1D *b2aq_selected = new TH1D("b2aq_selected","b2aq_selected",1000,1.8,2.2,300,-5,5);
...
//// Save the results of SVD
  ...
  Theta.Print();
   ...
   char foutname[50];
//   std::ofstream foutmtr("output/mass/svd4th_out_stm2_ref4_3step_unit2_SSR.dat");
...
//   std::ofstream foutmtrth("output/mass/theta_stm2_ref4_3step_unit2_SSR.dat");
...
//   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_stm2_ref4_3step_unit2_SSR.hist.root","recreate");
