...
void mass_calib3step_svd_st1_eventstore(){
...
// tree->AddFriend("tree1 = tree","sh13_analysis/hanai/phys/mass_calib/physics.chkmass_st1_2step_ref3.eventstore.170272.all.root"); // Add file. Basically mass calibration file.
 tree->AddFriend("tree1 = tree","sh13_analysis/hanai/phys/mass_calib/physics.chkmass_st1_3step_unit2_ref3.eventstore.170272.all.root"); // Add file. Basically mass calibration file.
...
// tree->SetBranchAddress("mass_corst1_BLD_2nd",&array_mass_corst1);
...
// ifstream fin("/home/sh13/art_analysis/user/hanai/prm/mass/input_2step_st1.dat");
 ifstream fin("/home/sh13/art_analysis/user/hanai/prm/mass/input_3step_st1_ref3.dat");
 if (fin.fail()){
...
// ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd4th_eachstripst1_ref1_3step.dat");
// ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd4th_eachstripst1_ref1_3step_unit2.dat");
// ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd4th_eachstripst1_ref3_3step_unit2.dat");
 ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd4th_eachstripst1_ref3_3step_unit2_SSR.dat");
 if (fout.fail()){
...
// ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd4th_eachstripst1_ref1_3step.dat");
// ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd4th_eachstripst1_ref1_3step_unit2.dat");
// ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd4th_eachstripst1_ref3_3step_unit2.dat");
 ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd4th_eachstripst1_ref3_3step_unit2_SSR.dat");
 if (foutselect.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 return;
  }
...
//   TFile *ofv = new TFile("output/mass/mass_calib_svd_4th_eachstrip_st1_ref1_3step.hist_selected.root","recreate");
//   TFile *ofv = new TFile("output/mass/mass_calib_svd_4th_eachstrip_st1_ref1_3step.hist_selected_unit2.root","recreate");
//   TFile *ofv = new TFile("output/mass/mass_calib_svd_4th_eachstrip_st1_ref3_3step.hist_selected_unit2.root","recreate");
   TFile *ofv = new TFile("output/mass/mass_calib_svd_4th_eachstrip_st1_ref3_3step.hist_selected_unit2_SSR.root","recreate");
...
//// Save the results of SVD
  ...
  Theta.Print();
   ...
   char foutname[50];
//   std::ofstream foutmtr("output/mass/svd4th_out_st1_ref1_3step.dat");
//   std::ofstream foutmtr("output/mass/svd4th_out_st1_ref1_3step_unit2.dat");
//   std::ofstream foutmtr("output/mass/svd4th_out_st1_ref3_3step_unit2.dat");
   std::ofstream foutmtr("output/mass/svd4th_out_st1_ref3_3step_unit2_SSR.dat");
...
//   std::ofstream foutmtrth("output/mass/theta_st1_ref1_3step.dat");
//   std::ofstream foutmtrth("output/mass/theta_st1_ref1_3step_unit2.dat");
//   std::ofstream foutmtrth("output/mass/theta_st1_ref3_3step_unit2.dat");
   std::ofstream foutmtrth("output/mass/theta_st1_ref3_3step_unit2_SSR.dat");
 if (foutmtrth.fail()){
...
//// AoQ cor
  ...
  for (Int_t iData = 0; iData < nData; iData++){
    ...
    Int_t hit_s0_cor = array_s0->GetEntriesFast();
     ...
     if ( hit_dia_tof32st1cor > 0 && hit_tracku_cor > 0 && hit_trackd_cor > 0 && hit_s0_cor >0){
...
//   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_st1_ref1_3step.hist.root","recreate");
//   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_st1_ref1_3step_unit2.hist.root","recreate");
//   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_st1_ref3_3step_unit2.hist.root","recreate");
   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_st1_ref3_3step_unit2_SSR.hist.root","recreate");
