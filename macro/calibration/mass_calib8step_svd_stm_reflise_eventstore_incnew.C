...
void mass_calib8step_svd_stm_reflise_eventstore_incnew(){
...
//// Save the results of SVD
  ...
  Theta.Print();
   ...
   char foutname[50];
   std::ofstream foutmtr("output/mass/svd4th_out_stm2_reflise_8step_unitlise_SSR_mahala_incnew.dat");
   ...
   std::ofstream foutmtrth("output/mass/theta_stm2_reflise_8step_unitlise_SSR_mahala_incnew.dat");
 if (foutmtrth.fail()){
...
// if (ssrd < 0.1){
 if (tracku_tmp_ok && trackd_tmp_ok){
	 ...
	 if(19.5 < z_tmpt && z_tmpt < 20.5){ 
     
      h_zaq_cal->Fill(Aq_cor[iData],z_tmpt);
      h_aq_cal->Fill(Aq_cor[iData]);

 }else if(20.5 < z_tmpt && z_tmpt < 21.5){

      h_zaq_cal->Fill(Aq_cor[iData],z_tmpt);
      h_aq_cal->Fill(Aq_cor[iData]);
 
 }else if(21.5 < z_tmpt && z_tmpt < 22.5){
 ...
 }else if(22.5 < z_tmpt && z_tmpt < 23.5){
 ...
 }else if(24.5 < z_tmpt && z_tmpt < 25.5){
 ...
 }else if(26.5 < z_tmpt && z_tmpt < 27.5){
   ...
   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_stm2_reflise_8step_unitlise_SSR_mahala_incnew.hist.root","recreate");
