...
void sampling_mass_calib6step_svd_stm_ref6_eventstore(){
...
// 4th order
 ...
 if(!HasEvents){
   ...
   char* foutAB;
   foutAB = new char[32];
   sprintf(foutAB,"/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd4th_stm2_ref6_6step_unit2_SSR_Step%d.dat",step);
   std::ofstream fout;
...
for(int n = 0; n < Nevt; n++){
   ...
   sprintf(foutselectname,"/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd4th_stm2_ref6_6step_unit2_SSR_Step%d.dat",step);
...
for(int n = 0; n < Nevt; n++){
   ...
   TFile *ofv = new TFile(Form("\"output/mass/mass_calib_svd_4th_stm2_ref6_6step.hist_selected_unit2_SSR_Step%d.root\"",step),"recreate");
...
//// Save the results of SVD
  ...
  Theta.Print();
   ...
   sprintf(foutname,"output/mass/svd4th_out_stm2_ref6_6step_unit2_SSR_Step%d.dat",step);
   ...
   sprintf(fthetaname,"output/mass/theta_stm2_ref6_6step_unit2_SSR_Step%d.dat",step);
