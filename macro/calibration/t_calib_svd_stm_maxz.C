...
void t_calib_svd_stm_maxz(){

 TFile* file = TFile::Open("sh13_analysis/hanai/phys/bld_file/BLD_maxz_stm/BLD_maxz_stm.170272.all.root");
 if(!file){
...
// unit orientation
 ...
 ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd3rd_stm2_BLD_maxz_ref4.dat");
 if (fout.fail()){
...
for(int n = 0; n < Nevt; n++){
 ...
 ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd3rd_stm2_BLD_maxz_ref4.dat");
 if (foutselect.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 return;
  }
...
//// Save the results of SVD
  ...
  Theta.Print();
   ...
   char foutname[50];
   std::ofstream foutmtr("output/mass/svd3rd_out_stm2_BLD_maxz_ref4.dat");
   ...
   std::ofstream foutmtrth("output/mass/theta_stm2_BLD_maxz_ref4.dat");
 if (foutmtrth.fail()){
...
//      h_47V_org->Fill(aq_tmpt);
   ...
   TFile *ofile = new TFile("output/mass/mass_calib_svd_3rd_eachtrip_stm2_BLD_maxz.hist_ref4.root","recreate");
