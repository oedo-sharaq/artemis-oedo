...
void mass_calib2step_svd_st2_eventstore(){
 ...
 tree->AddFriend("tree1 = tree","sh13_analysis/hanai/phys/merge/physics.chkmass_st2_1step.eventstore.170272.all.root"); // Add file. Basically mass calibration file.
...
// tree->SetBranchAddress("mass_corst2",&array_mass_corst2);
 tree->SetBranchAddress("mass_corst2_BLD",&array_mass_corst2);
...
// tree->SetBranchStatus("mass_corst2",1);
 tree->SetBranchStatus("mass_corst2_BLD",1);
...
// ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd3rd_eachstripst2_ref1_2step.dat");
 ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd3rd_eachstripst2_ref1_2step_BLD.dat");
 if (fout.fail()){
...
// ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd3rd_eachstripst2_ref1_2step.dat");
 ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd3rd_eachstripst2_ref1_2step_BLD.dat");
 if (foutselect.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 return;
  }
...
//// Save the results of SVD
  ...
  Theta.Print();
   ...
   char foutname[50];
//  std::ofstream foutmtr("output/mass/svd3rd_out_st2_ref1_2step.dat");
   std::ofstream foutmtr("output/mass/svd3rd_out_st2_ref1_2step_BLD.dat");
 ...
 //  std::ofstream foutmtrth("output/mass/theta_st2_ref1_2step.dat");
   std::ofstream foutmtrth("output/mass/theta_st2_ref1_2step_BLD.dat");
 if (foutmtrth.fail()){
...
//// AoQ cor
  ...
  for (Int_t iData = 0; iData < nData; iData++){
    ...
    Int_t hit_s0_cor = array_s0->GetEntriesFast();
     ...
     if ( hit_dia_tof32st2cor > 0 && hit_tracku_cor > 0 && hit_s0_cor >0){
...
//   TFile *ofile = new TFile("output/mass/mass_calib_svd_3rd_eachstrip_st2_ref1_2step.hist.root","recreate");
   TFile *ofile = new TFile("output/mass/mass_calib_svd_3rd_eachstrip_st2_ref1_2step_BLD.hist.root","recreate");
