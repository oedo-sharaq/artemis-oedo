...
//// Load a input file
 ...
 TFile* fbuff = new TFile("output/mass/mass_calib_mlp_anntree.root","recreate");

// TFile* ofile = new TFile("sh13_analysis/hanai/phys/mass_calib/mass_calib_ref_half.mlp.root","RECREATE");
  TNtuple* anntree = new TNtuple("anntree","anntree","c0:c1:c2:c3:c4:c5:f");
//  TTree *anntree = new TTree("anntree","anntree");
//  Double_t c0, c1, c2, c3, c4, c5, f;
//  anntree->Branch("c0",&c0,"c0/D");
//  anntree->Branch("c1",&c0,"c1/D");
//  anntree->Branch("c2",&c0,"c2/D");
//  anntree->Branch("c3",&c0,"c3/D");
//  anntree->Branch("c4",&c0,"c4/D");
//  anntree->Branch("c5",&c0,"c5/D");
//  anntree->Branch("f",&f,"f/D");
...
// unit orientation
 ...
 ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_mlp.dat");
 if (foutselect.fail()){
...
//// Check results for selected events
 ...
 ofstream fouteval("/home/sh13/art_analysis/user/hanai/prm/mass/evaluate_mlp.dat");
 if (fouteval.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 return;
  }
...
//// Draw original histogram
 ...
 TFile *ofile = new TFile("output/mass/mass_calib_mlp.hist.root","recreate");
