...
void mass_calib6step_svd_stm_ref6in_eventstore(){
 ...
 ifstream fin("/home/sh13/art_analysis/user/hanai/prm/mass/input_6step_stm_ref6in.dat");
 if (fin.fail()){
...
//	foutselect.close();
   ...
   TFile *ofv = new TFile("output/mass/mass_calib_svd_4th_stm2_ref6in_6step.hist_selected_ngate_sqrt.root","recreate");
...
//// Save the results of SVD
  ...
  Theta.Print();
   ...
   char foutname[50];
   std::ofstream foutmtr("output/mass/svd4th_out_stm2_ref6in_6step_nogate_sqrt.dat");
   ...
   std::ofstream foutmtrth("output/mass/theta_stm2_ref6in_6step_nogate_sqrt.dat");
 if (foutmtrth.fail()){
...
//// Draw original histogram
 ...
 TH2D *h_zaq_org = new TH2D("zaq_org", "zaq_org",500,1.7,2.3,500,18,30);
  ...
  for (Int_t iData = 0; iData < nData; iData++){
   ...
   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_stm2_ref6in_6step_nogate.hist.root","recreate");
