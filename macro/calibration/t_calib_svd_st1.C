...
// ifstream fin("/home/sh13/art_analysis/user/hanai/prm/mass/input_try_ref3.dat");
 ifstream fin("/home/sh13/art_analysis/user/hanai/prm/mass/input_try_ref4.dat");
...
for (int iref = 0; iref < Nref; iref++){
  ...
  for(int i = 0; i < nData; i++){
	 ...
	 art::TMassData *mass_st1_tmp = (art::TMassData*) array_mass_st1->UncheckedAt(0);
     Double_t z_tmp = mass_tmp->GetZ();
     Double_t aq_tmp = mass_st1_tmp->GetAq();
...
// ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd3rd_eachstripst1.dat");
 ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd3rd_eachstripst1_BLD_ref4.dat");
// ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd3rd_eachstripst1_ssdpla_.dat");
 if (fout.fail()){
...
// ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd3rd_eachstripst1.dat");
 ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd3rd_eachstripst1_BLD_ref3.dat");
// ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd3rd_eachstripst1_ssdpla.dat");
 if (foutselect.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 return;
  }
...
//// Save the results of SVD
  ...
  Theta.Print();
   ...
   char foutname[50];
//   std::ofstream foutmtr("output/mass/svd3rd_out_st1.dat");
   std::ofstream foutmtr("output/mass/svd3rd_out_st1_BLD_ref4.dat");
//   std::ofstream foutmtr("output/mass/svd3rd_out_st1_ssdpla.dat");
...
//   std::ofstream foutmtrth("output/mass/theta_st1.dat");
   std::ofstream foutmtrth("output/mass/theta_st1_BLD_ref4.dat");
//   std::ofstream foutmtrth("output/mass/theta_st1_ssdpla.dat");
 if (foutmtrth.fail()){
...
//// AoQ cor
  ...
  for (Int_t iData = 0; iData < nData; iData++){
    double sum = 0.;
     ...
     tree->GetEntry(iData);
	 art::TMassData *mass_cor = (art::TMassData*) array_mass_st1->UncheckedAt(0);
    ...
    Int_t hit_mass_cor = array_mass_st1->GetEntriesFast();
...
// TH1D *h_47V_org = new TH1D("h47V_org", "h47V_org",51000,2.01,2.21);
 TH1D *h_46V_org = new TH1D("h46V_org", "h46V_org",51000,1.985,2.005);
 ...
 TH2D *h_zaq_org = new TH2D("zaq_org", "zaq_org",500,1.7,2.3,500,18,30);
  ...
  for (Int_t iData = 0; iData < nData; iData++){
     tree->GetEntry(iData);
     art::TMassData *mass_tmpt = (art::TMassData*) array_mass->UncheckedAt(0);
     art::TMassData *mass_corst1_tmpt = (art::TMassData*) array_mass_st1->UncheckedAt(0);
     Double_t z_tmpt = mass_tmpt->GetZ();
...
//   TFile *ofile = new TFile("output/mass/mass_calib_svd_3rd_eachtrip_st1.hist.root","recreate");
   TFile *ofile = new TFile("output/mass/mass_calib_svd_3rd_eachtrip_st1_BLD.hist_ref4.root","recreate");
//   TFile *ofile = new TFile("output/mass/mass_calib_svd_3rd_eachtrip_st1_ssdpla.hist.root","recreate");
