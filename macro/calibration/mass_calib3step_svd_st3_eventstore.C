...
void mass_calib3step_svd_st3_eventstore(){
...
// ifstream fin("/home/sh13/art_analysis/user/hanai/prm/mass/input_2step_st1.dat");
 ifstream fin("/home/sh13/art_analysis/user/hanai/prm/mass/input_3step_st3.dat");
 if (fin.fail()){
...
// 4th order
 ...
 ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd4th_eachstripst3_ref1_3step.dat");
 if (fout.fail()){
...
for(int n = 0; n < Nevt; n++){
 ...
 ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd4th_eachstripst3_ref1_3step.dat");
 if (foutselect.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 return;
  }
...
//// Save the results of SVD
  ...
  Theta.Print();
   ...
   char foutname[50];
   std::ofstream foutmtr("output/mass/svd4th_out_st3_ref1_3step.dat");
   ...
   std::ofstream foutmtrth("output/mass/theta_st3_ref1_3step.dat");
 if (foutmtrth.fail()){
