...
void mass_calib3step_svd_st2_eventstore(){
 ...
 tree->AddFriend("tree1 = tree","sh13_analysis/hanai/phys/mass_calib/physics.chkmass_st2_2step.eventstore.170272.all.root"); // Add file. Basically mass calibration file.
...
//  const Int_t Nrun = 2000;  //the number of runs
 ...
 tree->SetBranchAddress("mass_corst2_BLD_2nd",&array_mass_corst2);
 ...
 tree->SetBranchStatus("mass_corst2_BLD_2nd",1);
...
// ifstream fin("/home/sh13/art_analysis/user/hanai/prm/mass/input_2step_st2.dat");
// ifstream fin("/home/sh13/art_analysis/user/hanai/prm/mass/input_2step_st1.dat");
// ifstream fin("/home/sh13/art_analysis/user/hanai/prm/mass/input_3step_st2_ref3.dat");
 ...
 TMatrixD b(Nevt,1);
 TMatrixD value(Nevt,12); // output the fitting value 
...
for (int iref = 0; iref < Nref; iref++){
  ...
  for(int i = 0; i < nData; i++){
     ...
     if ( hit_mass > 0 && hit_mass_corst2 > 0 && hit_tracku > 0 && hit_trackd > 0 && hit_s0 > 0){
...
// ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd4th_eachstripst2_ref1_3step.dat");
// ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd4th_eachstripst2_ref3_3step_unit2.dat");
 ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/set_matrix_svd4th_eachstripst2_ref4_3step_unit2.dat");
 if (fout.fail()){
...
// ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd4th_eachstripst2_ref1_3step.dat");
// ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd4th_eachstripst2_ref3_3step_unit2.dat");
 ofstream foutselect("/home/sh13/art_analysis/user/hanai/prm/mass/value_selected_svd4th_eachstripst2_ref4_3step_unit2.dat");
 if (foutselect.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 return;
  }
...
for(int n = 0; n < Nevt; n++){
   ...
   TFile *ofv = new TFile("output/mass/mass_calib_svd_4th_eachstrip_st2_ref4_3step.hist_selected_unit2_SSR.root","recreate");
...
//// Save the results of SVD
  ...
  Theta.Print();
   ...
   char foutname[50];
 //  std::ofstream foutmtr("output/mass/svd4th_out_st2_ref1_3step.dat");
 //  std::ofstream foutmtr("output/mass/svd4th_out_st2_ref3_3step_unit2.dat");
   std::ofstream foutmtr("output/mass/svd4th_out_st2_ref4_3step_unit2.dat");
...
//   std::ofstream foutmtrth("output/mass/theta_st2_ref1_3step.dat");
//   std::ofstream foutmtrth("output/mass/theta_st2_ref3_3step_unit2.dat");
   std::ofstream foutmtrth("output/mass/theta_st2_ref4_3step_unit2.dat");
 if (foutmtrth.fail()){
...
//// AoQ cor
  ...
  for (Int_t iData = 0; iData < nData; iData++){
    double sum = 0.;
     ...
     tree->GetEntry(iData);
	 art::TDiaTimingData *dia_tof32st2cor = (art::TDiaTimingData*) array_dia_tof32st2->UncheckedAt(0);
    ...
    Int_t hit_dia_tof32st2cor = array_dia_tof32st2->GetEntriesFast();
    ...
    Int_t hit_s0_cor = array_s0->GetEntriesFast();
     ...
     if ( hit_dia_tof32st2cor > 0 && hit_tracku_cor > 0 && hit_trackd_cor > 0 && hit_s0_cor >0){
 
     Double_t ti_cor = dia_tof32st2cor->GetTiming();
...
//      h_47V_org->Fill(aq_tmpt);
   ...
   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_st2_ref4_3step_unit2.hist.root","recreate");
 //  TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_st2_ref1_3step.hist.root","recreate");
