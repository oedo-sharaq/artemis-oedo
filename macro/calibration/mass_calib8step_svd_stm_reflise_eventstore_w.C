...
void mass_calib8step_svd_stm_reflise_eventstore_w(){
...
//   std::ofstream foutmtr("output/mass/svd4th_out_stm2_reflise_8step_unitlise_SSR_mahala_w.dat");
   std::ofstream foutmtr("output/mass/svd4th_out_stm2_reflise_8step_unitlise_SSR_mahala_w2.dat");
...
//   std::ofstream foutmtrth("output/mass/theta_stm2_reflise_8step_unitlise_SSR_mahala_w.dat");
   std::ofstream foutmtrth("output/mass/theta_stm2_reflise_8step_unitlise_SSR_mahala_w2.dat");
 if (foutmtrth.fail()){
...
//   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_stm2_reflise_8step_unitlise_SSR_mahala_w.hist.root","recreate");
   TFile *ofile = new TFile("output/mass/mass_calib_svd_4th_eachstrip_stm2_reflise_8step_unitlise_SSR_mahala_w2.hist.root","recreate");
