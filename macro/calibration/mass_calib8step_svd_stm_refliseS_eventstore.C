...
void mass_calib8step_svd_stm_refliseS_eventstore(){
...
//  const Int_t Nrun = 1000;  //the number of runs
  ...
  const Int_t Nref =  20;  // the number of species for reference
...
// ifstream fin("/home/sh13/art_analysis/user/hanai/prm/mass/input_8step_stm_reflise.dat");
 ifstream fin("/home/sh13/art_analysis/user/hanai/prm/mass/input_8step_stm_refliseS.dat");
 if (fin.fail()){
