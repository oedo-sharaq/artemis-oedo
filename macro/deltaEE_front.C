{
  for (int i = 1; i<=16; i++){
    ...
    tree->Draw(Form("ttt_front_hit[0].fCharge:csiS%d.fCharge>>front_h%d(150,0,30,150,0,20)",i,i),"","colz");
    //tree->Draw(Form("tina3.fEcsi:csirawS%d.fCharge>>front_h%d(50,0,4000,50,0,20)",i,i),"tgate","colz");
  }
