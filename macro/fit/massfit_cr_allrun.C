...
void massfit_cr_allrun(){
 ...
 TFile* file = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st2_2step.170272.cr.hist.root");
 if(!file){
...
TH1F *h44cr = (TH1F*)gDirectory->Get(Form("mass_st2_44cr_2nd_%d",i));
...
TH1F *h45cr = (TH1F*)gDirectory->Get(Form("mass_st2_45cr_2nd_%d",i));
...
TH1F *h46cr = (TH1F*)gDirectory->Get(Form("mass_st2_46cr_2nd_%d",i));
