...
void massfit_all_refliseT_epsilon(){

 ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/stm/fit.refliseT_8step_unitlise_SSSR_mahala.dat");
 if(fout.fail()){
 ...
 TFile* file = TFile::Open("output/mass/mass_calib_svd_4th_eachstrip_stm2_refliseT_8step_unitlise_SSR_mahala.hist.root");
 if(!file){
