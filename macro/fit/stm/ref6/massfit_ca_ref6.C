...
// ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_3step.eventstore.38ca.dat");
// ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_5step.eventstore.38ca.dat");
// ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_6step.eventstore.38ca.dat");
// ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_6step_posmod.eventstore.38ca.dat");
// ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_7step_posmod.eventstore.38ca.dat");
 ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_8step_posmod.eventstore.38ca.dat");
 if(fout1.fail()){
...
// ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_4step.eventstore.39ca.dat");
// ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_5step.eventstore.39ca.dat");
// ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_6step.eventstore.39ca.dat");
// ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_6step_posmod.eventstore.39ca.dat");
// ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_7step_posmod.eventstore.39ca.dat");
 ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_8step_posmod.eventstore.39ca.dat");
 if(fout2.fail()){
	 cout << "Error; Could not open output file2.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
  }

// ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_4step.eventstore.41ca.dat");
// ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_5step.eventstore.41ca.dat");
// ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_6step.eventstore.41ca.dat");
// ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_6step_posmod.eventstore.41ca.dat");
// ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_7step_posmod.eventstore.41ca.dat");
 ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_8step_posmod.eventstore.41ca.dat");
 if(fout3.fail()){
	 cout << "Error; Could not open output file3.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
  }
...
// ofstream foutall("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_7step_posmod.eventstore.all.dat",ios::app);
 ...
 if(foutall.fail()){
	 cout << "Error; Could not open output file all.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
  }
...
// }else{
 h38ca->Fit("gaus","L","",1.89766,1.89889);
 ...
 Double_t tdiff1 = t_38ca - t_ref_38ca;
  ...
  fout1 << "  " << prm1[0] << "  " << prm1[1] << "  " << prm1[2] << "  " << nh38ca << "  " << mean1 << " " << mass1_keV << "  " << mass1_keV_error << "  " << reso1 << "  " << aq_diff1 << "  " << massdiff1 << "  " << massdiff1oq << "  " << tdiff1 << "  " << t_38ca_error << endl;
...
TH1D *h39ca = (TH1D*)gDirectory->Get("h39ca_aq");
 ...
 h39ca->Fit("gaus","L","",1.94738,1.94859);
// if( nh40ca < 200 ){
...
//}else{
 ...
 Double_t tdiff2 = t_39ca - t_ref_39ca;
  ...
  fout2  << "  " << prm2[0] << "  " << prm2[1] << "  " << prm2[2] << "  " << nh39ca  << "  " << mean2  << "  " << mass2_keV << " " << "  " << mass2_keV_error << "  " << reso2 << "  " << aq_diff2 << "  " << massdiff2 << "  " << massdiff2oq << "  " << tdiff2 << "  " << t_39ca_error << endl;
...
TH1D *h41ca = (TH1D*)gDirectory->Get("h41ca_aq");
 ...
 h41ca->Fit("gaus","L","",2.04696,2.04815);
// if( nh41ca < 200 ){
...
//}else{
 ...
 Double_t tdiff3 = t_41ca - t_ref_41ca;
  ...
  fout3  << "  " << prm3[0] << "  " << prm3[1] << "  " << prm3[2] << "  " << nh41ca << "  " << mean3 << "  " << mass3_keV << "  " << "  " << mass3_keV_error << "  " << reso3 << "  " << aq_diff3 << "  " << massdiff3 << "  " << massdiff3oq << "  " << tdiff3 << "  " << t_41ca_error << endl;
