...
void massfit_mn_ref6(){
 ...
 const Double_t ele  = 1.60218e-19;
  ...
  Double_t mref_49mn = ref_49mn * amu * z * ele * 1.e3; //mass [J]
  ...
  Double_t t_ref_49mn = tof_func(L,ele,z,Brho,c,mref_49mn); // [ps]


// ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_5step.eventstore.46mn.dat");
// ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_6step.eventstore.46mn.dat");
// ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_6step_posmod.eventstore.46mn.dat");
// ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_7step_posmod.eventstore.46mn.dat");
 ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_8step_posmod.eventstore.46mn.dat");
 if(fout1.fail()){
...
// ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_5step.eventstore.47mn.dat");
// ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_6step.eventstore.47mn.dat");
// ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_6step_posmod.eventstore.47mn.dat");
// ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_7step_posmod.eventstore.47mn.dat");
 ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_8step_posmod.eventstore.47mn.dat");
 if(fout2.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
...
// ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_5step.eventstore.48mn.dat");
// ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_6step.eventstore.48mn.dat");
// ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_6step_posmod.eventstore.48mn.dat");
// ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_7step_posmod.eventstore.48mn.dat");
 ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_8step_posmod.eventstore.48mn.dat");
 if(fout3.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
...
// ofstream fout4("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_5step.eventstore.49mn.dat");
// ofstream fout4("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_6step.eventstore.49mn.dat");
// ofstream fout4("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_6step_posmod.eventstore.49mn.dat");
// ofstream fout4("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_7step_posmod.eventstore.49mn.dat");
 ofstream fout4("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_8step_posmod.eventstore.49mn.dat");
 if(fout4.fail()){
...
// }else{
 h46mn->Fit("gaus","L","",1.83824,1.83955);
 ...
 fout1 << "[fit scale]    [fit mean]    [fit sigma]   [Entry]    [A/Q mean +- 3sigma]    [Mass mean +- 3sigma (keV)] [Mass mean fit error (keV)]  [3sigma (keV)]   [aq diff]  [mass diff (keV)]  [mass diff (keV/q)]  [TOF diff (ps)] [TOF fit error (ps)]" << endl;  
  fout1 << "  " << prm1[0] << "  " << prm1[1] << "  " << prm1[2] << "  " << nh46mn << "  " << mean1 << " " << mass1_keV << "  " << mass1_keV_error << "  " << reso1 << "  " << aq_diff1 << "  " << massdiff1 << "  " << massdiff1oq << "  " << tdiff1 << "  " << t_46mn_error << endl;
...
TH1D *h47mn = (TH1D*)gDirectory->Get("h47mn_aq");
 ...
 h47mn->Fit("gaus","L","",1.87789,1.87906);
// if( nh47mn < 200 ){
...
// }else{
 ...
 Double_t tdiff2 = t_47mn - t_ref_47mn;
  ...
  fout2  << "  " << prm2[0] << "  " << prm2[1] << "  " << prm2[2] << "  " << nh47mn  << "  " << mean2  << "  " << mass2_keV << " " << "  " << mass2_keV_error << "  " << reso2 << "  " << aq_diff2 << "  " << massdiff2 << "  " << massdiff2oq << "  " << tdiff2 << "  " << t_47mn_error << endl;
...
TH1D *h48mn = (TH1D*)gDirectory->Get("h48mn_aq");
 ...
 h48mn->Fit("gaus","L","",1.91757,1.91872);
// if( nh48mn < 200 ){
...
//}else{
 ...
 fout3 << "[fit scale]    [fit mean]    [fit sigma]   [Entry]    [A/Q mean +- 3sigma]    [Mass mean +- 3sigma (keV)] [Mass mean fit error (keV)]  [3sigma (keV)]   [aq diff]  [mass diff (keV)]  [mass diff (keV/q)]  [TOF diff (ps)] [TOF fit error (ps)]" << endl;  
  fout3  << "  " << prm3[0] << "  " << prm3[1] << "  " << prm3[2] << "  " << nh48mn << "  " << mean3 << "  " << mass3_keV << "  " << "  " << mass3_keV_error << "  " << reso3 << "  " << aq_diff3 << "  " << massdiff3 << "  " << massdiff3oq << "  " << tdiff3 << "  " << t_48mn_error << endl;
...
TH1D *h49mn = (TH1D*)gDirectory->Get("h49mn_aq");
 Int_t nh49mn = h49mn->GetEntries();
 h49mn->Fit("gaus","L","",1.95732,1.95822);
// if( nh49mn < 200 ){
//  fout3 << i << " " << 0 << " " << 0 << " " << 0 << " " << nh49mn <<  endl;
// delete gROOT->Get("h49mn");
//}else{
 TF1 *f4 = h49mn->GetFunction("gaus");
 ...
 h49mn->GetXaxis()->SetRangeUser(xmin4,xmax4);
 Double_t mean4 = h49mn->GetMean();
 ...
 Double_t aq_diff4 = mean4 - ref_49mn;
 Double_t massdiff4 = aq_diff4 * amu * z;
 Double_t massdiff4oq = aq_diff4 * amu;
 Double_t t_49mn = tof_func(L,ele,z,Brho,c,mass4); // [ps]
 Double_t t_49mn_error = tof_func(L,ele,z,Brho,c,mass4) * mass4_error ; // [ps]
 Double_t tdiff4 = t_49mn - t_ref_49mn;
 fout4 << "[fit scale]    [fit mean]    [fit sigma]   [Entry]    [A/Q mean +- 3sigma]    [Mass mean +- 3sigma (keV)] [Mass mean fit error (keV)]  [3sigma (keV)]   [aq diff]  [mass diff (keV)]  [mass diff (keV/q)]  [TOF diff (ps)] [TOF fit error (ps)]" << endl;  
  fout4  << "  " << prm4[0] << "  " << prm4[1] << "  " << prm4[2] << "  " << nh49mn << "  " << mean4 << "  " << mass4_keV << "  " << "  " << mass4_keV_error << "  " << reso4 << "  " << aq_diff4 << "  " << massdiff4 << "  " << massdiff4oq << "  " << tdiff4 << "  " << t_49mn_error << endl;
