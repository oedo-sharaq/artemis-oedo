...
// ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_4step.eventstore.40sc.dat");
// ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_5step.eventstore.40sc.dat");
// ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_6step.eventstore.40sc.dat");
// ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_6step_posmod.eventstore.40sc.dat");
// ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_7step_posmod.eventstore.40sc.dat");
 ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_8step_posmod.eventstore.40sc.dat");
 if(fout1.fail()){
...
// ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_4step.eventstore.41sc.dat");
// ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_5step.eventstore.41sc.dat");
// ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_6step.eventstore.41sc.dat");
// ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_6step_posmod.eventstore.41sc.dat");
// ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_7step_posmod.eventstore.41sc.dat");
 ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_8step_posmod.eventstore.41sc.dat");
 if(fout2.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
...
// ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_4step.eventstore.43sc.dat");
// ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_5step.eventstore.43sc.dat");
// ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_6step.eventstore.43sc.dat");
// ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_6step_posmod.eventstore.43sc.dat");
// ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_7step_posmod.eventstore.43sc.dat");
 ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_8step_posmod.eventstore.43sc.dat");
 if(fout3.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
...
// ofstream foutall("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref6_fitting_stm2_4step.eventstore.all.dat",ios::app);
...
// ofstream foutfitgate("/home/sh13/art_analysis/user/hanai/prm/mass/stm/fitgate_ref6_stm2_4step.dat",ios::app);
...
// TFile* file = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_stm2_4step_ref6.eventstore.170272.hist.root");
...
// }else{
 h40sc->Fit("gaus","L","",1.90243,1.90384);
 ...
 fout1 << "[fit scale]    [fit mean]    [fit sigma]   [Entry]    [A/Q mean +- 3sigma]    [Mass mean +- 3sigma (keV)]  [Mass mean fit error (keV)]  [3sigma (keV)]   [aq diff]  [mass diff (keV)]  [mass diff (keV/q)]  [TOF diff (ps)]  [TOF fit error (ps)]" << endl;  
  fout1 << "  " << prm1[0] << "  " << prm1[1] << "  " << prm1[2] << "  " << nh40sc << "  " << mean1 << " " << mass1_keV << "  " << mass1_keV_error << "  " << reso1 << "  " << aq_diff1 << "  " << massdiff1 << "  " << massdiff1oq << "  " << tdiff1 << "  " << t_40sc_error << endl;
...
TH1D *h41sc = (TH1D*)gDirectory->Get("h41sc_aq");
 ...
 h41sc->Fit("gaus","L","",1.94953,1.95108);
// if( nh41sc < 200 ){
...
// }else{
 ...
 Double_t tdiff2 = t_41sc - t_ref_41sc;
  ...
  fout2  << "  " << prm2[0] << "  " << prm2[1] << "  " << prm2[2] << "  " << nh41sc  << "  " << mean2  << "  " << mass2_keV << " " << "  " << mass2_keV_error << "  " << reso2 << "  " << aq_diff2 << "  " << massdiff2 << "  " << massdiff2oq<< tdiff2 << "  " << t_41sc_error << endl;
...
TH1D *h43sc = (TH1D*)gDirectory->Get("h43sc_aq");
 ...
 h43sc->Fit("gaus","L","",2.04443,2.04590);
// if( nh43sc < 200 ){
...
//}else{
 ...
 Double_t tdiff3 = t_43sc - t_ref_43sc;
  ...
  fout3  << "  " << prm3[0] << "  " << prm3[1] << "  " << prm3[2] << "  " << nh43sc << "  " << mean3 << "  " << mass3_keV << "  " << "  " << mass3_keV_error << "  " << reso3 << "  " << aq_diff3 << "  " << massdiff3 << "  " << massdiff3oq << "  " << tdiff3 << "  " << t_43sc_error << endl;
  foutall << massdiff3oq << endl << endl;
