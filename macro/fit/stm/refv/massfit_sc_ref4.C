...
// ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref4_fitting_stm2_3step_SSRBVar.eventstore.40sc.dat");
 ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/stm/refv_fitting_stm2_3step.eventstore.40sc.dat");
 if(fout1.fail()){
...
// ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref4_fitting_stm2_3step_SSRVBar.eventstore.41sc.dat");
 ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/stm/refv_fitting_stm2_3step.eventstore.41sc.dat");
 if(fout2.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
...
// ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/stm/ref4_fitting_stm2_3step_SSRBVar.eventstore.43sc.dat");
 ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/stm/refv_fitting_stm2_3step.eventstore.43sc.dat");
 if(fout3.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
