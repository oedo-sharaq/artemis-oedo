...
void massfit_v_allrun(){
 ...
 TFile* file = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st3_2step.170272.v.hist.root");
 if(!file){
...
TH1F *h43v = (TH1F*)gDirectory->Get(Form("mass_st3_43v_2nd_%d",i));
...
TH1F *h44v = (TH1F*)gDirectory->Get(Form("mass_st3_44v_2nd_%d",i));
...
TH1F *h45v = (TH1F*)gDirectory->Get(Form("mass_st3_45v_2nd_%d",i));
