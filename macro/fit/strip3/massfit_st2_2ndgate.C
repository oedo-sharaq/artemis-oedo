...
void massfit_st2_2ndgate(int refnum){

// ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/ref_st2_fitting.dat");
// if(fout.fail()){
...
if(refnum==0){
//// Ca
 ofstream fout(Form("/home/sh13/art_analysis/user/hanai/prm/mass/ref_st2_fitting%d.dat",refnum));
 if(fout.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
