...
// ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/strip3/ref_fitting_st3_2step.48fe.dat");
 ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/strip3/ref_fitting_st3_2step_5sigma.48fe.dat");
 if(fout1.fail()){
...
// ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/strip3/ref_fitting_st3_2step.49fe.dat");
 ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/strip3/ref_fitting_st3_2step_5sigma.49fe.dat");
 if(fout2.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
...
// ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/strip3/ref_fitting_st3_2step.50fe.dat");
 ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/strip3/ref_fitting_st3_2step_5sigma.50fe.dat");
 if(fout3.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
...
// Double_t xmax1 = prm1[1] + 3 * prm1[2];
 ...
 Double_t tdiff1 = t_48fe - t_ref_48fe;
  ...
  fout1  << "  " << prm1[0] << "  " << prm1[1] << "  " << prm1[2] << "  " << nh48fe << "  " << mean1 << "  " << mass1_keV << "  " << reso1 << "  " << aq_diff1 << "  " << massdiff1 << "  " << tdiff1 << endl;
...
// Double_t xmax2 = prm2[1] + 3 * prm2[2];
 ...
 Double_t tdiff2 = t_49fe - t_ref_49fe;
  ...
  fout2  << "  " << prm2[0] << "  " << prm2[1] << "  " << prm2[2] << "  " << nh49fe  << "  " << mean2  << "  " << mass2_keV << "  " << reso2 << "  " << aq_diff2 << "  " << massdiff2 << "  " << tdiff2 << endl;
...
// Double_t xmax3 = prm3[1] + 3 * prm3[2];
 ...
 Double_t tdiff3 = t_50fe - t_ref_50fe;
  ...
  fout3  << "  " << prm3[0] << "  " << prm3[1] << "  " << prm3[2] << "  " << nh50fe << "  " << mean3 << "  " << mass3_keV << "  " << reso3 << "  " << aq_diff3 << "  " << massdiff3 << "  " << tdiff3 << endl;
