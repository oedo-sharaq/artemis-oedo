...
// TFile* file = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st0_2step.170272.ca.hist.root");
 TFile* file = TFile::Open("sh13_analysis/hanai/phys/merge/mass_corst0_2nd_all.170272.hist.root");
 if(!file){
...
TH1F *h39ca = (TH1F*)gDirectory->Get(Form("mass_st0_39ca_2step_%d",i));
...
TH1F *h40ca = (TH1F*)gDirectory->Get(Form("mass_st0_40ca_2step_%d",i));
...
TH1F *h41ca = (TH1F*)gDirectory->Get(Form("mass_st0_41ca_2step_%d",i));
