...
void massfit_ti_allrun(){
 ...
 TFile* file = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st0_2step.170272.ti.hist.root");
 if(!file){
...
TH1F *h40ti = (TH1F*)gDirectory->Get(Form("mass_st0_40ti_2nd_%d",i));
...
TH1F *h41ti = (TH1F*)gDirectory->Get(Form("mass_st0_41ti_2nd_%d",i));
...
TH1F *h43ti = (TH1F*)gDirectory->Get(Form("mass_st0_43ti_2nd_%d",i));
