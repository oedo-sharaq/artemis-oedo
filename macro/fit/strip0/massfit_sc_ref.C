...
// ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/strip0/ref_fitting_st0_2step.40sc.dat");
 ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/strip0/ref_fitting_st0_2step_5sigma.40sc.dat");
 if(fout1.fail()){
...
// ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/strip0/ref_fitting_st0_2step.41sc.dat");
 ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/strip0/ref_fitting_st0_2step_5sigma.41sc.dat");
 if(fout2.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
...
// ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/strip0/ref_fitting_st0_2step.43sc.dat");
 ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/strip0/ref_fitting_st0_2step_5sigma.43sc.dat");
 if(fout3.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
