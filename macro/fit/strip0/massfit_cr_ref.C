...
// ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/strip0/ref_fitting_st0_2step.44cr.dat");
 ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/strip0/ref_fitting_st0_2step_5sigma.44cr.dat");
 if(fout1.fail()){
...
// ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/strip0/ref_fitting_st0_2step.45cr.dat");
 ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/strip0/ref_fitting_st0_2step_5sigma.45cr.dat");
 if(fout2.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
...
// ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/strip0/ref_fitting_st0_2step.46cr.dat");
 ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/strip0/ref_fitting_st0_2step_5sigma.46cr.dat");
 if(fout3.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
...
// Double_t xmax1 = prm1[1] + 3 * prm1[2];
 ...
 Double_t tdiff1 = t_44cr - t_ref_44cr;
  ...
  fout1  << "  " << prm1[0] << "  " << prm1[1] << "  " << prm1[2] << "  " << nh44cr << "  " << mean1 << "  " << mass1_keV << "  " << reso1 << "  " << aq_diff1 << "  " << massdiff1 << "  " << tdiff1 << endl;
...
// Double_t xmax2 = prm2[1] + 3 * prm2[2];
 ...
 Double_t tdiff2 = t_45cr - t_ref_45cr;
  ...
  fout2  << "  " << prm2[0] << "  " << prm2[1] << "  " << prm2[2] << "  " << nh45cr  << "  " << mean2  << "  " << mass2_keV << "  " << reso2 << "  " << aq_diff2 << "  " << massdiff2 << "  " << tdiff2 << endl;
...
// Double_t xmax3 = prm3[1] + 3 * prm3[2];
 ...
 Double_t tdiff3 = t_46cr - t_ref_46cr;
  ...
  fout3  << "  " << prm3[0] << "  " << prm3[1] << "  " << prm3[2] << "  " << nh46cr << "  " << mean3 << "  " << mass3_keV << "  " << reso3 << "  " << aq_diff3 << "  " << massdiff3 << "  " << tdiff3 << endl;
