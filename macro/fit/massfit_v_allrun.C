...
// ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/ref_fitting_2step.43v.170272.dat");
 ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/ref_fitting_2step_5sigma.43v.170272.dat");
 if(fout1.fail()){
...
// ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/ref_fitting_2step.44v.170272.dat");
 ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/ref_fitting_2step_5sigma.44v.170272.dat");
 if(fout2.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
...
// ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/ref_fitting_2step.45v.170272.dat");
 ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/ref_fitting_2step_5sigma.45v.170272.dat");
 if(fout3.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
 ...
 TFile* file = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st2_2step.170272.v.hist.root");
 if(!file){
...
TH1F *h43v = (TH1F*)gDirectory->Get(Form("mass_st2_43v_2nd_%d",i));
...
TH1F *h44v = (TH1F*)gDirectory->Get(Form("mass_st2_44v_2nd_%d",i));
...
TH1F *h45v = (TH1F*)gDirectory->Get(Form("mass_st2_45v_2nd_%d",i));
