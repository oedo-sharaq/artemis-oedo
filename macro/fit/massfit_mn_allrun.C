...
void massfit_mn_allrun(){
 ...
 TFile* file = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st2_2step.170272.mn.hist.root");
 if(!file){
...
TH1F *h46mn = (TH1F*)gDirectory->Get(Form("mass_st2_46mn_2nd_%d",i));
...
TH1F *h47mn = (TH1F*)gDirectory->Get(Form("mass_st2_47mn_2nd_%d",i));
...
TH1F *h48mn = (TH1F*)gDirectory->Get(Form("mass_st2_48mn_2nd_%d",i));
