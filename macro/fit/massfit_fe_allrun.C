...
void massfit_fe_allrun(){
 ...
 TFile* file = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st2_2step.170272.fe.hist.root");
 if(!file){
...
TH1F *h48fe = (TH1F*)gDirectory->Get(Form("mass_st2_48fe_2nd_%d",i));
...
TH1F *h49fe = (TH1F*)gDirectory->Get(Form("mass_st2_49fe_2nd_%d",i));
...
TH1F *h50fe = (TH1F*)gDirectory->Get(Form("mass_st2_50fe_2nd_%d",i));
