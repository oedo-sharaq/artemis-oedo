...
void massfit_sc_allrun(){
 ...
 TFile* file = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st2_2step.170272.sc.hist.root");
 if(!file){
...
TH1F *h40sc = (TH1F*)gDirectory->Get(Form("mass_st2_40sc_2nd_%d",i));
...
TH1F *h41sc = (TH1F*)gDirectory->Get(Form("mass_st2_41sc_2nd_%d",i));
...
TH1F *h43sc = (TH1F*)gDirectory->Get(Form("mass_st2_43sc_2nd_%d",i));
