...
void massfit_v_ref2(){
 ...
 ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/strip2/ref3_fitting_st2_3step.eventstore.43v.dat");
 if(fout1.fail()){
 ...
 ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/strip2/ref3_fitting_st2_3step.eventstore.44v.dat");
 if(fout2.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
 ...
 ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/strip2/ref3_fitting_st2_3step.eventstore.47v.dat");
 if(fout3.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
