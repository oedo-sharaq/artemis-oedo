...
// ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/strip2/ref_fitting_st2_2step.39ca.dat");
// ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/strip2/ref_fitting_st2_2step_5sigma.39ca.dat");
// ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/strip2/ref_fitting_st2_2step_st1theta.39ca.dat");
 ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/strip2/ref_fitting_st2_3step.eventstore.39ca.dat");
 if(fout1.fail()){
...
// ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/strip2/ref_fitting_st2_2step.40ca.dat");
// ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/strip2/ref_fitting_st2_2step_5sigma.40ca.dat");
// ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/strip2/ref_fitting_st2_2step_st1theta.40ca.dat");
 ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/strip2/ref_fitting_st2_3step.eventstore.40ca.dat");
 if(fout2.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
...
// ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/strip2/ref_fitting_st2_2step.41ca.dat");
// ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/strip2/ref_fitting_st2_2step_5sigma.41ca.dat");
// ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/strip2/ref_fitting_st2_2step_st1theta.41ca.dat");
 ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/strip2/ref_fitting_st2_3step.eventstore.41ca.dat");
 if(fout3.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
...
// TFile* file = TFile::Open("sh13_analysis/hanai/phys/merge/mass_corst2_2nd_ref_st1theta.170272.hist.root");
 TFile* file = TFile::Open("sh13_analysis/hanai/phys/mass_calib/physics.chkmass_st2_3step.eventstore.170272.hist.root");
 if(!file){
