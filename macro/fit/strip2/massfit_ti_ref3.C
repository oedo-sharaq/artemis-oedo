...
void massfit_ti_ref3(){
 ...
 ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/strip1/ref3_fitting_st2_3step.eventstore.40ti.dat");
 if(fout1.fail()){
 ...
 ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/strip1/ref3_fitting_st2_3step.eventstore.41ti.dat");
 if(fout2.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
 ...
 ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/strip1/ref3_fitting_st2_3step.eventstore.42ti.dat");
 if(fout3.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
