...
void massfit_ca_allrun(){
 ...
 ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/strip2/ref_fitting_3step.39ca_aq.170272.dat");
// ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/strip2/ref_fitting_3step.39ca_aq.170272_mcconsider.dat");
 if(fout1.fail()){
 ...
 ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/strip2/ref_fitting_3step.40ca_aq.170272.dat");
// ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/strip2/ref_fitting_3step.40ca_aq.170272_mcconsider.dat");
 if(fout2.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
 ...
 ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/strip2/ref_fitting_3step.41ca_aq.170272.dat");
// ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/strip2/ref_fitting_3step.41ca_aq.170272_mcconsider.dat");
 if(fout3.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
...
//TH1F *h39ca = (TH1F*)gDirectory->Get(Form("mass_st1_39ca_2step_%d",i));
...
// }else{
 ...
 Double_t t_39ca_error = tof_error_func(L,ele,z,Brho,c,mass1) * mass1_error; // [ps]
...
//if(nh39ca < 200){
//	fout1 << i << "  " << 0 << "  " << 3.14 << "  " << 3.14 << "  " << 3.14 << "  " << nh39ca << "  " << 3.14 << " " << 3.14 << "  " << 3.14 << "  " << 3.14 << "  " << 3.14 << "  " << 3.14 << "  " << 3.14  << "  " << 3.14 << endl;
//	}else{
	fout1 << i << "  " << 0 << "  " << prm1[0] << "  " << prm1[1] << "  " << prm1[2] << "  " << nh39ca << "  " << mean1 << " " << mass1_keV << "  " << mass1_keV_error << "  " << reso1 << "  " << aq_diff1 << "  " << massdiff1 << "  " << tdiff1 << "  " << t_39ca_error << endl;
// }
...
//TH1F *h40ca = (TH1F*)gDirectory->Get(Form("mass_st1_40ca_2step_%d",i));
TH1F *h40ca = (TH1F*)gDirectory->Get(Form("h40ca_aq_%d",i));
...
//}else{
 ...
 Double_t t_40ca_error = tof_error_func(L,ele,z,Brho,c,mass2) * mass2_error; // [ps]
...
//if(nh40ca < 200 ){
//fout2 << i  << "  " << 0 << "  " << 3.14 << "  " << 3.14 << "  " << 3.14 << "  " << nh40ca  << "  " << 3.14  << "  " << 3.14 << " " << "  " << 3.14 << "  " << 3.14 << "  " << 3.14 << "  " << 3.14 << "  " << 3.14 << "  " << 3.14 << endl;
//}else{
fout2 << i  << "  " << 0 << "  " << prm2[0] << "  " << prm2[1] << "  " << prm2[2] << "  " << nh40ca  << "  " << mean2  << "  " << mass2_keV << " " << "  " << mass2_keV_error << "  " << reso2 << "  " << aq_diff2 << "  " << massdiff2 << "  " << tdiff2 << "  " << t_40ca_error << endl;
// }
 delete gROOT->Get("h40ca");
 delete gROOT->Get("f2");
...
//TH1F *h41ca = (TH1F*)gDirectory->Get(Form("mass_st1_41ca_2step_%d",i));
TH1F *h41ca = (TH1F*)gDirectory->Get(Form("h41ca_aq_%d",i));
...
//}else{
 ...
 Double_t t_41ca_error = tof_error_func(L,ele,z,Brho,c,mass3) * mass3_error; // [ps]
...
//if(nh41ca < 200){
//fout3 << i << "  " << 0 << "  " << 3.14 << "  " << 3.14 << "  " << 3.14 << "  " << nh41ca << "  " << 3.14 << "  " << 3.14 << "  " << "  " << 3.14 << "  " << 3.14 << "  " << 3.14 << "  " << 3.14 << "  " << 3.14 << "  " << 3.14 << endl;
//}else{
fout3 << i << "  " << 0 << "  " << prm3[0] << "  " << prm3[1] << "  " << prm3[2] << "  " << nh41ca << "  " << mean3 << "  " << mass3_keV << "  " << "  " << mass3_keV_error << "  " << reso3 << "  " << aq_diff3 << "  " << massdiff3 << "  " << tdiff3 << "  " << t_41ca_error << endl;
// }
 delete gROOT->Get("h41ca");
 delete gROOT->Get("f3");
