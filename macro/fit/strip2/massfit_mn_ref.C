...
void massfit_mn_ref(){
 ...
 ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/strip2/ref3_fitting_st2_3step.eventstore.46mn.dat");
 if(fout1.fail()){
 ...
 ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/strip2/ref3_fitting_st2_3step.eventstore.47mn.dat");
 if(fout2.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
 ...
 ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/strip2/ref3_fitting_st2_3step.eventstore.48mn.dat");
 if(fout3.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
