...
// ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/strip1/ref2_fitting_st1_4step_maxz_nooff.eventstore.38ca.dat");
// ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/strip1/ref2_fitting_st1_4step_ssdpla_nooff.eventstore.38ca.dat");
// ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/strip1/ref2_fitting_st1_4.5step_ssdpla_nooff.eventstore.38ca.dat");
 ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/strip1/ref3_fitting_st1_3step_old.eventstore.38ca.dat");
 if(fout1.fail()){
...
// ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/strip1/ref2_fitting_st1_4step_maxz_nooff.eventstore.39ca.dat");
// ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/strip1/ref2_fitting_st1_4step_ssdpla_nooff.eventstore.39ca.dat");
// ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/strip1/ref2_fitting_st1_4.5step_ssdpla_nooff.eventstore.39ca.dat");
 ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/strip1/ref3_fitting_st1_3step_old.eventstore.39ca.dat");
 if(fout2.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
...
// ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/strip1/ref2_fitting_st1_4step_maxz_nooff.eventstore.41ca.dat");
// ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/strip1/ref2_fitting_st1_4step_ssdpla_nooff.eventstore.41ca.dat");
// ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/strip1/ref2_fitting_st1_4.5step_ssdpla_nooff.eventstore.41ca.dat");
 ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/strip1/ref3_fitting_st1_3step_old.eventstore.41ca.dat");
 if(fout3.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
