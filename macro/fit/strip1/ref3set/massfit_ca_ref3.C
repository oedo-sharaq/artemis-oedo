...
void massfit_ca_ref3(){
 ...
 ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/strip1/ref3_fitting_st1_3step_20230908.eventstore.38ca.dat");
 if(fout1.fail()){
 ...
 ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/strip1/ref3_fitting_st1_3step_20230908.eventstore.39ca.dat");
 if(fout2.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
 ...
 ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/strip1/ref3_fitting_st1_3step_20230908.eventstore.41ca.dat");
 if(fout3.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
