//// fitting for 2nd calibration. calculate mean and sigma for each reference


void massfit_st0_2ndgate(int refnum){

// ofstream fout("/home/sh13/art_analysis/user/hanai/prm/mass/ref_st0_fitting.dat");
// if(fout.fail()){
...
if(refnum==0){
//// Ca
 ofstream fout(Form("/home/sh13/art_analysis/user/hanai/prm/mass/ref_st0_fitting%d.dat",refnum));
 if(fout.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
 ...
 TFile* file1 = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st0.170272.ca.hist.root");
 if(!file1){
...
TH1F *h39ca = (TH1F*)gDirectory->Get("mass_st0_39ca");
TH1F *h40ca = (TH1F*)gDirectory->Get("mass_st0_40ca");
TH1F *h41ca = (TH1F*)gDirectory->Get("mass_st0_41ca");
...
//// Sc
 ...
 TFile* file2 = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st0.170272.sc.hist.root");
 if(!file2){
	 printf("Cannot open the file!\n");
	 gROOT->ProcessLine(".q");
	 return;
...
TH1F * h40sc = (TH1F*)gDirectory->Get("mass_st0_40sc");
TH1F * h41sc = (TH1F*)gDirectory->Get("mass_st0_41sc");
TH1F * h43sc = (TH1F*)gDirectory->Get("mass_st0_43sc");
...
//// Ti
 ...
 TFile* file3 = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st0.170272.ti.hist.root");
 if(!file3){
	 printf("Cannot open the file!\n");
	 gROOT->ProcessLine(".q");
	 return;
...
TH1F *h40ti = (TH1F*)gDirectory->Get("mass_st0_40ti");
TH1F *h41ti = (TH1F*)gDirectory->Get("mass_st0_41ti");
TH1F *h43ti = (TH1F*)gDirectory->Get("mass_st0_43ti");
...
//// V
 ...
 TFile* file4 = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st0.170272.v.hist.root");
 if(!file4){
	 printf("Cannot open the file!\n");
	 gROOT->ProcessLine(".q");
	 return;
...
TH1F *h43v  = (TH1F*)gDirectory->Get("mass_st0_43v");
TH1F *h44v  = (TH1F*)gDirectory->Get("mass_st0_44v");
TH1F *h45v  = (TH1F*)gDirectory->Get("mass_st0_45v");
...
//// Cr
 ...
 TFile* file5 = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st0.170272.cr.hist.root");
 if(!file5){
	 printf("Cannot open the file!\n");
	 gROOT->ProcessLine(".q");
	 return;
...
TH1F *h44cr = (TH1F*)gDirectory->Get("mass_st0_44cr");
TH1F *h45cr = (TH1F*)gDirectory->Get("mass_st0_45cr");
TH1F *h46cr = (TH1F*)gDirectory->Get("mass_st0_46cr");
...
//// Mn
 ...
 TFile* file6 = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st0.170272.mn.hist.root");
 if(!file6){
	 printf("Cannot open the file!\n");
	 gROOT->ProcessLine(".q");
	 return;
...
TH1F *h46mn = (TH1F*)gDirectory->Get("mass_st0_46mn");
TH1F *h47mn = (TH1F*)gDirectory->Get("mass_st0_47mn");
TH1F *h48mn = (TH1F*)gDirectory->Get("mass_st0_48mn");
 ...
 h48mn->Fit("gaus","","",1.9174,1.9188);
 TF1 *f18 = h48mn->GetFunction("gaus");
...
//// Fe
 ...
 TFile* file7 = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st0.170272.fe.hist.root");
 if(!file7){
	 printf("Cannot open the file!\n");
	 gROOT->ProcessLine(".q");
	 return;
...
TH1F *h48fe = (TH1F*)gDirectory->Get("mass_st0_48fe");
TH1F *h49fe = (TH1F*)gDirectory->Get("mass_st0_49fe");
TH1F *h50fe = (TH1F*)gDirectory->Get("mass_st0_50fe");
