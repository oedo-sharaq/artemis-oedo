...
void massfit_v_ref4(){
 ...
 ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/strip1/ref4_fitting_st1_3step_SSR.eventstore.43v.dat");
 if(fout1.fail()){
 ...
 ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/strip1/ref4_fitting_st1_3step_SSR.eventstore.44v.dat");
 if(fout2.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
 ...
 ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/strip1/ref4_fitting_st1_3step_SSR.eventstore.46v.dat");
 if(fout3.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
