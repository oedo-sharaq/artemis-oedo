...
// ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/ref_fitting_2step.43v.170272.dat");
 ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/strip1/ref_fitting_3step.43v_aq.170272.dat");
// ofstream fout1("/home/sh13/art_analysis/user/hanai/prm/mass/strip1/ref_fitting_3step_unit.43v_aq.170272.dat");
 if(fout1.fail()){
...
// ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/ref_fitting_2step.44v.170272.dat");
 ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/strip1/ref_fitting_3step.44v_aq.170272.dat");
// ofstream fout2("/home/sh13/art_analysis/user/hanai/prm/mass/strip1/ref_fitting_3step_unit.44v_aq.170272.dat");
 if(fout2.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
...
// ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/ref_fitting_2step.45v.170272.dat");
 ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/strip1/ref_fitting_3step.45v_aq.170272.dat");
// ofstream fout3("/home/sh13/art_analysis/user/hanai/prm/mass/strip1/ref_fitting_3step_unit.45v_aq.170272.dat");
 if(fout3.fail()){
	 cout << "Error; Could not open output file.." << endl << endl;
	 gROOT->ProcessLine(".q");
	 return;
...
// TFile* file = TFile::Open("sh13_analysis/hanai/phys/merge/physics.chkmass_st1_2step.170272.v.hist.root");
...
TH1F *h43v = (TH1F*)gDirectory->Get(Form("h43v_aq_%d",i));
...
// }else{
 ...
 Double_t t_43v_error = tof_error_func(L,ele,z,Brho,c,mass1) * mass1_error; // [ps]
...
//if(nh43v < 200){
//	fout1 << i << "  " << 0 << "  " << 3.14 << "  " << 3.14 << "  " << 3.14 << "  " << nh43v << "  " << 3.14 << " " << 3.14 << "  " << 3.14 << "  " << 3.14 << "  " << 3.14 << "  " << 3.14 << "  " << 3.14  << "  " << 3.14 << endl;
//	}else{
	fout1 << i << "  " << 0 << "  " << prm1[0] << "  " << prm1[1] << "  " << prm1[2] << "  " << nh43v << "  " << mean1 << " " << mass1_keV << "  " << mass1_keV_error << "  " << reso1 << "  " << aq_diff1 << "  " << massdiff1 << "  " << tdiff1 << "  " << t_43v_error << endl;
// }
...
TH1F *h44v = (TH1F*)gDirectory->Get(Form("h44v_aq_%d",i));
...
// }else{
 ...
 Double_t t_44v_error = tof_error_func(L,ele,z,Brho,c,mass2) * mass2_error; // [ps]
...
//if(nh44v < 200 ){
//fout2 << i  << "  " << 0 << "  " << 3.14 << "  " << 3.14 << "  " << 3.14 << "  " << nh44v  << "  " << 3.14  << "  " << 3.14 << " " << "  " << 3.14 << "  " << 3.14 << "  " << 3.14 << "  " << 3.14 << "  " << 3.14 << "  " << 3.14 << endl;
//}else{
fout2 << i  << "  " << 0 << "  " << prm2[0] << "  " << prm2[1] << "  " << prm2[2] << "  " << nh44v  << "  " << mean2  << "  " << mass2_keV << " " << "  " << mass2_keV_error << "  " << reso2 << "  " << aq_diff2 << "  " << massdiff2 << "  " << tdiff2 << "  " << t_44v_error << endl;
// }
...
TH1F *h45v = (TH1F*)gDirectory->Get(Form("h45v_aq_%d",i));
...
//}else{
 ...
 Double_t t_45v_error = tof_error_func(L,ele,z,Brho,c,mass3) * mass3_error; // [ps]
...
//if(nh45v < 200){
//fout3 << i << "  " << 0 << "  " << 3.14 << "  " << 3.14 << "  " << 3.14 << "  " << nh45v << "  " << 3.14 << "  " << 3.14 << "  " << "  " << 3.14 << "  " << 3.14 << "  " << 3.14 << "  " << 3.14 << "  " << 3.14 << "  " << 3.14 << endl;
//}else{
fout3 << i << "  " << 0 << "  " << prm3[0] << "  " << prm3[1] << "  " << prm3[2] << "  " << nh45v << "  " << mean3 << "  " << mass3_keV << "  " << "  " << mass3_keV_error << "  " << reso3 << "  " << aq_diff3 << "  " << massdiff3 << "  " << tdiff3 << "  " << t_45v_error << endl;
// }
 delete gROOT->Get("h45v");
 delete gROOT->Get("f3");
