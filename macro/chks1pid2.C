{
  ...
  for (Int_t i = 1; i<=20; i++){
    tree->Draw(Form("x%d:tofc1>>S1pid%d(200,130,180,500,-200,200)",i,i),"fe9.pid56Ni","colz");
  }

  for (Int_t i = 1; i<=20; i++){
    tree->Draw(Form("0.0830631619726*x%d+0.996544284577*tofc1>>rot%d(200,130,180)",i,i),"fe9.pid56Ni","colz");
  }
