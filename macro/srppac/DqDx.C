...
//set dir  
  ...
  char mkdu[30];
  sprintf(mkdu,".! mkdir -p prm/srppac/sr91/dq2dx/%s",runnumber);
...
//upstream
  ...
  sprintf(filenamesrux,"prm/srppac/sr91/dq2dx/%s/xc0.dat",runnumber);
...
//   }
  ...
  sprintf(filenamesruy,"prm/srppac/sr91/dq2dx/%s/yc0.dat",runnumber);
...
//downstream
  ...
  char mkdd[30];
  sprintf(mkdd,".! mkdir -p prm/srppac/sr92/dq2dx/%s",runnumber);
  ...
  sprintf(filenamesrdx,"prm/srppac/sr92/dq2dx/%s/xc0.dat",runnumber);
...
//   }
  ...
  sprintf(filenamesrdy,"prm/srppac/sr92/dq2dx/%s/yc0.dat",runnumber);
