/**
 * @file   TModuleDecoderA3100FreeRunTSI.cc
...
using art::TModuleDecoderA3100FreeRunTSI;

typedef art::TRawDataTriggeredList A3100Raw_t;

ClassImp(TModuleDecoderA3100FreeRunTSI)

TModuleDecoderA3100FreeRunTSI::TModuleDecoderA3100FreeRunTSI()
...
Int_t TModuleDecoderA3100FreeRunTSI::Decode(char* buf, const Int_t &size, TObjArray *seg)
{
...
//TModuleDecoderA3100FreeRunTSI::TModuleDecoderA3100(const TModuleDecoderA3100& rhs)
//{
//}
//
//TModuleDecoderA3100FreeRunTSI& TModuleDecoderA3100::operator=(const TModuleDecoderA3100& rhs)
//{
//  if (this != &rhs) {
//
//  }
