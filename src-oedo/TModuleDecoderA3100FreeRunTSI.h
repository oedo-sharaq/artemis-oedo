/**
 * @file   TModuleDecoderA3100FreeRunTSI.h
...
#ifndef TMODULEDECODERA3100FREERUNTSI_H
#define TMODULEDECODERA3100FREERUNTSI_H

#include "TModuleDecoder.h"

namespace art
{
  class TModuleDecoderA3100FreeRunTSI;
}

class art::TModuleDecoderA3100FreeRunTSI : public TModuleDecoder
{
public:
  static const int kID = 31;
  TModuleDecoderA3100FreeRunTSI();
  virtual ~TModuleDecoderA3100FreeRunTSI();
...
protected:
  ...
  ClassDef(TModuleDecoderA3100FreeRunTSI, 0) // A3100 decoder
