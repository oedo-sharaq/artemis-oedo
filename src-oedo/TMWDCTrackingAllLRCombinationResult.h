...
class art::TMWDCTrackingAllLRCombinationResult : public TTrack {
public:
   // Default constructor
   TMWDCTrackingAllLRCombinationResult();
   virtual ~TMWDCTrackingAllLRCombinationResult();
   // Copy constructor
   TMWDCTrackingAllLRCombinationResult(const TMWDCTrackingAllLRCombinationResult& rhs);
   // Assignment operator
   TMWDCTrackingAllLRCombinationResult& operator=(const TMWDCTrackingAllLRCombinationResult& rhs);
   ...
   void SetLRAdopted(Int_t idxLR, Double_t valLR){
      fLR[idxLR] = valLR;
   }

   Double_t GetLRAdopted(Int_t idxLR){
      return fLR[idxLR];
   }

   void SetSRAdopted(Int_t idxSR, Double_t valSR){
      fSR[idxSR] = valSR;
   }

   Double_t GetSRAdopted(Int_t idxSR){
      return fSR[idxSR];
   }
...
protected:
   ...
   std::vector<Double_t> fLR;          //
   std::vector<Double_t> fSR;          //
   ...
   ClassDef(TMWDCTrackingAllLRCombinationResult,3) // container for MWDC tracking result
};
