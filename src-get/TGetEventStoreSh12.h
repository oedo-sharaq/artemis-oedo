...
class art::TGetEventStoreSh12 : public TProcessor, public IEventStore {
public:
   static const Int_t kFPNIDs[4]; // 11, 22, 45, 56

   TGetEventStoreSh12();
   virtual ~TGetEventStoreSh12();

   TGetEventStoreSh12(const TGetEventStoreSh12& rhs);
   TGetEventStoreSh12& operator=(const TGetEventStoreSh12& rhs);
...
private:
   ...
   ClassDef(TGetEventStoreSh12,1) // get file event store
};
