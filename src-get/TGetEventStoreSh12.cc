...
using art::TGetEventStoreSh12;

ClassImp(TGetEventStoreSh12)

const Int_t TGetEventStoreSh12::kFPNIDs[4] = {11, 22, 45, 56};
TGetEventStoreSh12::TGetEventStoreSh12()
{
   StringVec_t dummy;
...
TGetEventStoreSh12::TGetEventStoreSh12(const TGetEventStoreSh12& rhs)
{
}

TGetEventStoreSh12& TGetEventStoreSh12::operator=(const TGetEventStoreSh12& rhs)
{
   if (this != &rhs) {
...
void TGetEventStoreSh12::Init(TEventCollection *col) 
{
...
void TGetEventStoreSh12::Process()
{
...
void TGetEventStoreSh12::ProcessFullCobo() {
...
void TGetEventStoreSh12::ProcessReducedCobo() {
...
void TGetEventStoreSh12::ProcessAsAd(GETBasicFrame *asad) {
...
art::TRunInfo* TGetEventStoreSh12::GetRunInfo()
{
...
Int_t art::TGetEventStoreSh12::GetRunNumber() const
{
   return fEventHeader->GetRunNumber();
}

const char* art::TGetEventStoreSh12::GetRunName() const
{
